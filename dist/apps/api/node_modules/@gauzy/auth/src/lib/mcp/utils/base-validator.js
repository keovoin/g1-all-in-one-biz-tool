...
class BaseValidator {
     ...
     */
    static validateAuthorizeRequest(params) {
        // Required parameters
        ...
        switch (params.grant_type) {
            case 'authorization_code':
                ...
                if (params.code_verifier !== undefined) {
                    ...
                    if (!BaseValidator.BASE64URL_RE.test(params.code_verifier) ||
     ...
     */
    static validateClientCredentials(clientId, clientSecret) {
 ...
 */
BaseValidator.BASE64URL_RE = /^[A-Za-z0-9_-]+$/;
