 ...
 */
export declare enum TaskProofOfCompletionTypeEnum {
    PUBLIC = "PUBLIC",
    PRIVATE = "PRIVATE"
}
/**
 ...
 */
export declare const DEFAULT_TASK_NOTIFY_PERIOD = 7;
/**
 * Default period (in days) before an unresolved issue is automatically closed.
 */
export declare const DEFAULT_AUTO_CLOSE_ISSUE_PERIOD = 7;
/**
 * Default period (in days) before an inactive issue is automatically archived.
 */
export declare const DEFAULT_AUTO_ARCHIVE_ISSUE_PERIOD = 7;
/**
 * Default proof of completion type for a task, set to PRIVATE.
 */
export declare const DEFAULT_PROOF_COMPLETION_TYPE = TaskProofOfCompletionTypeEnum.PRIVATE;
