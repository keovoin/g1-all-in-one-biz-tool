 ...
 */
export declare enum ActivepiecesConnectionType {
 ...
 */
export declare enum ActivepiecesConnectionScope {
    PROJECT = "PROJECT"
}
/**
 ...
 */
export declare enum ActivepiecesConnectionStatus {
    ACTIVE = "ACTIVE",
    ERROR = "ERROR"
}
/**
 ...
 */
export declare enum ActivepiecesSettingName {
    API_KEY = "api_key",
