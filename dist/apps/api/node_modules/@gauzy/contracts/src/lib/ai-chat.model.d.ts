 ...
 */
export declare enum AiSpeechErrorCode {
...
export declare const AI_CHAT_SETTINGS_PATH = "/pages/settings/ai";
/**
 ...
 */
export declare const AI_CHAT_RATE_LIMIT_CODE = "ai-chat/rate-limited";
/**
