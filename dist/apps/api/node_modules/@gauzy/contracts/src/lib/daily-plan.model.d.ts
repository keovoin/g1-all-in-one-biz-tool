...
export interface IDailyPlanUpdateInput extends Partial<IDailyPlanBase>, Pick<IDailyPlanCreateInput, 'employeeId'>, Partial<Pick<IRelationalOrganizationTeam, 'organizationTeamId'>> {
}
export interface IGetDailyPlansByTeamInput extends IBaseRelationsEntityModel, IBasePerTenantAndOrganizationEntityModel {
    teamIds?: ID[];
}
export interface IDailyPlanTasksUpdateInput extends Pick<IDailyPlanCreateInput, 'taskId' | 'employeeId'>, IBasePerTenantAndOrganizationEntityModel {
}
export interface IDailyPlansTasksUpdateInput extends Pick<IDailyPlanCreateInput, 'employeeId' | 'organizationTeamId'>, IBasePerTenantAndOrganizationEntityModel {
    plansIds: ID[];
}
