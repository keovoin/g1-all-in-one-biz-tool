...
export interface IDashboardWidget extends IBasePerTenantAndOrganizationEntityModel, IEmployeeEntityInput, IRelationalOrganizationProject, IRelationalOrganizationTeam {
    name: string;
    order?: number;
    size?: number;
    color?: string;
