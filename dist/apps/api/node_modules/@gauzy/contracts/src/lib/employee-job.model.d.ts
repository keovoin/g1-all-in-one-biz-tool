...
export declare enum JobPostSourceEnum {
    UPWORK = "upwork",
    WEB = "web",
    LINKEDIN = "linkedin"
}
export declare enum JobPostStatusEnum {
    OPEN = "open",
    APPLIED = "applied",
    COMPLETED = "completed",
    CLOSED = "closed"
}
export declare enum JobPostTypeEnum {
    HOURLY = "hourly",
    FIXED = "fixed"
}
...
export interface IEmployeeJobApplicationAppliedResult extends IEmployeeJobApplication {
    isRedirectRequired: boolean;
}
