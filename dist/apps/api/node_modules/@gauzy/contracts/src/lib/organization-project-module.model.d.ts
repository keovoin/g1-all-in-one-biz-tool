...
export declare enum ProjectModuleStatusEnum {
    BACKLOG = "backlog",
    PLANNED = "planned",
...
export interface IOrganizationProjectModuleFindInput extends IBasePerTenantAndOrganizationEntityModel, Partial<Pick<IOrganizationProjectModule, 'name' | 'status' | 'projectId'>> {
    organizationTeamId?: ID;
    organizationSprintId?: ID;
}
export interface IOrganizationProjectModuleCreateInput extends Omit<IOrganizationProjectModule, 'id'>, IMemberEntityBased {
}
export interface IOrganizationProjectModuleUpdateInput extends Partial<IOrganizationProjectModuleCreateInput> {
}
export interface IOrganizationProjectModuleEmployee extends IBasePerTenantAndOrganizationEntityModel, IEmployeeEntityInput, IRelationalRole, IManagerAssignable {
