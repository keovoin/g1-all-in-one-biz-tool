...
export interface IOrganizationProjectBase extends IBasePerTenantAndOrganizationEntityModel, IRelationalImageAsset, IRelationalOrganizationContact, IOrganizationProjectSetting, IRelationalOrganizationStrategicInitiatives, ITaggable {
    name?: string;
    startDate?: Date;
    endDate?: Date;
...
export interface IOrganizationProjectsFindInput extends IBasePerTenantAndOrganizationEntityModel, IRelationalOrganizationContact {
    name?: string;
    public?: boolean;
    billable?: boolean;
    billingFlat?: boolean;
...
export interface IOrganizationProjectEmployee extends IBasePerTenantAndOrganizationEntityModel, IEmployeeEntityInput, IRelationalRole, IManagerAssignable {
    organizationProject: IOrganizationProject;
    organizationProjectId: ID;
}
export declare enum TaskListTypeEnum {
    GRID = "GRID",
    SPRINT = "SPRINT"
}
export declare enum OrganizationProjectBudgetTypeEnum {
    HOURS = "hours",
    COST = "cost"
}
