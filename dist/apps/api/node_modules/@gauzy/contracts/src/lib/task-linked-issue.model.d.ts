...
export declare enum TaskRelatedIssuesRelationEnum {
    IS_BLOCKED_BY = 1,
    BLOCKS = 2,
    IS_CLONED_BY = 3,
    CLONES = 4,
...
export interface ILinkedIssueFindInput extends IBasePerTenantAndOrganizationEntityModel, Pick<ITaskLinkedIssue, 'taskFromId'>, Pick<ITaskLinkedIssue, 'taskToId'> {
}
