...
export interface ITaskViewBase extends IBasePerTenantAndOrganizationEntityModel, IRelationalOrganizationTeam, IRelationalOrganizationProject, IRelationalOrganizationProjectModule, IRelationalOrganizationSprint {
    name?: string;
    description?: string;
...
export declare enum VisibilityLevelEnum {
    MODULE_AND_SPRINT = 0,
    TEAM_AND_PROJECT = 1,
    ORGANIZATION = 2,
    WORKSPACE = 3
