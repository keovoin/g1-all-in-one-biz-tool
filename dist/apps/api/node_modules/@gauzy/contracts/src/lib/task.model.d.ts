...
import { IOrganizationSprint, IRelationalOrganizationSprint, IOrganizationSprintTaskHistory } from './organization-sprint.model';
...
export declare enum TaskParticipantEnum {
    EMPLOYEES = "employees",
    TEAMS = "teams"
}
...
export interface ITaskDateFilterInput extends IBasePerTenantAndOrganizationEntityModel, Pick<ITask, 'isScreeningTask' | 'projectId' | 'organizationSprintId' | 'createdByUserId'>, IEmployeeEntityInput, IRelationalOrganizationTeam, IBaseRelationsEntityModel {
    startDateFrom?: Date;
    startDateTo?: Date;
    dueDateFrom?: Date;
    dueDateTo?: Date;
