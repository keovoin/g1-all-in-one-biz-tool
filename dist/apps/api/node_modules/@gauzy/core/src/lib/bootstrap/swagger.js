 ...
 */
const setupSwagger = async (app, { title = 'Gauzy API', description = 'Gauzy API Documentation', version = '1.0', swaggerPath = 'swg', scalarPath = 'docs', enableScalar = true, contact = {
    name: 'Ever Co. LTD',
    url: 'https://ever.co',
    ...
    const options = {
        operationIdFactory: (controllerKey, methodKey) => `${controllerKey.replace(/Controller$/i, '')}_${methodKey}`
    };
    ...
    swagger_1.SwaggerModule.setup(swaggerPath, app, document, customOptions);
 ...
 * @private
 */
async function setupScalarUI(app, document, scalarPath, swaggerPath, title, servers) {
