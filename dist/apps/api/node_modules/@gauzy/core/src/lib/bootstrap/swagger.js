 ...
 */
const setupSwagger = async (app, { title = 'Gauzy API', description = 'Sastra API Documentation', version = '1.0', swaggerPath = 'swg', scalarPath = 'docs', enableScalar = true, contact = {
    name: 'Ever Co. LTD',
    url: 'https://ever.co',
