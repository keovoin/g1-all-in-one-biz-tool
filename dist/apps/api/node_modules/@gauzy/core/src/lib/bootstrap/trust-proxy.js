...
exports.DEFAULT_TRUST_PROXY = void 0;
...
function resolveTrustProxy(raw) {
    ...
    if (!value) {
        return exports.DEFAULT_TRUST_PROXY;
    }
    const normalized = value.toLowerCase();
    if (normalized === 'true') {
        // eslint-disable-next-line no-console
        console.warn(chalk.yellow('TRUST_PROXY=true trusts the ENTIRE X-Forwarded-For chain, so req.ip — and the rate-limit ' +
