...
exports.GENERIC_DATABASE_ERROR_MESSAGE = void 0;
exports.safeMessageForDatabaseText = safeMessageForDatabaseText;
exports.isDatabaseErrorPayload = isDatabaseErrorPayload;
exports.looksLikeDriverCode = looksLikeDriverCode;
exports.describeDatabaseError = describeDatabaseError;
exports.safeErrorMessage = safeErrorMessage;
exports.redactDatabaseError = redactDatabaseError;
 ...
 */
const DATABASE_ERROR_KEYS = ['driverError', 'sqlMessage'];
/**
 ...
 */
const DATABASE_ERROR_COMBO_KEYS = ['query', 'sql'];
/** What the client is told instead, when nothing more specific is known. */
exports.GENERIC_DATABASE_ERROR_MESSAGE = 'The request could not be completed.';
/**
 ...
 */
const DATABASE_ERROR_MESSAGES = new Map([
    // unique violation
 ...
 */
const DATABASE_MESSAGE_SIGNATURES = [
    ...
    [/\b(?:SELECT\s+[\s\S]+\s+FROM|INSERT\s+INTO|UPDATE\s+\S+\s+SET|DELETE\s+FROM)\s+["'`\w]/i, exports.GENERIC_DATABASE_ERROR_MESSAGE],
    [/\bSQLITE_[A-Z0-9_]+\b/, exports.GENERIC_DATABASE_ERROR_MESSAGE],
    ...
    [/\bER_[A-Z0-9_]{3,}\b/, exports.GENERIC_DATABASE_ERROR_MESSAGE],
    [/\bQueryFailedError\b/, exports.GENERIC_DATABASE_ERROR_MESSAGE]
];
/**
 ...
 */
function safeMessageForDatabaseText(value) {
 ...
 */
function isDatabaseErrorPayload(value) {
 ...
 */
function looksLikeDriverCode(code) {
 ...
 */
function resolveDriverCode(error) {
...
function describeDatabaseError(error) {
    ...
    return (code && DATABASE_ERROR_MESSAGES.get(code)) || exports.GENERIC_DATABASE_ERROR_MESSAGE;
}
/**
...
function safeErrorMessage(error) {
    ...
    return safeMessageForDatabaseText(message) ?? message ?? exports.GENERIC_DATABASE_ERROR_MESSAGE;
}
/**
 ...
 */
function maskQuotedLiterals(message) {
 ...
 */
function redactDatabaseError(error) {
    if (!isDatabaseErrorPayload(error)) {
        return error;
    }
    const source = error;
    const redacted = {
        ...
        message: maskQuotedLiterals(error?.message),
        code: resolveDriverCode(error)
    };
    if ('query' in source)
        redacted['query'] = source['query'];
