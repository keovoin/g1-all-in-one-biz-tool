...
exports.AddActiveTaskColumnToOrganizationTeamEmployee1690167501143 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddActiveTaskColumnToOrganizationTeamEmployee1690167501143 {
    constructor() {
        this.name = 'AddActiveTaskColumnToOrganizationTeamEmployee1690167501143';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "organization_team_employee" ADD "activeTaskId" uuid`);
        await queryRunner.query(`CREATE INDEX "IDX_719aeb37fa7a1dd80d25336a0c" ON "organization_team_employee" ("activeTaskId") `);
        await queryRunner.query(`ALTER TABLE "organization_team_employee" ADD CONSTRAINT "FK_719aeb37fa7a1dd80d25336a0cf" FOREIGN KEY ("activeTaskId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "organization_team_employee" DROP CONSTRAINT "FK_719aeb37fa7a1dd80d25336a0cf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_719aeb37fa7a1dd80d25336a0c"`);
        await queryRunner.query(`ALTER TABLE "organization_team_employee" DROP COLUMN "activeTaskId"`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_organization_team_employee" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "tenantId" varchar, "organizationId" varchar, "organizationTeamId" varchar NOT NULL, "employeeId" varchar NOT NULL, "roleId" varchar, "isTrackingEnabled" boolean DEFAULT (1), "activeTaskId" varchar, CONSTRAINT "FK_fe12e1b76bbb76209134d9bdc2e" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_d8eba1c0e500c60be1b69c1e777" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_8dc83cdd7c519d73afc0d8bdf09" FOREIGN KEY ("organizationTeamId") REFERENCES "organization_team" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_a2a5601d799fbfc29c17b99243f" FOREIGN KEY ("employeeId") REFERENCES "employee" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_ce83034f38496f5fe3f19796977" FOREIGN KEY ("roleId") REFERENCES "role" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
...
exports.AddActiveTaskColumnToOrganizationTeamEmployee1690167501143 = AddActiveTaskColumnToOrganizationTeamEmployee1690167501143;
//# sourceMappingURL=1690167501143-AddActiveTaskColumnToOrganizationTeamEmployee.js.map