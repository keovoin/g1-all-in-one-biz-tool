...
exports.AlterOrganizationTeamAddRequirePlanToTrackField1718386634024 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterOrganizationTeamAddRequirePlanToTrackField1718386634024 {
    constructor() {
        this.name = 'AlterOrganizationTeamAddRequirePlanToTrackField1718386634024';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "organization_team" ADD "requirePlanToTrack" boolean NOT NULL DEFAULT false`);
    }
    /**
    ...
    async mysqlUpQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`organization_team\` ADD \`requirePlanToTrack\` tinyint NOT NULL DEFAULT 0`);
    }
    /**
...
exports.AlterOrganizationTeamAddRequirePlanToTrackField1718386634024 = AlterOrganizationTeamAddRequirePlanToTrackField1718386634024;
//# sourceMappingURL=1718386634024-AlterOrganizationTeamAddRequirePlanToTrackField.js.map