...
exports.AlterOrganizationGithubRepositoryIssueEntityTable1719994643595 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterOrganizationGithubRepositoryIssueEntityTable1719994643595 {
    constructor() {
        this.name = 'AlterOrganizationGithubRepositoryIssueEntityTable1719994643595';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_github_repository_issue" ALTER COLUMN "issueId" TYPE bigint`);
        await queryRunner.query(`ALTER TABLE "organization_github_repository_issue" ALTER COLUMN "issueId" SET NOT NULL`);
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`DROP INDEX "public"."IDX_055f310a04a928343494a5255a"`);
        await queryRunner.query(`ALTER TABLE "organization_github_repository_issue" ALTER COLUMN "issueId" TYPE integer`);
        await queryRunner.query(`ALTER TABLE "organization_github_repository_issue" ALTER COLUMN "issueId" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_055f310a04a928343494a5255a" ON "organization_github_repository_issue" ("issueId") `);
    }
    /**
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "organization_github_repository_issue" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "issueId" integer NOT NULL, "issueNumber" integer NOT NULL, "repositoryId" varchar, "deletedAt" datetime, CONSTRAINT "FK_b3234be5b70c2362cdf67bb1889" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_6c8e119fc6a2a7d3413aa76d3bd" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_5065401113abb6e9608225e5678" FOREIGN KEY ("repositoryId") REFERENCES "organization_github_repository" ("id") ON DELETE SET NULL ON UPDATE NO ACTION)`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        await queryRunner.query(`DROP INDEX \`IDX_055f310a04a928343494a5255a\` ON \`organization_github_repository_issue\``);
        await queryRunner.query(`ALTER TABLE \`organization_github_repository_issue\` MODIFY COLUMN \`issueId\` bigint NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_055f310a04a928343494a5255a\` ON \`organization_github_repository_issue\` (\`issueId\`)`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`DROP INDEX \`IDX_055f310a04a928343494a5255a\` ON \`organization_github_repository_issue\``);
        await queryRunner.query(`ALTER TABLE \`organization_github_repository_issue\` MODIFY COLUMN \`issueId\` int NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_055f310a04a928343494a5255a\` ON \`organization_github_repository_issue\` (\`issueId\`)`);
    }
}
exports.AlterOrganizationGithubRepositoryIssueEntityTable1719994643595 = AlterOrganizationGithubRepositoryIssueEntityTable1719994643595;
//# sourceMappingURL=1719994643595-AlterOrganizationGithubRepositoryIssueEntityTable.js.map