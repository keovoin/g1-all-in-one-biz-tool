...
exports.AddColumnsToOrganizationProjectEmployeeEntity1726509769379 = void 0;
const chalk = require("chalk");
const uuid_1 = require("uuid");
const config_1 = require("@gauzy/config");
class AddColumnsToOrganizationProjectEmployeeEntity1726509769379 {
    constructor() {
        this.name = 'AddColumnsToOrganizationProjectEmployeeEntity1726509769379';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD "id" uuid NOT NULL DEFAULT gen_random_uuid()`);
        // Step 3: Modify primary keys
        console.log('Step 3: Modifying primary keys...');
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_5be2464327d74ba4e2b2240aac4"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_ce1fc15962d70f8776be4e19c36" PRIMARY KEY ("employeeId", "organizationProjectId", "id")`);
        // Step 4: Add timestamps and status columns
        console.log('Step 4: Adding timestamps and status columns...');
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_ce1fc15962d70f8776be4e19c36"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_ef7ed5fb243d49d55cecf1ae8bd" PRIMARY KEY ("employeeId", "id")`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_ef7ed5fb243d49d55cecf1ae8bd"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_cb8069ff5917c90adbc48139147" PRIMARY KEY ("id")`);
        // Step 7: Create new indexes
        console.log('Step 7: Creating new indexes...');
        await queryRunner.query(`CREATE INDEX "IDX_f3d1102a8aa6442cdfce5d57c3" ON "organization_project_employee" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_abbe29504bb642647a69959cc0" ON "organization_project_employee" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_a9abd98013154ec1edfa1ec18c" ON "organization_project_employee" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a77a507b7402f0adb6a6b41e41" ON "organization_project_employee" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_509be755cdaf837c263ffaa6b6" ON "organization_project_employee" ("isManager") `);
        await queryRunner.query(`CREATE INDEX "IDX_25de67f7f3f030438e3ecb1c0e" ON "organization_project_employee" ("assignedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_1c5e006185395a6193ede3456c" ON "organization_project_employee" ("roleId") `);
        // Step 8: Recreate foreign keys
        console.log('Step 8: Recreating foreign keys...');
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "FK_a9abd98013154ec1edfa1ec18cd" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "FK_a77a507b7402f0adb6a6b41e412" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "FK_2ba868f42c2301075b7c141359e" FOREIGN KEY ("organizationProjectId") REFERENCES "organization_project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "FK_6b5b0c3d994f59d9c800922257f" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "FK_1c5e006185395a6193ede3456c6" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async postgresDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "FK_1c5e006185395a6193ede3456c6"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "FK_6b5b0c3d994f59d9c800922257f"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "FK_2ba868f42c2301075b7c141359e"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "FK_a77a507b7402f0adb6a6b41e412"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "FK_a9abd98013154ec1edfa1ec18cd"`);
        // Step 2: Drop indexes
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_cb8069ff5917c90adbc48139147"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_ef7ed5fb243d49d55cecf1ae8bd" PRIMARY KEY ("employeeId", "id")`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_ef7ed5fb243d49d55cecf1ae8bd"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_ce1fc15962d70f8776be4e19c36" PRIMARY KEY ("employeeId", "organizationProjectId", "id")`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" DROP CONSTRAINT "PK_ce1fc15962d70f8776be4e19c36"`);
        await queryRunner.query(`ALTER TABLE "organization_project_employee" ADD CONSTRAINT "PK_5be2464327d74ba4e2b2240aac4" PRIMARY KEY ("employeeId", "organizationProjectId")`);
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        console.log('Step 10: Renaming temporary_organization_project_employee_with_constraints to organization_project_employee');
        await queryRunner.query(`
    ...
    async mysqlUpQueryRunner(queryRunner) {
        // Step 1: Drop existing foreign keys
        console.log('Step 1: Dropping foreign keys...');
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_2ba868f42c2301075b7c141359e\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_6b5b0c3d994f59d9c800922257f\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`organizationId\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`isManager\` tinyint NULL DEFAULT 0`);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`isActive\` tinyint NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`isArchived\` tinyint NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`createdAt\` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`updatedAt\` DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        // Step 1: Drop existing foreign keys
        console.log('Step 1: Dropping existing foreign keys...');
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_1c5e006185395a6193ede3456c6\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_6b5b0c3d994f59d9c800922257f\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_2ba868f42c2301075b7c141359e\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_a77a507b7402f0adb6a6b41e412\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP FOREIGN KEY \`FK_a9abd98013154ec1edfa1ec18cd\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`employeeId\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD PRIMARY KEY (\`employeeId\`, \`id\`)`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`organizationProjectId\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD \`organizationProjectId\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD PRIMARY KEY (\`employeeId\`, \`organizationProjectId\`, \`id\`)`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`roleId\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`assignedAt\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`isManager\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`organizationId\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`createdAt\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD PRIMARY KEY (\`employeeId\`, \`organizationProjectId\`)`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` DROP COLUMN \`deletedAt\``);
...
exports.AddColumnsToOrganizationProjectEmployeeEntity1726509769379 = AddColumnsToOrganizationProjectEmployeeEntity1726509769379;
//# sourceMappingURL=1726509769379-AddColumnsToOrganizationProjectEmployeeEntity.js.map