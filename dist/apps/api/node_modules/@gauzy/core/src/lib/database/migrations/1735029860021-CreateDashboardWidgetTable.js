...
exports.CreateDashboardWidgetTable1735029860021 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateDashboardWidgetTable1735029860021 {
    constructor() {
        this.name = 'CreateDashboardWidgetTable1735029860021';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_874c658642731879efcb59eb86" ON "dashboard_widget" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8aca6bf2a4bb3d3e4fefb45025" ON "dashboard_widget" ("organizationTeamId") `);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_a7ffbc7d50b1a1b81b1fe536efa" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_874c658642731879efcb59eb86d" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_37493320a29e31ef5270a1a4cdb" FOREIGN KEY ("dashboardId") REFERENCES "dashboard"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_2b7c8613b15d53b39b38ac1ec35" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_76ce155efa0c89ce6aeda06e70c" FOREIGN KEY ("projectId") REFERENCES "organization_project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dashboard_widget" ADD CONSTRAINT "FK_8aca6bf2a4bb3d3e4fefb45025e" FOREIGN KEY ("organizationTeamId") REFERENCES "organization_team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
...
exports.CreateDashboardWidgetTable1735029860021 = CreateDashboardWidgetTable1735029860021;
//# sourceMappingURL=1735029860021-CreateDashboardWidgetTable.js.map