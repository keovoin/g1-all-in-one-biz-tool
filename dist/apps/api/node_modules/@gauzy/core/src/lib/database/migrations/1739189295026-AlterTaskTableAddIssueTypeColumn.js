...
exports.AlterTaskTableAddIssueTypeColumn1739189295026 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterTaskTableAddIssueTypeColumn1739189295026 {
    constructor() {
        this.name = 'AlterTaskTableAddIssueTypeColumn1739189295026';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_684653b9509fadccb77ea2bfcca" FOREIGN KEY ("taskTypeId") REFERENCES "issue_type"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    /**
...
exports.AlterTaskTableAddIssueTypeColumn1739189295026 = AlterTaskTableAddIssueTypeColumn1739189295026;
//# sourceMappingURL=1739189295026-AlterTaskTableAddIssueTypeColumn.js.map