...
exports.AlterResourceLinkEntityTable1739782998215 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterResourceLinkEntityTable1739782998215 {
    constructor() {
        this.name = 'AlterResourceLinkEntityTable1739782998215';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "resource_link"
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        console.log('Step 8: Dropping old "resource_link" table and renaming "temporary_resource_link" to "resource_link"...');
        await queryRunner.query(`DROP TABLE "resource_link"`);
        await queryRunner.query(`ALTER TABLE "temporary_resource_link" RENAME TO "resource_link"`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "resource_link" (
				"deletedAt" datetime,
				"id" varchar PRIMARY KEY NOT NULL,
				"createdAt" datetime NOT NULL DEFAULT (datetime('now')),
				"updatedAt" datetime NOT NULL DEFAULT (datetime('now')),
        ...
        await queryRunner.query(`INSERT INTO "resource_link"(
				"deletedAt",
				"id",
				"createdAt",
				"updatedAt",
        ...
        console.log('Step 6: Dropping the old "temporary_resource_link" table and renaming the "resource_link" table...');
...
exports.AlterResourceLinkEntityTable1739782998215 = AlterResourceLinkEntityTable1739782998215;
//# sourceMappingURL=1739782998215-AlterResourceLinkEntityTable.js.map