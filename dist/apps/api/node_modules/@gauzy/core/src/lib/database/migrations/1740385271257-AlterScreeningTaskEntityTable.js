...
exports.AlterScreeningTaskEntityTable1740385271257 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterScreeningTaskEntityTable1740385271257 {
    constructor() {
        this.name = 'AlterScreeningTaskEntityTable1740385271257';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_28727a84fdc4cad1cafd070148" ON "screening_task" ("createdByUserId") `);
        await queryRunner.query(`ALTER TABLE "screening_task" ADD CONSTRAINT "FK_28727a84fdc4cad1cafd0701482" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    /**
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`screening_task\` CHANGE \`creatorId\` \`createdByUserId\` varchar(255) NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_28727a84fdc4cad1cafd070148\` ON \`screening_task\` (\`createdByUserId\`)`);
        await queryRunner.query(`ALTER TABLE \`screening_task\` ADD CONSTRAINT \`FK_28727a84fdc4cad1cafd0701482\` FOREIGN KEY (\`createdByUserId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`screening_task\` CHANGE \`createdByUserId\` \`creatorId\` varchar(255) NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_b7864d01ba77b2d96448779925\` ON \`screening_task\` (\`creatorId\`)`);
        await queryRunner.query(`ALTER TABLE \`screening_task\` ADD CONSTRAINT \`FK_b7864d01ba77b2d964487799252\` FOREIGN KEY (\`creatorId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
}
exports.AlterScreeningTaskEntityTable1740385271257 = AlterScreeningTaskEntityTable1740385271257;
//# sourceMappingURL=1740385271257-AlterScreeningTaskEntityTable.js.map