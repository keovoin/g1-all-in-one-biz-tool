...
exports.AlterInviteEntityTable1740401389878 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterInviteEntityTable1740401389878 {
    constructor() {
        this.name = 'AlterInviteEntityTable1740401389878';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "invite" ADD CONSTRAINT "FK_044d4be3cf3d789d0bfd7aaaba0" FOREIGN KEY ("invitedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
...
exports.AlterInviteEntityTable1740401389878 = AlterInviteEntityTable1740401389878;
//# sourceMappingURL=1740401389878-AlterInviteEntityTable.js.map