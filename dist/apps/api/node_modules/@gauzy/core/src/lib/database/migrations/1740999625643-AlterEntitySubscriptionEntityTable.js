...
exports.AlterEntitySubscriptionEntityTable1740999625643 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterEntitySubscriptionEntityTable1740999625643 {
    constructor() {
        this.name = 'AlterEntitySubscriptionEntityTable1740999625643';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        console.log(chalk.yellow('Skipping PostgresDB Up Migration: This migration is implemented for SQLite databases only.'));
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        console.log(chalk.yellow('Skipping PostgresDB Down Migration: This migration is implemented for SQLite databases only.'));
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_20ab5595afd1d6f3c615901f0e" ON "entity_subscription" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4d44ab2374537d23199e12af3a" ON "entity_subscription" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c85c985e49dbf5cf54556dc339" ON "entity_subscription" ("employeeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_179d37cfc5af1b922ae61ef197" ON "entity_subscription" ("actorType") `);
        await queryRunner.query(`CREATE INDEX "IDX_5ba76d22f6ce6da7ed654d6b3a" ON "entity_subscription" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_953e680602ea3b0cd53cc5091d" ON "entity_subscription" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_92007461ec4f0503e7c31f4c3c" ON "entity_subscription" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_acab84b45e0a2cad5ea5b03211" ON "entity_subscription" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9c48df6f668733aba86e4fc1ee" ON "entity_subscription" ("updatedByUserId") `);
        await queryRunner.query(`DROP INDEX "IDX_20ab5595afd1d6f3c615901f0e"`);
        await queryRunner.query(`DROP INDEX "IDX_4d44ab2374537d23199e12af3a"`);
        await queryRunner.query(`DROP INDEX "IDX_c85c985e49dbf5cf54556dc339"`);
        await queryRunner.query(`DROP INDEX "IDX_179d37cfc5af1b922ae61ef197"`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "entity_subscription" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "entityId" varchar NOT NULL, "entity" varchar NOT NULL, "type" varchar NOT NULL, "actorType" integer, "employeeId" varchar, "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar)`);
        await queryRunner.query(`INSERT INTO "entity_subscription"("deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "entityId", "entity", "type", "actorType", "employeeId", "createdByUserId", "updatedByUserId", "deletedByUserId") SELECT "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "entityId", "entity", "type", "actorType", "employeeId", "createdByUserId", "updatedByUserId", "deletedByUserId" FROM "temporary_entity_subscription"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        console.log(chalk.yellow('Skipping MySQL Up Migration: This migration is implemented for SQLite databases only.'));
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        console.log(chalk.yellow('Skipping MySQL Down Migration: This migration is implemented for SQLite databases only.'));
    }
}
exports.AlterEntitySubscriptionEntityTable1740999625643 = AlterEntitySubscriptionEntityTable1740999625643;
//# sourceMappingURL=1740999625643-AlterEntitySubscriptionEntityTable.js.map