...
exports.AlterEquipmentSharingEntityTable1741002457504 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterEquipmentSharingEntityTable1741002457504 {
    constructor() {
        this.name = 'AlterEquipmentSharingEntityTable1741002457504';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_equipment_sharing" (
        ...
        await queryRunner.query(`INSERT INTO "temporary_equipment_sharing" (
				"id",
				"createdAt",
				"updatedAt",
				"tenantId",
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0d491ffab5a4d82c939abb34ce" ON "equipment_sharing" ("deletedByUserId")`);
        await queryRunner.query(`CREATE INDEX "IDX_2e2c8ba7c8f08f3dca8ff4214a" ON "equipment_sharing" ("createdByUserId")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_3febe3cf1c4c2809555fe43eac" ON "equipment_sharing" ("updatedByUserId")`);
    }
    /**
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "equipment_sharing" (
				"id" varchar PRIMARY KEY NOT NULL,
				"createdAt" datetime NOT NULL DEFAULT (datetime('now')),
				"updatedAt" datetime NOT NULL DEFAULT (datetime('now')),
				"tenantId" varchar,
...
exports.AlterEquipmentSharingEntityTable1741002457504 = AlterEquipmentSharingEntityTable1741002457504;
//# sourceMappingURL=1741002457504-AlterEquipmentSharingEntityTable.js.map