...
exports.AlterRequestApprovalEntityTable1741071424998 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterRequestApprovalEntityTable1741071424998 {
    constructor() {
        this.name = 'AlterRequestApprovalEntityTable1741071424998';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d383e220a98ca0c1413bc00e0d" ON "request_approval" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_95a94c342eb56b844616d6bb29" ON "request_approval" ("createdByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_2cfc197cc78c994f77574af388" ON "request_approval" ("updatedByUserId") `);
    }
    /**
...
exports.AlterRequestApprovalEntityTable1741071424998 = AlterRequestApprovalEntityTable1741071424998;
//# sourceMappingURL=1741071424998-AlterRequestApprovalEntityTable.js.map