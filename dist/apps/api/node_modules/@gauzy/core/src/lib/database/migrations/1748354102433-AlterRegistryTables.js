...
exports.AlterRegistryTables1748354102433 = void 0;
const config_1 = require("@gauzy/config");
const chalk = require("chalk");
class AlterRegistryTables1748354102433 {
    constructor() {
        this.name = 'AlterRegistryTables1748354102433';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."plugin_source_operatingsystem_enum" AS ENUM('LINUX', 'MAC', 'WINDOWS', 'UNIVERSAL')`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD "operatingSystem" "public"."plugin_source_operatingsystem_enum" NOT NULL DEFAULT 'UNIVERSAL'`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_source_architecture_enum" AS ENUM('X64', 'ARM')`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD "architecture" "public"."plugin_source_architecture_enum" NOT NULL DEFAULT 'X64'`);
        ...
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_f2dd1610a6a707db852710519e6" FOREIGN KEY ("versionId") REFERENCES "plugin_version"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "plugin_version"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId" FROM "temporary_plugin_version"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`plugin_source\` DROP COLUMN \`authToken\``);
        await queryRunner.query(`ALTER TABLE \`plugin_version\` DROP COLUMN \`sourceId\``);
        await queryRunner.query(`ALTER TABLE \`plugin_source\` ADD \`operatingSystem\` enum ('LINUX', 'MAC', 'WINDOWS', 'UNIVERSAL') NOT NULL DEFAULT 'UNIVERSAL'`);
        await queryRunner.query(`ALTER TABLE \`plugin_source\` ADD \`architecture\` enum ('X64', 'ARM') NOT NULL DEFAULT 'X64'`);
...
exports.AlterRegistryTables1748354102433 = AlterRegistryTables1748354102433;
//# sourceMappingURL=1748354102433-AlterRegistryTables.js.map