...
exports.CreateTableCamshots1749490131969 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateTableCamshots1749490131969 {
    constructor() {
        this.name = 'CreateTableCamshots1749490131969';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "camshots" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "title" varchar NOT NULL, "fileKey" varchar NOT NULL, "thumbKey" varchar, "storageProvider" varchar CHECK( "storageProvider" IN ('LOCAL','S3','WASABI','CLOUDINARY','DIGITALOCEAN') ), "recordedAt" datetime, "fullUrl" varchar, "thumbUrl" varchar, "size" integer, "timeSlotId" varchar, "uploadedById" varchar, "userId" varchar)`);
        await queryRunner.query(`INSERT INTO "camshots"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "title", "fileKey", "thumbKey", "storageProvider", "recordedAt", "fullUrl", "thumbUrl", "size", "timeSlotId", "uploadedById", "userId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "title", "fileKey", "thumbKey", "storageProvider", "recordedAt", "fullUrl", "thumbUrl", "size", "timeSlotId", "uploadedById", "userId" FROM "temporary_camshots"`);
...
exports.CreateTableCamshots1749490131969 = CreateTableCamshots1749490131969;
//# sourceMappingURL=1749490131969-CreateTableCamshots.js.map