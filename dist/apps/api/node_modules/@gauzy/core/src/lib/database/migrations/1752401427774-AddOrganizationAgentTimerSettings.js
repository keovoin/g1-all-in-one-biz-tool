...
exports.AddOrganizationAgentTimerSettings1752401427774 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddOrganizationAgentTimerSettings1752401427774 {
    constructor() {
        this.name = 'AddOrganizationAgentTimerSettings1752401427774';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization" ADD "allowLogoutFromAgentApp" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "organization" ADD "trackKeyboardMouseActivity" boolean NOT NULL DEFAULT false`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`organization\` ADD \`allowLogoutFromAgentApp\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`organization\` ADD \`trackKeyboardMouseActivity\` tinyint NOT NULL DEFAULT 0`);
...
exports.AddOrganizationAgentTimerSettings1752401427774 = AddOrganizationAgentTimerSettings1752401427774;
//# sourceMappingURL=1752401427774-AddOrganizationAgentTimerSettings.js.map