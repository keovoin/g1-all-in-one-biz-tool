...
exports.CreatePluginMarketplaceTables1766045577607 = void 0;
const config_1 = require("@gauzy/config");
const chalk = require("chalk");
class CreatePluginMarketplaceTables1766045577607 {
    constructor() {
        this.name = 'CreatePluginMarketplaceTables1766045577607';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."plugin_tenants_scope_enum" AS ENUM('tenant', 'organization', 'user')`);
        await queryRunner.query(`CREATE TABLE "plugin_tenants" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "pluginId" uuid NOT NULL, "enabled" boolean NOT NULL DEFAULT true, "scope" "public"."plugin_tenants_scope_enum" NOT NULL DEFAULT 'user', "autoInstall" boolean NOT NULL DEFAULT false, "requiresApproval" boolean NOT NULL DEFAULT true, "isMandatory" boolean NOT NULL DEFAULT false, "maxInstallations" integer, "maxActiveUsers" integer, "currentInstallations" integer NOT NULL DEFAULT '0', "currentActiveUsers" integer NOT NULL DEFAULT '0', "tenantConfiguration" jsonb, "preferences" jsonb, "approvedAt" TIMESTAMP, "isDataCompliant" boolean NOT NULL DEFAULT true, "complianceCertifications" text, "approvedById" uuid, CONSTRAINT "PK_994378ab16d5ce4bb7793a3ffab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f209a8620f1677ed2c82c4cd2e" ON "plugin_tenants" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0b5cc71673410a449491fb3db9" ON "plugin_tenants" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_06f10073cd6e84a19b6f604ddd" ON "plugin_tenants" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_545faee53386f4e9d7b4311104" ON "plugin_tenants" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c4accce384c6007c92b9afdc2d" ON "plugin_tenants" ("currentInstallations") `);
        await queryRunner.query(`CREATE INDEX "IDX_1aca41d7ee08b3b140eae4ee88" ON "plugin_tenants" ("currentActiveUsers") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4f1dada611375594ce22411cbe" ON "plugin_tenants" ("pluginId", "enabled") `);
        await queryRunner.query(`CREATE INDEX "IDX_69f72957e1c98832cdab0c486e" ON "plugin_tenants" ("organizationId", "scope") `);
        await queryRunner.query(`CREATE INDEX "IDX_a3a616a07b21a4212736493f5e" ON "plugin_tenants" ("tenantId", "scope", "enabled") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_1394aebfcfe6782051e76f46a5" ON "plugin_tenants" ("pluginId", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_settings_datatype_enum" AS ENUM('string', 'number', 'boolean', 'json', 'file')`);
        await queryRunner.query(`CREATE TABLE "plugin_settings" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "key" character varying NOT NULL, "value" text NOT NULL, "isRequired" boolean NOT NULL DEFAULT false, "isEncrypted" boolean NOT NULL DEFAULT false, "description" text, "order" integer, "validationRules" text, "dataType" "public"."plugin_settings_datatype_enum" NOT NULL DEFAULT 'string', "defaultValue" character varying, "pluginId" uuid NOT NULL, "pluginTenantId" uuid, "categoryId" uuid, "updatedById" uuid, CONSTRAINT "PK_ae7adb397738141e37cdd4e4539" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5534e36ff3a1416c17f507d546" ON "plugin_settings" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6b8deef29d0fb5eee571c39b39" ON "plugin_settings" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a97ab238dc6aff5f305d37dbc7" ON "plugin_settings" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d4504369b0f19d2360a464408a" ON "plugin_settings" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_737e0935140d7b17632fc7815a" ON "plugin_settings" ("pluginId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8e11188fb92db2ee126b53e866" ON "plugin_settings" ("pluginTenantId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_48aa394150a960cf3e7b285cf4" ON "plugin_settings" ("pluginId", "key", "pluginTenantId") `);
        await queryRunner.query(`CREATE TABLE "plugin_categories" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "name" character varying NOT NULL, "description" text, "slug" character varying NOT NULL, "color" character varying, "icon" character varying, "order" integer NOT NULL DEFAULT '0', "metadata" jsonb, "parentId" uuid, CONSTRAINT "UQ_d427c34c4dd721c72d5d56187f9" UNIQUE ("slug"), CONSTRAINT "PK_02cd60be2345ddb1e88bab84483" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_60543808734ff13850d7843f7b" ON "plugin_categories" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c7c4b6b97be418be173859d10d" ON "plugin_categories" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_1fa4520b20a0bf4fdfe3ca1ec7" ON "plugin_categories" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_17c923b300710a13f6dfade59b" ON "plugin_tags" ("tagId", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_cddb5e04a93a957dc4d56522b7" ON "plugin_tags" ("pluginId", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_676e7c749905331c36b1707ba8" ON "plugin_tags" ("pluginId", "tagId") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_installations_status_enum" AS ENUM('INSTALLED', 'UNINSTALLED', 'FAILED', 'IN_PROGRESS')`);
        await queryRunner.query(`CREATE TABLE "plugin_installations" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "pluginId" uuid, "versionId" uuid, "installedById" uuid, "installedAt" TIMESTAMP, "uninstalledAt" TIMESTAMP, "status" "public"."plugin_installations_status_enum" NOT NULL DEFAULT 'IN_PROGRESS', "isActivated" boolean NOT NULL DEFAULT false, "activatedAt" TIMESTAMP, "deactivatedAt" TIMESTAMP, CONSTRAINT "PK_af29f092b24666b0ceacead453c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_842e5e5f94c4008a42d4b5f44a" ON "plugin_installations" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7e9b8b3eebb881753e07b73f6c" ON "plugin_installations" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a45f5c2aba22d4fa4eb8fa85af" ON "plugin_installations" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d742ed346264f4c9d9225265d7" ON "plugin_installations" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_3e63eed07bcc0e3e36d9183cca" ON "plugin_installations" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_dff9e6c763c8c33b07f330e6a1" ON "plugin_installations" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8aafffefdce2eb11079ec2aa75" ON "plugin_installations" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_547e4b71ae81ee772fa4ab79e6" ON "plugin_installations" ("pluginId") `);
        await queryRunner.query(`CREATE INDEX "IDX_acac58b213936ea488d0a8d1a3" ON "plugin_installations" ("versionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_32c3f7a738ec8b40d6375b2933" ON "plugin_installations" ("installedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_28624735b4e3ace75883521a57" ON "plugin_installations" ("installedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_c92ea21dfcfd889730e2214c8f" ON "plugin_installations" ("uninstalledAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_5e6b80341a4ed75ae7c4af6897" ON "plugin_installations" ("activatedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_3c3ce338e7716d853220d8b176" ON "plugin_installations" ("deactivatedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_173e0668b17afd3696abf3c518" ON "plugin_installations" ("installedById", "pluginId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_1569d8ca526d958d82483e15c7" ON "plugin_installations" ("pluginId", "tenantId", "organizationId", "installedById") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_sources_type_enum" AS ENUM('CDN', 'NPM', 'GAUZY')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_sources_operatingsystem_enum" AS ENUM('LINUX', 'MAC', 'WINDOWS', 'UNIVERSAL')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_sources_architecture_enum" AS ENUM('X64', 'ARM')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_sources_storageprovider_enum" AS ENUM('LOCAL', 'S3', 'WASABI', 'CLOUDINARY', 'DIGITALOCEAN')`);
        await queryRunner.query(`CREATE TABLE "plugin_sources" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "type" "public"."plugin_sources_type_enum" NOT NULL DEFAULT 'GAUZY', "operatingSystem" "public"."plugin_sources_operatingsystem_enum" NOT NULL DEFAULT 'UNIVERSAL', "architecture" "public"."plugin_sources_architecture_enum" NOT NULL DEFAULT 'X64', "url" character varying, "integrity" character varying, "crossOrigin" character varying, "name" character varying, "registry" character varying, "private" boolean DEFAULT false, "scope" character varying, "filePath" character varying, "fileName" character varying, "fileSize" integer, "mimeType" character varying, "fileKey" character varying, "versionId" uuid, "storageProvider" "public"."plugin_sources_storageprovider_enum", CONSTRAINT "PK_f3b8f3deb563db7010fb5a7b6c0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_09a383d6f2858d49c064ca4cda" ON "plugin_sources" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0404416b5c1cd48ae87fe81834" ON "plugin_sources" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c90b796bd033e54e3719213a0c" ON "plugin_sources" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7c6dc1cdd58690b7179d76184b" ON "plugin_sources" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_55bee446d2c470e5d6b066a27a" ON "plugin_sources" ("versionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d658bc853b354445cf2a0d6fb7" ON "plugin_sources" ("storageProvider") `);
        await queryRunner.query(`CREATE INDEX "IDX_af8978fbf37560525c19ec7048" ON "plugin_sources" ("tenantId", "organizationId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6fae6d0ddfd7177abcb4befd72" ON "plugin_sources" ("versionId", "operatingSystem", "architecture", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE TABLE "plugin_versions" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "number" character varying NOT NULL, "changelog" character varying NOT NULL, "checksum" character varying, "signature" character varying, "releaseDate" TIMESTAMP, "downloadCount" integer DEFAULT '0', "pluginId" uuid, CONSTRAINT "PK_d45355357c416a54832493a865a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_485db4d1cc977cc3d499824d95" ON "plugin_versions" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0b36b5701e9890a395ded76cb5" ON "plugin_versions" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e06094816e67e584dea754cc81" ON "plugin_versions" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f806bae81cd490404a1888ad5b" ON "plugin_versions" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6fa0eda3add1fb070ba172a44e" ON "plugin_versions" ("downloadCount") `);
        await queryRunner.query(`CREATE INDEX "IDX_e632aa70ea7b7e5c5fdbfba41b" ON "plugin_versions" ("number") `);
        await queryRunner.query(`CREATE INDEX "IDX_e1e7cf1589d06ac02a12e41db0" ON "plugin_versions" ("pluginId", "releaseDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_f5c8259c0d815486f31878864d" ON "plugin_versions" ("tenantId", "organizationId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_39d060301c8a36b51da6e4aec3" ON "plugin_versions" ("pluginId", "organizationId", "number") `);
        await queryRunner.query(`CREATE TYPE "public"."plugins_type_enum" AS ENUM('DESKTOP', 'WEB', 'MOBILE')`);
        await queryRunner.query(`CREATE TYPE "public"."plugins_status_enum" AS ENUM('ACTIVE', 'INACTIVE', 'DEPRECATED', 'ARCHIVED')`);
        await queryRunner.query(`CREATE TABLE "plugins" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "type" "public"."plugins_type_enum" NOT NULL DEFAULT 'DESKTOP', "status" "public"."plugins_status_enum" NOT NULL DEFAULT 'ACTIVE', "categoryId" uuid, "author" character varying, "license" character varying, "homepage" character varying, "repository" character varying, "uploadedById" uuid, "uploadedAt" TIMESTAMP, "requiresSubscription" boolean NOT NULL DEFAULT false, "isFeatured" boolean NOT NULL DEFAULT false, "isVerified" boolean NOT NULL DEFAULT false, "lastDownloadedAt" TIMESTAMP, CONSTRAINT "PK_bb3d17826b76295957a253ba73e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."plugin_subscription_plans_type_enum" AS ENUM('free', 'trial', 'basic', 'premium', 'enterprise', 'custom')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_subscription_plans_billingperiod_enum" AS ENUM('daily', 'weekly', 'monthly', 'quarterly', 'yearly', 'one-time')`);
        await queryRunner.query(`CREATE TABLE "plugin_subscription_plans" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "name" character varying NOT NULL, "description" text, "type" "public"."plugin_subscription_plans_type_enum" NOT NULL DEFAULT 'free', "price" numeric(10,2) NOT NULL DEFAULT '0', "currency" character varying(3) NOT NULL DEFAULT 'USD', "billingPeriod" "public"."plugin_subscription_plans_billingperiod_enum" NOT NULL DEFAULT 'monthly', "features" text NOT NULL, "limitations" jsonb, "isPopular" boolean NOT NULL DEFAULT false, "isRecommended" boolean NOT NULL DEFAULT false, "trialDays" integer, "setupFee" numeric(10,2), "discountPercentage" numeric(5,2), "metadata" jsonb, "sortOrder" integer NOT NULL DEFAULT '0', "pluginId" uuid NOT NULL, "createdById" uuid, CONSTRAINT "PK_50d5a1a9d691b355206aa1991d9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_646aa1161ac9861061842e05c2" ON "plugin_subscription_plans" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b874f9ee9c04061b4892926388" ON "plugin_subscription_plans" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6f401b811d14d8b06db0fbea30" ON "plugin_subscription_plans" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a7bf8b446ca66e5824fb6ff91a" ON "plugin_subscription_plans" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_dec9037a57726ae5f54bc3c4a8" ON "plugin_subscription_plans" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_234c8f3d694ae31b095bdf5a8a" ON "plugin_subscription_plans" ("price", "billingPeriod") `);
        await queryRunner.query(`CREATE INDEX "IDX_37c9e1c698331b9345280374fd" ON "plugin_subscription_plans" ("isActive", "type") `);
        await queryRunner.query(`CREATE INDEX "IDX_082f6cba880ecd144b28284376" ON "plugin_subscription_plans" ("pluginId", "type") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_subscriptions_status_enum" AS ENUM('active', 'cancelled', 'expired', 'trial', 'past_due', 'suspended', 'pending')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_subscriptions_scope_enum" AS ENUM('tenant', 'organization', 'user')`);
        await queryRunner.query(`CREATE TABLE "plugin_subscriptions" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "status" "public"."plugin_subscriptions_status_enum" NOT NULL DEFAULT 'pending', "scope" "public"."plugin_subscriptions_scope_enum" NOT NULL DEFAULT 'tenant', "startDate" TIMESTAMP NOT NULL DEFAULT now(), "endDate" TIMESTAMP, "trialEndDate" TIMESTAMP, "autoRenew" boolean NOT NULL DEFAULT true, "cancelledAt" TIMESTAMP, "cancellationReason" text, "metadata" jsonb, "externalSubscriptionId" character varying, "pluginId" uuid NOT NULL, "pluginTenantId" uuid NOT NULL, "planId" uuid, "subscriberId" uuid, "parentId" uuid, CONSTRAINT "PK_6afb264e9a7966e886acd27a2ad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_449b2294593f5787f40a60c8f2" ON "plugin_subscriptions" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ddf7be116060ee20bc16128632" ON "plugin_subscriptions" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0be98c36cdbaa56f3880bc6baa" ON "plugin_subscriptions" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_18743cb5933b78e2b8081589e4" ON "plugin_subscriptions" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_b5163f874ce5bc6b63c8e8631a" ON "plugin_subscriptions" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_7f792e3c1891f728f9e5256142" ON "plugin_subscriptions" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9bbac226cce476576134c5726e" ON "plugin_subscriptions" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7afeffe18364cae48efd454e4d" ON "plugin_subscriptions" ("scope", "tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_39a16aca760fc7a3cef39d5563" ON "plugin_subscriptions" ("parentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_bbd6dc08c0c91724e5d26202fa" ON "plugin_subscriptions" ("externalSubscriptionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_4e8a9f4ee7df8c39d0314063e7" ON "plugin_subscriptions" ("planId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_18db53b62833e1bdb9949b5827" ON "plugin_subscriptions" ("pluginId", "subscriberId", "tenantId") WHERE "subscriberId" IS NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_448990d16086477ee1c5f08968" ON "plugin_subscriptions" ("status", "tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fed0c61e1d142e1c448a45e5a0" ON "plugin_subscriptions" ("status", "endDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_af82eaa17a59e0cf0fac16d7fe" ON "plugin_subscriptions" ("subscriberId", "tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_eb3b9c7cfe7aa86bca589aee9e" ON "plugin_subscriptions" ("pluginId", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_billings_status_enum" AS ENUM('pending', 'processed', 'paid', 'overdue', 'failed', 'cancelled', 'refunded', 'partially_paid')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_billings_billingperiod_enum" AS ENUM('daily', 'weekly', 'monthly', 'quarterly', 'yearly', 'one-time')`);
        await queryRunner.query(`CREATE TABLE "plugin_billings" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "amount" numeric(10,2) NOT NULL, "currency" character varying NOT NULL DEFAULT 'USD', "billingDate" TIMESTAMP NOT NULL, "dueDate" TIMESTAMP NOT NULL, "status" "public"."plugin_billings_status_enum" NOT NULL DEFAULT 'pending', "billingPeriod" "public"."plugin_billings_billingperiod_enum" NOT NULL, "billingPeriodStart" TIMESTAMP NOT NULL, "billingPeriodEnd" TIMESTAMP NOT NULL, "description" text, "metadata" jsonb, "subscriptionId" uuid NOT NULL, CONSTRAINT "PK_53bbb94a70e4a89818bca2de680" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_74d0d8f22af90d92d3213d5e74" ON "plugin_billings" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_2c926e12d6fba9b0d320c974f3" ON "plugin_billings" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8fb8bf376857199096a73d90b8" ON "plugin_billings" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7d05232ee38835a76623154b7b" ON "plugin_billings" ("organizationId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_roles" ("pluginTenantsId" uuid NOT NULL, "roleId" uuid NOT NULL, CONSTRAINT "PK_770563b1a6189b3c8deff187700" PRIMARY KEY ("pluginTenantsId", "roleId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_12c6c6c88720dfb785a0e066bb" ON "plugin_tenant_allowed_roles" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0c355caddd182f2e7099d35911" ON "plugin_tenant_allowed_roles" ("roleId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_users" ("pluginTenantsId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_3fc226e3c68ee9e6d15c28e9674" PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_358b3ee7d6cac92234c829e384" ON "plugin_tenant_allowed_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_99cab633947d311b29e5e3d9f1" ON "plugin_tenant_allowed_users" ("userId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_denied_users" ("pluginTenantsId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_04b34bee67f6a3905b9031c10ed" PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_27e45daf821a522cf6c7b794bc" ON "plugin_tenant_denied_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_17fc7d5ec9f51d9716c79b50ae" ON "plugin_tenant_denied_users" ("userId") `);
        await queryRunner.query(`CREATE TABLE "plugin_categories_closure" ("id_ancestor" uuid NOT NULL, "id_descendant" uuid NOT NULL, CONSTRAINT "PK_f5e8c87cd37537b34e1a8c887e9" PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6eca05af711ef729dbe99f9b63" ON "plugin_categories_closure" ("id_ancestor") `);
        await queryRunner.query(`CREATE INDEX "IDX_ac6e3a024785d6cd7e1dc8a7d0" ON "plugin_categories_closure" ("id_descendant") `);
        await queryRunner.query(`CREATE TABLE "plugin_subscriptions_closure" ("id_ancestor" uuid NOT NULL, "id_descendant" uuid NOT NULL, CONSTRAINT "PK_75160b23192304669eeeeac9533" PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`CREATE INDEX "IDX_31cca01b2ea11308a44475563b" ON "plugin_subscriptions_closure" ("id_ancestor") `);
        await queryRunner.query(`CREATE INDEX "IDX_9c7a67d94dc7edfc580657a52d" ON "plugin_subscriptions_closure" ("id_descendant") `);
        await queryRunner.query(`ALTER TABLE "organization_project" ALTER COLUMN "status" SET DEFAULT 'open'`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_f209a8620f1677ed2c82c4cd2e4" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_0b5cc71673410a449491fb3db93" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_06f10073cd6e84a19b6f604ddd1" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_5df2b63d82f2168e43c2d7e64c1" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_545faee53386f4e9d7b43111047" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_c47db2e2072ba3b570608192467" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tenants" ADD CONSTRAINT "FK_52ca2ab9f943fe3f47df36aef76" FOREIGN KEY ("approvedById") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_5534e36ff3a1416c17f507d5469" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_6b8deef29d0fb5eee571c39b39b" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_a97ab238dc6aff5f305d37dbc72" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_bbced9536ca0a8ee967b531c325" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_d4504369b0f19d2360a464408ad" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_737e0935140d7b17632fc7815ad" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_8e11188fb92db2ee126b53e866e" FOREIGN KEY ("pluginTenantId") REFERENCES "plugin_tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_a8471a91f63494a0d3ec5cf248c" FOREIGN KEY ("categoryId") REFERENCES "plugin_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_settings" ADD CONSTRAINT "FK_734649a34ee071f44de4a14490d" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_60543808734ff13850d7843f7b8" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_c7c4b6b97be418be173859d10da" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_1fa4520b20a0bf4fdfe3ca1ec7b" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_7c239f665e5caedd708c62b1f7a" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_ca31918911db08a4008be72c8e5" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_categories" ADD CONSTRAINT "FK_70bfaf5965c91621dedb183bc81" FOREIGN KEY ("parentId") REFERENCES "plugin_categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_9b013a85a6ae26db17101ffb894" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_ee480ffb800fb2c9f6d91f66aa7" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_09654ebaec00e0c0c4dfae4c427" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_da359f059e06030ec33adba1335" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_8bcd0243b780191a391b348f582" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_05292c8750270ff028ab2fec140" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_tags" ADD CONSTRAINT "FK_df3d0fc648c9e0544ca11df9d2e" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_842e5e5f94c4008a42d4b5f44a6" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_7e9b8b3eebb881753e07b73f6c6" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_a45f5c2aba22d4fa4eb8fa85af8" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_dff9e6c763c8c33b07f330e6a19" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_8aafffefdce2eb11079ec2aa755" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_547e4b71ae81ee772fa4ab79e60" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_acac58b213936ea488d0a8d1a30" FOREIGN KEY ("versionId") REFERENCES "plugin_versions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installations" ADD CONSTRAINT "FK_32c3f7a738ec8b40d6375b2933c" FOREIGN KEY ("installedById") REFERENCES "employee"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_09a383d6f2858d49c064ca4cda9" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_0404416b5c1cd48ae87fe81834a" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_c90b796bd033e54e3719213a0ce" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_19d9135639e3b40ec0dca1c9261" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_7c6dc1cdd58690b7179d76184be" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_sources" ADD CONSTRAINT "FK_55bee446d2c470e5d6b066a27a2" FOREIGN KEY ("versionId") REFERENCES "plugin_versions"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_485db4d1cc977cc3d499824d958" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_0b36b5701e9890a395ded76cb57" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_e06094816e67e584dea754cc81c" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_650ccf2e7394509f7ad8448e323" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_f806bae81cd490404a1888ad5b9" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_versions" ADD CONSTRAINT "FK_8adf7a9181e968bcafc71236c80" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugins" ADD CONSTRAINT "FK_cc5b64091fbfdcdbd23d6da80ee" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugins" ADD CONSTRAINT "FK_61357761fc6b140180b104dc8d5" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugins" ADD CONSTRAINT "FK_3210c015451d02d015a23eedad4" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugins" ADD CONSTRAINT "FK_16d0aed6fcc311379f5c75bbd2d" FOREIGN KEY ("categoryId") REFERENCES "plugin_categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugins" ADD CONSTRAINT "FK_4bf89f98c41969e23e3f9974d56" FOREIGN KEY ("uploadedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" ADD CONSTRAINT "FK_646aa1161ac9861061842e05c2f" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" ADD CONSTRAINT "FK_b874f9ee9c04061b4892926388f" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" ADD CONSTRAINT "FK_6f401b811d14d8b06db0fbea308" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" ADD CONSTRAINT "FK_a06a8b0e7f54e73cfc92c96511b" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" ADD CONSTRAINT "FK_d3afff45d3c259d2d484387a248" FOREIGN KEY ("createdById") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_449b2294593f5787f40a60c8f23" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_ddf7be116060ee20bc16128632d" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_0be98c36cdbaa56f3880bc6baa5" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_7f792e3c1891f728f9e52561428" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_9bbac226cce476576134c5726e2" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_052c95e24f8ac2afdea389d31e0" FOREIGN KEY ("pluginId") REFERENCES "plugins"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_6163fac447615c15bdd3cc4b108" FOREIGN KEY ("pluginTenantId") REFERENCES "plugin_tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_4e8a9f4ee7df8c39d0314063e73" FOREIGN KEY ("planId") REFERENCES "plugin_subscription_plans"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_b76c1241cbcbe8a92cba6d7fbcd" FOREIGN KEY ("subscriberId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions" ADD CONSTRAINT "FK_39a16aca760fc7a3cef39d55638" FOREIGN KEY ("parentId") REFERENCES "plugin_subscriptions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_74d0d8f22af90d92d3213d5e74e" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_2c926e12d6fba9b0d320c974f32" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_8fb8bf376857199096a73d90b86" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_7b12d1d4e5d36737596155ce2d5" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_7d05232ee38835a76623154b7b2" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_billings" ADD CONSTRAINT "FK_3c3212b2cf3a4e6cc6896657bb1" FOREIGN KEY ("subscriptionId") REFERENCES "plugin_subscriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_roles" ADD CONSTRAINT "FK_12c6c6c88720dfb785a0e066bb6" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_roles" ADD CONSTRAINT "FK_0c355caddd182f2e7099d359119" FOREIGN KEY ("roleId") REFERENCES "role"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_users" ADD CONSTRAINT "FK_358b3ee7d6cac92234c829e3844" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_users" ADD CONSTRAINT "FK_99cab633947d311b29e5e3d9f16" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_denied_users" ADD CONSTRAINT "FK_27e45daf821a522cf6c7b794bce" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_denied_users" ADD CONSTRAINT "FK_17fc7d5ec9f51d9716c79b50ae8" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_categories_closure" ADD CONSTRAINT "FK_6eca05af711ef729dbe99f9b634" FOREIGN KEY ("id_ancestor") REFERENCES "plugin_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_categories_closure" ADD CONSTRAINT "FK_ac6e3a024785d6cd7e1dc8a7d08" FOREIGN KEY ("id_descendant") REFERENCES "plugin_categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions_closure" ADD CONSTRAINT "FK_31cca01b2ea11308a44475563b3" FOREIGN KEY ("id_ancestor") REFERENCES "plugin_subscriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions_closure" ADD CONSTRAINT "FK_9c7a67d94dc7edfc580657a52df" FOREIGN KEY ("id_descendant") REFERENCES "plugin_subscriptions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions_closure" DROP CONSTRAINT "FK_9c7a67d94dc7edfc580657a52df"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions_closure" DROP CONSTRAINT "FK_31cca01b2ea11308a44475563b3"`);
        await queryRunner.query(`ALTER TABLE "plugin_categories_closure" DROP CONSTRAINT "FK_ac6e3a024785d6cd7e1dc8a7d08"`);
        await queryRunner.query(`ALTER TABLE "plugin_categories_closure" DROP CONSTRAINT "FK_6eca05af711ef729dbe99f9b634"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_denied_users" DROP CONSTRAINT "FK_17fc7d5ec9f51d9716c79b50ae8"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_denied_users" DROP CONSTRAINT "FK_27e45daf821a522cf6c7b794bce"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_users" DROP CONSTRAINT "FK_99cab633947d311b29e5e3d9f16"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_users" DROP CONSTRAINT "FK_358b3ee7d6cac92234c829e3844"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_roles" DROP CONSTRAINT "FK_0c355caddd182f2e7099d359119"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_roles" DROP CONSTRAINT "FK_12c6c6c88720dfb785a0e066bb6"`);
        await queryRunner.query(`ALTER TABLE "employee_job_preset" DROP CONSTRAINT "FK_7ae5b4d4bdec77971dab319f2e2"`);
        ...
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" DROP CONSTRAINT "FK_d3afff45d3c259d2d484387a248"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" DROP CONSTRAINT "FK_a06a8b0e7f54e73cfc92c96511b"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" DROP CONSTRAINT "FK_6f401b811d14d8b06db0fbea308"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" DROP CONSTRAINT "FK_b874f9ee9c04061b4892926388f"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" DROP CONSTRAINT "FK_646aa1161ac9861061842e05c2f"`);
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_af8978fbf37560525c19ec7048" ON "plugin_sources" ("tenantId", "organizationId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6fae6d0ddfd7177abcb4befd72" ON "plugin_sources" ("versionId", "operatingSystem", "architecture", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE TABLE "plugin_versions" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "number" varchar NOT NULL, "changelog" varchar NOT NULL, "checksum" varchar, "signature" varchar, "releaseDate" datetime, "downloadCount" integer DEFAULT (0), "pluginId" varchar)`);
        await queryRunner.query(`CREATE INDEX "IDX_485db4d1cc977cc3d499824d95" ON "plugin_versions" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0b36b5701e9890a395ded76cb5" ON "plugin_versions" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e06094816e67e584dea754cc81" ON "plugin_versions" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e6d49799b916946e5cd5399385" ON "plugin_versions" ("isActive") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7b12d1d4e5d36737596155ce2d" ON "plugin_billings" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7d05232ee38835a76623154b7b" ON "plugin_billings" ("organizationId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_roles" ("pluginTenantsId" varchar NOT NULL, "roleId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "roleId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_12c6c6c88720dfb785a0e066bb" ON "plugin_tenant_allowed_roles" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0c355caddd182f2e7099d35911" ON "plugin_tenant_allowed_roles" ("roleId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_358b3ee7d6cac92234c829e384" ON "plugin_tenant_allowed_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_99cab633947d311b29e5e3d9f1" ON "plugin_tenant_allowed_users" ("userId") `);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_denied_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_27e45daf821a522cf6c7b794bc" ON "plugin_tenant_denied_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_17fc7d5ec9f51d9716c79b50ae" ON "plugin_tenant_denied_users" ("userId") `);
        await queryRunner.query(`CREATE TABLE "plugin_categories_closure" ("id_ancestor" varchar NOT NULL, "id_descendant" varchar NOT NULL, PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6eca05af711ef729dbe99f9b63" ON "plugin_categories_closure" ("id_ancestor") `);
        await queryRunner.query(`CREATE INDEX "IDX_ac6e3a024785d6cd7e1dc8a7d0" ON "plugin_categories_closure" ("id_descendant") `);
        await queryRunner.query(`CREATE TABLE "plugin_subscriptions_closure" ("id_ancestor" varchar NOT NULL, "id_descendant" varchar NOT NULL, PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`CREATE INDEX "IDX_31cca01b2ea11308a44475563b" ON "plugin_subscriptions_closure" ("id_ancestor") `);
        await queryRunner.query(`CREATE INDEX "IDX_9c7a67d94dc7edfc580657a52d" ON "plugin_subscriptions_closure" ("id_descendant") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d93ae6f56a3b06ddc69ac5fc2e" ON "organization_project" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_408532f0a32e4fef8d2684a97f" ON "organization_project" ("createdByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_47da91256516fc5f08685638fc" ON "organization_project" ("updatedByUserId") `);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_plugin_tenant_allowed_roles" ("pluginTenantsId" varchar NOT NULL, "roleId" varchar NOT NULL, CONSTRAINT "FK_12c6c6c88720dfb785a0e066bb6" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_0c355caddd182f2e7099d359119" FOREIGN KEY ("roleId") REFERENCES "role" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("pluginTenantsId", "roleId"))`);
        await queryRunner.query(`INSERT INTO "temporary_plugin_tenant_allowed_roles"("pluginTenantsId", "roleId") SELECT "pluginTenantsId", "roleId" FROM "plugin_tenant_allowed_roles"`);
        await queryRunner.query(`DROP TABLE "plugin_tenant_allowed_roles"`);
        await queryRunner.query(`ALTER TABLE "temporary_plugin_tenant_allowed_roles" RENAME TO "plugin_tenant_allowed_roles"`);
        await queryRunner.query(`CREATE INDEX "IDX_12c6c6c88720dfb785a0e066bb" ON "plugin_tenant_allowed_roles" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0c355caddd182f2e7099d35911" ON "plugin_tenant_allowed_roles" ("roleId") `);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_plugin_tenant_allowed_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, CONSTRAINT "FK_358b3ee7d6cac92234c829e3844" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_99cab633947d311b29e5e3d9f16" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`INSERT INTO "temporary_plugin_tenant_allowed_users"("pluginTenantsId", "userId") SELECT "pluginTenantsId", "userId" FROM "plugin_tenant_allowed_users"`);
        await queryRunner.query(`DROP TABLE "plugin_tenant_allowed_users"`);
        await queryRunner.query(`ALTER TABLE "temporary_plugin_tenant_allowed_users" RENAME TO "plugin_tenant_allowed_users"`);
        await queryRunner.query(`CREATE INDEX "IDX_358b3ee7d6cac92234c829e384" ON "plugin_tenant_allowed_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_99cab633947d311b29e5e3d9f1" ON "plugin_tenant_allowed_users" ("userId") `);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_plugin_tenant_denied_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, CONSTRAINT "FK_27e45daf821a522cf6c7b794bce" FOREIGN KEY ("pluginTenantsId") REFERENCES "plugin_tenants" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_17fc7d5ec9f51d9716c79b50ae8" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`INSERT INTO "temporary_plugin_tenant_denied_users"("pluginTenantsId", "userId") SELECT "pluginTenantsId", "userId" FROM "plugin_tenant_denied_users"`);
        await queryRunner.query(`DROP TABLE "plugin_tenant_denied_users"`);
        await queryRunner.query(`ALTER TABLE "temporary_plugin_tenant_denied_users" RENAME TO "plugin_tenant_denied_users"`);
        await queryRunner.query(`CREATE INDEX "IDX_27e45daf821a522cf6c7b794bc" ON "plugin_tenant_denied_users" ("pluginTenantsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_17fc7d5ec9f51d9716c79b50ae" ON "plugin_tenant_denied_users" ("userId") `);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_plugin_subscriptions_closure" ("id_ancestor" varchar NOT NULL, "id_descendant" varchar NOT NULL, CONSTRAINT "FK_31cca01b2ea11308a44475563b3" FOREIGN KEY ("id_ancestor") REFERENCES "plugin_subscriptions" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_9c7a67d94dc7edfc580657a52df" FOREIGN KEY ("id_descendant") REFERENCES "plugin_subscriptions" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`INSERT INTO "temporary_plugin_subscriptions_closure"("id_ancestor", "id_descendant") SELECT "id_ancestor", "id_descendant" FROM "plugin_subscriptions_closure"`);
        await queryRunner.query(`DROP TABLE "plugin_subscriptions_closure"`);
        await queryRunner.query(`ALTER TABLE "temporary_plugin_subscriptions_closure" RENAME TO "plugin_subscriptions_closure"`);
        await queryRunner.query(`CREATE INDEX "IDX_31cca01b2ea11308a44475563b" ON "plugin_subscriptions_closure" ("id_ancestor") `);
        await queryRunner.query(`CREATE INDEX "IDX_9c7a67d94dc7edfc580657a52d" ON "plugin_subscriptions_closure" ("id_descendant") `);
    }
    /**
    ...
    async sqliteDownQueryRunner(queryRunner) {
        await queryRunner.query(`DROP INDEX "IDX_9c7a67d94dc7edfc580657a52d"`);
        await queryRunner.query(`DROP INDEX "IDX_31cca01b2ea11308a44475563b"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscriptions_closure" RENAME TO "temporary_plugin_subscriptions_closure"`);
        await queryRunner.query(`CREATE TABLE "plugin_subscriptions_closure" ("id_ancestor" varchar NOT NULL, "id_descendant" varchar NOT NULL, PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`INSERT INTO "plugin_subscriptions_closure"("id_ancestor", "id_descendant") SELECT "id_ancestor", "id_descendant" FROM "temporary_plugin_subscriptions_closure"`);
        await queryRunner.query(`DROP TABLE "temporary_plugin_subscriptions_closure"`);
        await queryRunner.query(`CREATE INDEX "IDX_9c7a67d94dc7edfc580657a52d" ON "plugin_subscriptions_closure" ("id_descendant") `);
        await queryRunner.query(`CREATE INDEX "IDX_31cca01b2ea11308a44475563b" ON "plugin_subscriptions_closure" ("id_ancestor") `);
        await queryRunner.query(`DROP INDEX "IDX_ac6e3a024785d6cd7e1dc8a7d0"`);
        await queryRunner.query(`DROP INDEX "IDX_6eca05af711ef729dbe99f9b63"`);
        await queryRunner.query(`ALTER TABLE "plugin_categories_closure" RENAME TO "temporary_plugin_categories_closure"`);
        await queryRunner.query(`CREATE TABLE "plugin_categories_closure" ("id_ancestor" varchar NOT NULL, "id_descendant" varchar NOT NULL, PRIMARY KEY ("id_ancestor", "id_descendant"))`);
        await queryRunner.query(`INSERT INTO "plugin_categories_closure"("id_ancestor", "id_descendant") SELECT "id_ancestor", "id_descendant" FROM "temporary_plugin_categories_closure"`);
        await queryRunner.query(`DROP TABLE "temporary_plugin_categories_closure"`);
        await queryRunner.query(`CREATE INDEX "IDX_ac6e3a024785d6cd7e1dc8a7d0" ON "plugin_categories_closure" ("id_descendant") `);
        await queryRunner.query(`CREATE INDEX "IDX_6eca05af711ef729dbe99f9b63" ON "plugin_categories_closure" ("id_ancestor") `);
        await queryRunner.query(`DROP INDEX "IDX_17fc7d5ec9f51d9716c79b50ae"`);
        await queryRunner.query(`DROP INDEX "IDX_27e45daf821a522cf6c7b794bc"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_denied_users" RENAME TO "temporary_plugin_tenant_denied_users"`);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_denied_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`INSERT INTO "plugin_tenant_denied_users"("pluginTenantsId", "userId") SELECT "pluginTenantsId", "userId" FROM "temporary_plugin_tenant_denied_users"`);
        await queryRunner.query(`DROP TABLE "temporary_plugin_tenant_denied_users"`);
        await queryRunner.query(`CREATE INDEX "IDX_17fc7d5ec9f51d9716c79b50ae" ON "plugin_tenant_denied_users" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_27e45daf821a522cf6c7b794bc" ON "plugin_tenant_denied_users" ("pluginTenantsId") `);
        await queryRunner.query(`DROP INDEX "IDX_99cab633947d311b29e5e3d9f1"`);
        await queryRunner.query(`DROP INDEX "IDX_358b3ee7d6cac92234c829e384"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_users" RENAME TO "temporary_plugin_tenant_allowed_users"`);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_users" ("pluginTenantsId" varchar NOT NULL, "userId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "userId"))`);
        await queryRunner.query(`INSERT INTO "plugin_tenant_allowed_users"("pluginTenantsId", "userId") SELECT "pluginTenantsId", "userId" FROM "temporary_plugin_tenant_allowed_users"`);
        await queryRunner.query(`DROP TABLE "temporary_plugin_tenant_allowed_users"`);
        await queryRunner.query(`CREATE INDEX "IDX_99cab633947d311b29e5e3d9f1" ON "plugin_tenant_allowed_users" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_358b3ee7d6cac92234c829e384" ON "plugin_tenant_allowed_users" ("pluginTenantsId") `);
        await queryRunner.query(`DROP INDEX "IDX_0c355caddd182f2e7099d35911"`);
        await queryRunner.query(`DROP INDEX "IDX_12c6c6c88720dfb785a0e066bb"`);
        await queryRunner.query(`ALTER TABLE "plugin_tenant_allowed_roles" RENAME TO "temporary_plugin_tenant_allowed_roles"`);
        await queryRunner.query(`CREATE TABLE "plugin_tenant_allowed_roles" ("pluginTenantsId" varchar NOT NULL, "roleId" varchar NOT NULL, PRIMARY KEY ("pluginTenantsId", "roleId"))`);
        await queryRunner.query(`INSERT INTO "plugin_tenant_allowed_roles"("pluginTenantsId", "roleId") SELECT "pluginTenantsId", "roleId" FROM "temporary_plugin_tenant_allowed_roles"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_billings" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "amount" decimal(10,2) NOT NULL, "currency" varchar NOT NULL DEFAULT ('USD'), "billingDate" datetime NOT NULL, "dueDate" datetime NOT NULL, "status" varchar CHECK( "status" IN ('pending','processed','paid','overdue','failed','cancelled','refunded','partially_paid') ) NOT NULL DEFAULT ('pending'), "billingPeriod" varchar CHECK( "billingPeriod" IN ('daily','weekly','monthly','quarterly','yearly','one-time') ) NOT NULL, "billingPeriodStart" datetime NOT NULL, "billingPeriodEnd" datetime NOT NULL, "description" text, "metadata" text, "subscriptionId" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "plugin_billings"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "amount", "currency", "billingDate", "dueDate", "status", "billingPeriod", "billingPeriodStart", "billingPeriodEnd", "description", "metadata", "subscriptionId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "amount", "currency", "billingDate", "dueDate", "status", "billingPeriod", "billingPeriodStart", "billingPeriodEnd", "description", "metadata", "subscriptionId" FROM "temporary_plugin_billings"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_subscriptions" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "status" varchar CHECK( "status" IN ('active','cancelled','expired','trial','past_due','suspended','pending') ) NOT NULL DEFAULT ('pending'), "scope" varchar CHECK( "scope" IN ('tenant','organization','user') ) NOT NULL DEFAULT ('tenant'), "startDate" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "endDate" datetime, "trialEndDate" datetime, "autoRenew" boolean NOT NULL DEFAULT (1), "cancelledAt" datetime, "cancellationReason" text, "metadata" text, "externalSubscriptionId" varchar, "pluginId" varchar NOT NULL, "pluginTenantId" varchar NOT NULL, "planId" varchar, "subscriberId" varchar, "parentId" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_subscriptions"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "status", "scope", "startDate", "endDate", "trialEndDate", "autoRenew", "cancelledAt", "cancellationReason", "metadata", "externalSubscriptionId", "pluginId", "pluginTenantId", "planId", "subscriberId", "parentId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "status", "scope", "startDate", "endDate", "trialEndDate", "autoRenew", "cancelledAt", "cancellationReason", "metadata", "externalSubscriptionId", "pluginId", "pluginTenantId", "planId", "subscriberId", "parentId" FROM "temporary_plugin_subscriptions"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_b874f9ee9c04061b4892926388"`);
        await queryRunner.query(`DROP INDEX "IDX_646aa1161ac9861061842e05c2"`);
        await queryRunner.query(`ALTER TABLE "plugin_subscription_plans" RENAME TO "temporary_plugin_subscription_plans"`);
        await queryRunner.query(`CREATE TABLE "plugin_subscription_plans" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "name" varchar NOT NULL, "description" text, "type" varchar CHECK( "type" IN ('free','trial','basic','premium','enterprise','custom') ) NOT NULL DEFAULT ('free'), "price" decimal(10,2) NOT NULL DEFAULT (0), "currency" varchar(3) NOT NULL DEFAULT ('USD'), "billingPeriod" varchar CHECK( "billingPeriod" IN ('daily','weekly','monthly','quarterly','yearly','one-time') ) NOT NULL DEFAULT ('monthly'), "features" text NOT NULL, "limitations" text, "isPopular" boolean NOT NULL DEFAULT (0), "isRecommended" boolean NOT NULL DEFAULT (0), "trialDays" integer, "setupFee" decimal(10,2), "discountPercentage" decimal(5,2), "metadata" text, "sortOrder" integer NOT NULL DEFAULT (0), "pluginId" varchar NOT NULL, "createdById" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_subscription_plans"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "name", "description", "type", "price", "currency", "billingPeriod", "features", "limitations", "isPopular", "isRecommended", "trialDays", "setupFee", "discountPercentage", "metadata", "sortOrder", "pluginId", "createdById") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "name", "description", "type", "price", "currency", "billingPeriod", "features", "limitations", "isPopular", "isRecommended", "trialDays", "setupFee", "discountPercentage", "metadata", "sortOrder", "pluginId", "createdById" FROM "temporary_plugin_subscription_plans"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugins" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "name" varchar NOT NULL, "description" varchar, "type" varchar CHECK( "type" IN ('DESKTOP','WEB','MOBILE') ) NOT NULL DEFAULT ('DESKTOP'), "status" varchar CHECK( "status" IN ('ACTIVE','INACTIVE','DEPRECATED','ARCHIVED') ) NOT NULL DEFAULT ('ACTIVE'), "categoryId" varchar, "author" varchar, "license" varchar, "homepage" varchar, "repository" varchar, "uploadedById" varchar, "uploadedAt" datetime, "requiresSubscription" boolean NOT NULL DEFAULT (0), "isFeatured" boolean NOT NULL DEFAULT (0), "isVerified" boolean NOT NULL DEFAULT (0), "lastDownloadedAt" datetime)`);
        await queryRunner.query(`INSERT INTO "plugins"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "name", "description", "type", "status", "categoryId", "author", "license", "homepage", "repository", "uploadedById", "uploadedAt", "requiresSubscription", "isFeatured", "isVerified", "lastDownloadedAt") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "name", "description", "type", "status", "categoryId", "author", "license", "homepage", "repository", "uploadedById", "uploadedAt", "requiresSubscription", "isFeatured", "isVerified", "lastDownloadedAt" FROM "temporary_plugins"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_versions" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "number" varchar NOT NULL, "changelog" varchar NOT NULL, "checksum" varchar, "signature" varchar, "releaseDate" datetime, "downloadCount" integer DEFAULT (0), "pluginId" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_versions"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId" FROM "temporary_plugin_versions"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_sources" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "type" varchar CHECK( "type" IN ('CDN','NPM','GAUZY') ) NOT NULL DEFAULT ('GAUZY'), "operatingSystem" varchar CHECK( "operatingSystem" IN ('LINUX','MAC','WINDOWS','UNIVERSAL') ) NOT NULL DEFAULT ('UNIVERSAL'), "architecture" varchar CHECK( "architecture" IN ('X64','ARM') ) NOT NULL DEFAULT ('X64'), "url" varchar, "integrity" varchar, "crossOrigin" varchar, "name" varchar, "registry" varchar, "private" boolean DEFAULT (0), "scope" varchar, "filePath" varchar, "fileName" varchar, "fileSize" integer, "mimeType" varchar, "fileKey" varchar, "versionId" varchar, "storageProvider" varchar CHECK( "storageProvider" IN ('LOCAL','S3','WASABI','CLOUDINARY','DIGITALOCEAN') ))`);
        await queryRunner.query(`INSERT INTO "plugin_sources"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type", "operatingSystem", "architecture", "url", "integrity", "crossOrigin", "name", "registry", "private", "scope", "filePath", "fileName", "fileSize", "mimeType", "fileKey", "versionId", "storageProvider") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type", "operatingSystem", "architecture", "url", "integrity", "crossOrigin", "name", "registry", "private", "scope", "filePath", "fileName", "fileSize", "mimeType", "fileKey", "versionId", "storageProvider" FROM "temporary_plugin_sources"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_installations" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "pluginId" varchar(36), "versionId" varchar(36), "installedById" varchar(36), "installedAt" datetime, "uninstalledAt" datetime, "status" varchar CHECK( "status" IN ('INSTALLED','UNINSTALLED','FAILED','IN_PROGRESS') ) NOT NULL DEFAULT ('IN_PROGRESS'), "isActivated" boolean NOT NULL DEFAULT (0), "activatedAt" datetime, "deactivatedAt" datetime)`);
        await queryRunner.query(`INSERT INTO "plugin_installations"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "versionId", "installedById", "installedAt", "uninstalledAt", "status", "isActivated", "activatedAt", "deactivatedAt") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "versionId", "installedById", "installedAt", "uninstalledAt", "status", "isActivated", "activatedAt", "deactivatedAt" FROM "temporary_plugin_installations"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_tags" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "pluginId" varchar NOT NULL, "tagId" varchar NOT NULL, "appliedAt" text DEFAULT (CURRENT_TIMESTAMP), "appliedById" varchar, "priority" integer DEFAULT (50), "isFeatured" boolean NOT NULL DEFAULT (0))`);
        await queryRunner.query(`INSERT INTO "plugin_tags"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "tagId", "appliedAt", "appliedById", "priority", "isFeatured") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "tagId", "appliedAt", "appliedById", "priority", "isFeatured" FROM "temporary_plugin_tags"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_categories" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "description" text, "slug" varchar NOT NULL, "color" varchar, "icon" varchar, "order" integer NOT NULL DEFAULT (0), "metadata" text, "parentId" varchar, CONSTRAINT "UQ_d427c34c4dd721c72d5d56187f9" UNIQUE ("slug"))`);
        await queryRunner.query(`INSERT INTO "plugin_categories"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "name", "description", "slug", "color", "icon", "order", "metadata", "parentId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "name", "description", "slug", "color", "icon", "order", "metadata", "parentId" FROM "temporary_plugin_categories"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_settings" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "key" varchar NOT NULL, "value" text NOT NULL, "isRequired" boolean NOT NULL DEFAULT (0), "isEncrypted" boolean NOT NULL DEFAULT (0), "description" text, "order" integer, "validationRules" text, "dataType" varchar CHECK( "dataType" IN ('string','number','boolean','json','file') ) NOT NULL DEFAULT ('string'), "defaultValue" varchar, "pluginId" varchar NOT NULL, "pluginTenantId" varchar, "categoryId" varchar, "updatedById" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_settings"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "key", "value", "isRequired", "isEncrypted", "description", "order", "validationRules", "dataType", "defaultValue", "pluginId", "pluginTenantId", "categoryId", "updatedById") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "key", "value", "isRequired", "isEncrypted", "description", "order", "validationRules", "dataType", "defaultValue", "pluginId", "pluginTenantId", "categoryId", "updatedById" FROM "temporary_plugin_settings"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_tenants" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "pluginId" varchar NOT NULL, "enabled" boolean NOT NULL DEFAULT (1), "scope" varchar CHECK( "scope" IN ('tenant','organization','user') ) NOT NULL DEFAULT ('user'), "autoInstall" boolean NOT NULL DEFAULT (0), "requiresApproval" boolean NOT NULL DEFAULT (1), "isMandatory" boolean NOT NULL DEFAULT (0), "maxInstallations" integer, "maxActiveUsers" integer, "currentInstallations" integer NOT NULL DEFAULT (0), "currentActiveUsers" integer NOT NULL DEFAULT (0), "tenantConfiguration" text, "preferences" text, "approvedAt" text, "isDataCompliant" boolean NOT NULL DEFAULT (1), "complianceCertifications" text, "approvedById" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_tenants"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "enabled", "scope", "autoInstall", "requiresApproval", "isMandatory", "maxInstallations", "maxActiveUsers", "currentInstallations", "currentActiveUsers", "tenantConfiguration", "preferences", "approvedAt", "isDataCompliant", "complianceCertifications", "approvedById") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "pluginId", "enabled", "scope", "autoInstall", "requiresApproval", "isMandatory", "maxInstallations", "maxActiveUsers", "currentInstallations", "currentActiveUsers", "tenantConfiguration", "preferences", "approvedAt", "isDataCompliant", "complianceCertifications", "approvedById" FROM "temporary_plugin_tenants"`);
        ...
        await queryRunner.query(`INSERT INTO "time_slot_session"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "sessionId", "startTime", "lastActivity", "timeSlotId", "employeeId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "sessionId", "startTime", "lastActivity", "timeSlotId", "employeeId" FROM "temporary_time_slot_session"`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions_closure\` DROP FOREIGN KEY \`FK_9c7a67d94dc7edfc580657a52df\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions_closure\` DROP FOREIGN KEY \`FK_31cca01b2ea11308a44475563b3\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories_closure\` DROP FOREIGN KEY \`FK_ac6e3a024785d6cd7e1dc8a7d08\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories_closure\` DROP FOREIGN KEY \`FK_6eca05af711ef729dbe99f9b634\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_denied_users\` DROP FOREIGN KEY \`FK_17fc7d5ec9f51d9716c79b50ae8\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_denied_users\` DROP FOREIGN KEY \`FK_27e45daf821a522cf6c7b794bce\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_allowed_users\` DROP FOREIGN KEY \`FK_99cab633947d311b29e5e3d9f16\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_allowed_users\` DROP FOREIGN KEY \`FK_358b3ee7d6cac92234c829e3844\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_allowed_roles\` DROP FOREIGN KEY \`FK_0c355caddd182f2e7099d359119\``);
        await queryRunner.query(`ALTER TABLE \`plugin_tenant_allowed_roles\` DROP FOREIGN KEY \`FK_12c6c6c88720dfb785a0e066bb6\``);
        await queryRunner.query(`ALTER TABLE \`employee_job_preset\` DROP FOREIGN KEY \`FK_7ae5b4d4bdec77971dab319f2e2\``);
        ...
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_39a16aca760fc7a3cef39d55638\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_b76c1241cbcbe8a92cba6d7fbcd\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_4e8a9f4ee7df8c39d0314063e73\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_6163fac447615c15bdd3cc4b108\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_052c95e24f8ac2afdea389d31e0\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_9bbac226cce476576134c5726e2\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_7f792e3c1891f728f9e52561428\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_0be98c36cdbaa56f3880bc6baa5\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_ddf7be116060ee20bc16128632d\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscriptions\` DROP FOREIGN KEY \`FK_449b2294593f5787f40a60c8f23\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscription_plans\` DROP FOREIGN KEY \`FK_d3afff45d3c259d2d484387a248\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscription_plans\` DROP FOREIGN KEY \`FK_a06a8b0e7f54e73cfc92c96511b\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscription_plans\` DROP FOREIGN KEY \`FK_6f401b811d14d8b06db0fbea308\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscription_plans\` DROP FOREIGN KEY \`FK_b874f9ee9c04061b4892926388f\``);
        await queryRunner.query(`ALTER TABLE \`plugin_subscription_plans\` DROP FOREIGN KEY \`FK_646aa1161ac9861061842e05c2f\``);
        ...
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_32c3f7a738ec8b40d6375b2933c\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_acac58b213936ea488d0a8d1a30\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_547e4b71ae81ee772fa4ab79e60\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_8aafffefdce2eb11079ec2aa755\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_dff9e6c763c8c33b07f330e6a19\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_a45f5c2aba22d4fa4eb8fa85af8\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_7e9b8b3eebb881753e07b73f6c6\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installations\` DROP FOREIGN KEY \`FK_842e5e5f94c4008a42d4b5f44a6\``);
        ...
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_70bfaf5965c91621dedb183bc81\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_ca31918911db08a4008be72c8e5\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_7c239f665e5caedd708c62b1f7a\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_1fa4520b20a0bf4fdfe3ca1ec7b\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_c7c4b6b97be418be173859d10da\``);
        await queryRunner.query(`ALTER TABLE \`plugin_categories\` DROP FOREIGN KEY \`FK_60543808734ff13850d7843f7b8\``);
...
exports.CreatePluginMarketplaceTables1766045577607 = CreatePluginMarketplaceTables1766045577607;
//# sourceMappingURL=1766045577607-CreatePluginMarketplaceTables.js.map