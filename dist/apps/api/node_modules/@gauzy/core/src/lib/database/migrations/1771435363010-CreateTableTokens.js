...
exports.CreateTableTokens1771435363010 = void 0;
const config_1 = require("@gauzy/config");
const chalk = require("chalk");
class CreateTableTokens1771435363010 {
    constructor() {
        this.name = 'CreateTableTokens1771435363010';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6777a5343aac1f6040b6bb872e" ON "tokens" ("rotatedFromTokenId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_07481c6f9a1bb2232215ff79b8" ON "tokens" ("userId", "tokenType", "status") `);
        ...
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_d1a23e22ed7aaed288357bdfcda" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_1adbf8d74a9eb8ce9510f938a32" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_daa87dd8ed79915baebce5c9ce4" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_6777a5343aac1f6040b6bb872e2" FOREIGN KEY ("rotatedFromTokenId") REFERENCES "tokens"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_630f6f12a435e5ef50350b1ddb3" FOREIGN KEY ("rotatedToTokenId") REFERENCES "tokens"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tokens" ADD CONSTRAINT "FK_d82ec12d7a61f38cb34ea3a0543" FOREIGN KEY ("revokedById") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    async postgresDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "knowledge_base_article_version" ALTER COLUMN "lastSavedAt" SET DEFAULT now()`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "tokens" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tokenHash" varchar(255) NOT NULL, "tokenType" varchar(50) NOT NULL, "status" varchar CHECK( "status" IN ('ACTIVE','REVOKED','EXPIRED','ROTATED') ) NOT NULL DEFAULT ('ACTIVE'), "expiresAt" datetime, "lastUsedAt" datetime, "usageCount" integer NOT NULL DEFAULT (0), "rotatedFromTokenId" varchar, "rotatedToTokenId" varchar, "revokedAt" datetime, "revokedReason" varchar(255), "revokedById" varchar, "metadata" text, "version" integer NOT NULL, "userId" varchar NOT NULL)`);
        await queryRunner.query(`INSERT INTO "tokens"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tokenHash", "tokenType", "status", "expiresAt", "lastUsedAt", "usageCount", "rotatedFromTokenId", "rotatedToTokenId", "revokedAt", "revokedReason", "revokedById", "metadata", "version", "userId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tokenHash", "tokenType", "status", "expiresAt", "lastUsedAt", "usageCount", "rotatedFromTokenId", "rotatedToTokenId", "revokedAt", "revokedReason", "revokedById", "metadata", "version", "userId" FROM "temporary_tokens"`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`knowledge_base_article_version\` DROP COLUMN \`lastSavedAt\``);
        await queryRunner.query(`ALTER TABLE \`knowledge_base_article_version\` ADD \`lastSavedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
...
exports.CreateTableTokens1771435363010 = CreateTableTokens1771435363010;
//# sourceMappingURL=1771435363010-CreateTableTokens.js.map