...
exports.CreateTermsAcceptanceTable1785000000000 = void 0;
const chalk = require("chalk");
const typeorm_1 = require("terms-acceptance/typeorm");
 ...
 */
class CreateTermsAcceptanceTable1785000000000 {
    constructor() {
        this.name = 'CreateTermsAcceptanceTable1785000000000';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        for (const statement of typeorm_1.migrationSql.up) {
    ...
    async postgresDownQueryRunner(queryRunner) {
        for (const statement of typeorm_1.migrationSql.down) {
            await queryRunner.query(statement);
        }
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "terms_acceptance" ("id" varchar(128) PRIMARY KEY NOT NULL, "subject_id" varchar(255) NOT NULL, "tenant_id" varchar(255), "document_id" varchar(255) NOT NULL, "version" varchar(64) NOT NULL, "sha256" varchar(64) NOT NULL, "accepted_at" datetime NOT NULL, "locale" varchar(35) NOT NULL, "ip_hash" varchar(64), "user_agent" varchar(512), "method" varchar(64) NOT NULL, "metadata" text, "fingerprint" varchar(64) NOT NULL)`);
        await queryRunner.query(`CREATE UNIQUE INDEX "terms_acceptance_unique_idx" ON "terms_acceptance" ("subject_id", "tenant_id", "document_id", "version")`);
        await queryRunner.query(`CREATE INDEX "terms_acceptance_subject_idx" ON "terms_acceptance" ("subject_id", "document_id", "accepted_at")`);
        await queryRunner.query(`CREATE INDEX "terms_acceptance_document_idx" ON "terms_acceptance" ("document_id", "version")`);
    }
    /**
    ...
    async mysqlUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`terms_acceptance\` (\`id\` varchar(128) NOT NULL, \`subject_id\` varchar(255) NOT NULL, \`tenant_id\` varchar(255) NULL, \`document_id\` varchar(255) NOT NULL, \`version\` varchar(64) NOT NULL, \`sha256\` varchar(64) NOT NULL, \`accepted_at\` datetime(3) NOT NULL, \`locale\` varchar(35) NOT NULL, \`ip_hash\` varchar(64) NULL, \`user_agent\` varchar(512) NULL, \`method\` varchar(64) NOT NULL, \`metadata\` json NULL, \`fingerprint\` varchar(64) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`terms_acceptance_unique_idx\` ON \`terms_acceptance\` (\`subject_id\`, \`tenant_id\`, \`document_id\`, \`version\`)`);
        await queryRunner.query(`CREATE INDEX \`terms_acceptance_subject_idx\` ON \`terms_acceptance\` (\`subject_id\`, \`document_id\`, \`accepted_at\`)`);
        await queryRunner.query(`CREATE INDEX \`terms_acceptance_document_idx\` ON \`terms_acceptance\` (\`document_id\`, \`version\`)`);
    }
...
exports.CreateTermsAcceptanceTable1785000000000 = CreateTermsAcceptanceTable1785000000000;
//# sourceMappingURL=1785000000000-CreateTermsAcceptanceTable.js.map