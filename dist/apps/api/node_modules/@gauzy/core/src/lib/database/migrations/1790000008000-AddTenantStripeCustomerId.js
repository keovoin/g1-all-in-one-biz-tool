...
exports.AddTenantStripeCustomerId1790000008000 = void 0;
 ...
 */
class AddTenantStripeCustomerId1790000008000 {
    constructor() {
        this.name = 'AddTenantStripeCustomerId1790000008000';
    }
    ...
    dialectFor(queryRunner) {
        const type = queryRunner.connection.options.type;
        if (type === config_1.DatabaseTypeEnum.postgres)
            return AddTenantStripeCustomerId1790000008000.DIALECTS.postgres;
        if (type === config_1.DatabaseTypeEnum.mysql)
            return AddTenantStripeCustomerId1790000008000.DIALECTS.mysql;
        if (type === config_1.DatabaseTypeEnum.sqlite || type === config_1.DatabaseTypeEnum.betterSqlite3) {
            return AddTenantStripeCustomerId1790000008000.DIALECTS.sqlite;
        }
        throw new Error(`Unsupported database: ${type}`);
    }
}
exports.AddTenantStripeCustomerId1790000008000 = AddTenantStripeCustomerId1790000008000;
/** Each driver's four statements, already quoted the way that driver expects. */
AddTenantStripeCustomerId1790000008000.DIALECTS = {
    postgres: {
...
//# sourceMappingURL=1790000008000-AddTenantStripeCustomerId.js.map