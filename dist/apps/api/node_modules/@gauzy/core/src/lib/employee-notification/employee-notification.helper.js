...
exports.generateNotificationTitle = generateNotificationTitle;
const contracts_1 = require("@gauzy/contracts");
const EmployeeNotificationTemplates = {
    [contracts_1.NotificationActionTypeEnum.Paid]: `You have been {action}`,
    [contracts_1.NotificationActionTypeEnum.Commented]: `{employeeName} {action} on {entity} "{entityName}"`,
    [contracts_1.NotificationActionTypeEnum.Assigned]: `{employeeName} {action} you to the {entity} "{entityName}"`,
    [contracts_1.NotificationActionTypeEnum.Invited]: `{employeeName} {action} you to join the {entity} "{entityName}"`,
    [contracts_1.NotificationActionTypeEnum.Mentioned]: `{employeeName} {action} you on the {entity} "{entityName}"`,
    [contracts_1.NotificationActionTypeEnum.Messaged]: `{employeeName} sent you a new message`,
    [contracts_1.NotificationActionTypeEnum.Broadcasted]: `{employeeName} published a new broadcast: "{entityName}"`
};
/**
 ...
 */
function generateNotificationTitle(action, entity, entityName, employeeName) {
...
//# sourceMappingURL=employee-notification.helper.js.map