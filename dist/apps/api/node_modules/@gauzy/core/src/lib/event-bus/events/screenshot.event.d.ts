 ...
 */
export declare class ScreenshotEvent extends BaseEntityEvent<Screenshot, ScreenshotInputTypes> {
     ...
     */
    constructor(ctx: RequestContext, entity: Screenshot, type: BaseEntityEventType, input?: ScreenshotInputTypes, data?: Buffer, file?: UploadedFile);
}
export {};
