...
exports.generateImportArchiveFileName = generateImportArchiveFileName;
 ...
 */
function generateImportArchiveFileName() {
    return `.import-${(0, node_crypto_1.randomUUID)()}.zip`;
}
//# sourceMappingURL=import-archive-file-name.js.map