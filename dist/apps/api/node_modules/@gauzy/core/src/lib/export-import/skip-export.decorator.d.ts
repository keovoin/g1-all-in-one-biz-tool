 ...
 */
export declare const SKIP_EXPORT_METADATA = "skipExport";
/**
 ...
 */
export declare function SkipExport(): ClassDecorator;
/**
 ...
 */
export declare function skipExport(...entities: Function[]): void;
/**
 ...
 */
export declare function isExportSkipped(entity: Function): boolean;
