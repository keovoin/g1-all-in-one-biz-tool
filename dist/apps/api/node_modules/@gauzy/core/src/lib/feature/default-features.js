...
const features = config_1.gauzyToggleFeatures;
exports.DEFAULT_FEATURES = [
    {
        name: 'Dashboard',
        code: contracts_1.FeatureEnum.FEATURE_DASHBOARD,
    ...
    {
        name: 'Time Tracking',
        code: contracts_1.FeatureEnum.FEATURE_TIME_TRACKING,
    ...
    {
        name: 'Estimate',
        code: contracts_1.FeatureEnum.FEATURE_ESTIMATE,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ESTIMATE_RECEIVED,
    ...
    {
        name: 'Invoice',
        code: contracts_1.FeatureEnum.FEATURE_INVOICE,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_INVOICE_RECEIVED,
    ...
    {
        name: 'Income',
        code: contracts_1.FeatureEnum.FEATURE_INCOME,
    ...
    {
        name: 'Expense',
        code: contracts_1.FeatureEnum.FEATURE_EXPENSE,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_RECURRING_EXPENSE,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_RECURRING_EXPENSE,
    ...
    {
        name: 'Payment',
        code: contracts_1.FeatureEnum.FEATURE_PAYMENT,
    ...
    {
        name: 'Proposal',
        code: contracts_1.FeatureEnum.FEATURE_PROPOSAL,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_PROPOSAL_TEMPLATE,
    ...
    {
        name: 'Sales Pipeline',
        code: contracts_1.FeatureEnum.FEATURE_PIPELINE,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_PIPELINE_DEAL,
    ...
    {
        name: 'Task Dashboard',
        code: contracts_1.FeatureEnum.FEATURE_DASHBOARD_TASK,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_TEAM_TASK,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_MY_TASK,
    ...
    {
        name: 'Jobs',
        code: contracts_1.FeatureEnum.FEATURE_JOB,
    ...
    {
        name: 'Employees',
        code: contracts_1.FeatureEnum.FEATURE_EMPLOYEES,
        ...
        children: [
            {
                name: 'Employee Level',
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_LEVEL,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_POSITION,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_TIMEOFF,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_APPROVAL,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_APPROVAL_POLICY,
    ...
    {
        name: 'Time Activity',
        code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_TIME_ACTIVITY,
    ...
    {
        name: 'Timesheet',
        code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_TIMESHEETS,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_APPOINTMENT,
    ...
    {
        name: 'Candidate',
        code: contracts_1.FeatureEnum.FEATURE_EMPLOYEE_CANDIDATE,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_MANAGE_INTERVIEW,
            ...
            {
                name: 'Manage Invite',
                code: contracts_1.FeatureEnum.FEATURE_MANAGE_INVITE,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION,
        ...
        children: [
            {
                name: 'Help Center',
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_HELP_CENTER,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_TAG,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_EQUIPMENT,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_VENDOR,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_DEPARTMENT,
            ...
            },
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_EMPLOYMENT_TYPE,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_INVENTORY,
    ...
    {
        name: 'Project',
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_PROJECT,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_TEAM,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATION_DOCUMENT,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_CONTACT,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_GOAL,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_GOAL_SETTING,
    ...
    {
        name: 'All Report',
        code: contracts_1.FeatureEnum.FEATURE_REPORT,
    ...
    {
        name: 'Users',
        code: contracts_1.FeatureEnum.FEATURE_USER,
    ...
    {
        name: 'Organizations',
        code: contracts_1.FeatureEnum.FEATURE_ORGANIZATIONS,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_APP_INTEGRATION,
    ...
    {
        name: 'Email History',
        code: contracts_1.FeatureEnum.FEATURE_EMAIL_HISTORY,
        ...
        children: [
            {
                ...
                code: contracts_1.FeatureEnum.FEATURE_EMAIL_TEMPLATE,
    ...
    {
        name: 'Setting',
        code: contracts_1.FeatureEnum.FEATURE_SETTING,
        ...
        children: [
            {
                name: 'File Storage',
                code: contracts_1.FeatureEnum.FEATURE_FILE_STORAGE,
            ...
            {
                name: 'SMS Gateway',
                code: contracts_1.FeatureEnum.FEATURE_SMS_GATEWAY,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_IMPORT_EXPORT,
    ...
    {
        name: 'Custom SMTP',
        code: contracts_1.FeatureEnum.FEATURE_SMTP,
    ...
    },
    {
        ...
        code: contracts_1.FeatureEnum.FEATURE_ROLES_PERMISSION,
    ...
    {
        name: 'Documents',
        code: contracts_1.FeatureEnum.FEATURE_DOCUMENTS,
