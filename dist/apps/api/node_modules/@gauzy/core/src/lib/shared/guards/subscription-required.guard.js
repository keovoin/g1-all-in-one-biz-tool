...
exports.SubscriptionRequiredGuard = void 0;
const tslib_1 = require("tslib");
const common_1 = require("@nestjs/common");
const stripe_subscription_service_1 = require("../billing/stripe-subscription.service");
/**
 ...
 */
let SubscriptionRequiredGuard = class SubscriptionRequiredGuard {
    ...
    async canActivate(context) {
        ...
        if (entitlement === stripe_subscription_service_1.EntitlementResult.NOT_ENTITLED) {
            throw new common_1.ForbiddenException({
                message: 'A subscription is required before you can create an account. ' +
...
exports.SubscriptionRequiredGuard = SubscriptionRequiredGuard;
exports.SubscriptionRequiredGuard = SubscriptionRequiredGuard = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [stripe_subscription_service_1.StripeSubscriptionService])
], SubscriptionRequiredGuard);
//# sourceMappingURL=subscription-required.guard.js.map