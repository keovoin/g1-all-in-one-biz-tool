...
exports.DEFAULT_GLOBAL_STATUSES = [
    {
        name: contracts_1.TaskStatusEnum.BACKLOG,
        value: contracts_1.TaskStatusEnum.BACKLOG,
    ...
    {
        name: contracts_1.TaskStatusEnum.DONE,
        value: contracts_1.TaskStatusEnum.DONE,
    ...
    {
        name: contracts_1.TaskStatusEnum.CANCELLED,
        value: contracts_1.TaskStatusEnum.CANCELLED,
    ...
    {
        name: contracts_1.TaskStatusEnum.CUSTOM,
        value: contracts_1.TaskStatusEnum.CUSTOM,
