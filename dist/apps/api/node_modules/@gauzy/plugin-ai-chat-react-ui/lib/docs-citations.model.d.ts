 ...
 */
export declare const DOCS_CITATIONS_PART_TYPE = "data-docs-citations";
...
export declare const MAX_CHIPS = 8;
 ...
 */
export declare function citationLabel(citation: IDocsCitation, translate?: CitationTranslate): string;
/**
 ...
 */
export declare function selectCitations(citations: IDocsCitation[]): IDocsCitation[];
