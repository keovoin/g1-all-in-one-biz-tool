 ...
 */
export declare class SpeechProviderError extends Error {
    ...
    readonly name = "SpeechProviderError";
...
export declare function isSpeechProviderError(error: unknown): error is SpeechProviderError;
