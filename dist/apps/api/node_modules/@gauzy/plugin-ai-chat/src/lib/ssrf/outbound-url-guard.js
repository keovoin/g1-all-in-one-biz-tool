...
exports.ALLOW_PRIVATE_BASE_URLS_ENV = void 0;
exports.isPrivateAiProviderBaseUrlAllowed = isPrivateAiProviderBaseUrlAllowed;
exports.isPrivateAiProviderEndpointAllowed = isPrivateAiProviderEndpointAllowed;
exports.getUnsafeAiOutboundUrlReason = getUnsafeAiOutboundUrlReason;
exports.getUnsafeAiProviderBaseUrlReason = getUnsafeAiProviderBaseUrlReason;
 ...
 */
exports.ALLOW_PRIVATE_BASE_URLS_ENV = 'GAUZY_AI_CHAT_ALLOW_PRIVATE_BASE_URLS';
/**
...
function isPrivateAiProviderBaseUrlAllowed() {
    return (process.env[exports.ALLOW_PRIVATE_BASE_URLS_ENV] ?? '').trim().toLowerCase() === 'true';
}
/**
 ...
 */
function isPrivateAiProviderEndpointAllowed(credentials) {
    if (!credentials) {
 ...
 */
function getUnsafeAiOutboundUrlReason(url, options) {
    ...
    if (allowPrivate && (0, utils_1.isPrivateOrLoopbackHost)(parsed.hostname)) {
        ...
        return (0, utils_1.getUnsafeOutboundUrlReason)(probe.toString(), { allowHttp: true });
    }
    return (0, utils_1.getUnsafeOutboundUrlReason)(candidate, { allowHttp: true });
}
/**
 ...
 */
function getUnsafeAiProviderBaseUrlReason(url, options) {
    if (typeof url !== 'string' || url.trim().length === 0) {
...
function isSafeAiProviderBaseUrl(url, options) {
    return getUnsafeAiProviderBaseUrlReason(url, options) === null;
}
//# sourceMappingURL=outbound-url-guard.js.map