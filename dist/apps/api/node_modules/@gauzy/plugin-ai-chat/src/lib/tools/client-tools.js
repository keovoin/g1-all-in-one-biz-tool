...
async function buildClientTools() {
    ...
    return {
        list_pages: tool({
            description: 'List the Sastra platform pages the current user can open in the canvas (main content area). ' +
                'Returns page paths, titles and descriptions. Use before open_page when unsure of a path.',
            inputSchema: zod_1.z.object({})
        }),
        open_page: tool({
            description: 'Open a Sastra platform page in the canvas (the main content area next to this chat). ' +
