...
exports.deepgramProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.DEEPGRAM;
...
const transcribeAudio = async (audio, mimeType, credentials, options) => {
    ...
    const base = (0, plugin_ai_chat_1.trimTrailingSlash)(credentials.baseUrl || DEFAULT_BASE_URL);
    return (0, plugin_ai_chat_1.speechRequest)({
        ...
        parse: (body) => body.results?.channels?.[0]?.alternatives?.[0]?.transcript ?? ''
    });
};
/**
 ...
 */
exports.deepgramProviderDefinition = {
    id: PROVIDER_ID,
    label: 'Deepgram',
...
//# sourceMappingURL=ai-provider-deepgram.provider.js.map