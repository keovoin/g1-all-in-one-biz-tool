...
exports.mistralProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.MISTRAL;
...
const listCatalogue = async (credentials) => (0, plugin_ai_chat_1.keyedCatalogue)({
    ...
    load: async (resolved) => {
        const body = await (0, plugin_ai_chat_1.fetchCatalogueJson)(`${DEFAULT_BASE_URL}/models`, { headers: { authorization: `Bearer ${resolved.apiKey}` } });
 ...
 */
exports.mistralProviderDefinition = {
    id: PROVIDER_ID,
    label: 'Mistral',
...
//# sourceMappingURL=ai-provider-mistral.provider.js.map