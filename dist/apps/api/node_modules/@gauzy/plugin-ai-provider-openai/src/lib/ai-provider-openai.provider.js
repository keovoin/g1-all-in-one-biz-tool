...
exports.openAiProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.OPENAI;
/**
...
const listCatalogue = async (credentials) => (0, plugin_ai_chat_1.keyedCatalogue)({
    ...
    load: async (resolved) => {
        const body = await (0, plugin_ai_chat_1.fetchCatalogueJson)('https://api.openai.com/v1/models', {
 ...
 * have failed.
 */
const transcribeAudio = async (audio, mimeType, credentials, options) => (0, plugin_ai_chat_1.transcribeViaOpenAiCompatible)({
 ...
 */
exports.openAiProviderDefinition = {
    id: PROVIDER_ID,
    label: 'OpenAI',
    ...
    async createModel(modelId, credentials) {
        const { createOpenAI } = await (0, plugin_ai_chat_1.importEsm)('@ai-sdk/openai');
...
//# sourceMappingURL=ai-provider-openai.provider.js.map