...
const PANEL_SUPPORTED_WIDTHS = [4, 6, 8, 12];
/**
 ...
 */
const COUNTER_CONTEXT = ['organization', 'dateRange'];
/**
 ...
 */
export const DASHBOARD_TIME_TRACK_WIDGETS = [
    {
        location: 'dashboard',
    ...
    },
    {
        ...
        permissions: [],
        loadComponent: () => import('./recent-activities-widget.component').then((m) => m.RecentActivitiesWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'time-tracking',
...
//# sourceMappingURL=dashboard-time-track.widgets.js.map