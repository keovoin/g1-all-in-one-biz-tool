...
export class EmptyStateComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: EmptyStateComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.7", type: EmptyStateComponent, isStandalone: false, selector: "gz-docs-empty-state", inputs: { variant: "variant" }, outputs: { primaryAction: "primaryAction" }, ngImport: i0, template: `
	...
	`, isInline: true, styles: [":host{display:block;width:100%}.docs-empty{display:flex;flex-direction:column;align-items:center;gap:.5rem;padding:2rem 1.25rem;text-align:center;color:var(--docs-text-muted, var(--text-hint-color))}.docs-empty h6{margin:0;font-size:var(--docs-body-size, .8125rem);font-weight:600;color:var(--docs-text, var(--text-basic-color))}.docs-empty p{margin:0;max-width:26rem;font-size:var(--docs-meta-size, .75rem)}.docs-empty-icon{font-size:2rem;color:var(--docs-text-muted, var(--text-hint-color));opacity:.75}.docs-empty-icon.success{color:var(--color-success-default);opacity:1}.docs-empty-icon.danger{color:var(--color-danger-default);opacity:1}.docs-empty-actions{display:flex;flex-wrap:wrap;justify-content:center;gap:.375rem;margin-top:.25rem}.docs-empty button[nbButton]{display:inline-flex;align-items:center;gap:.375rem;height:var(--docs-control-height, 2rem);min-height:var(--docs-control-height, 2rem);padding-inline:.75rem;border-radius:var(--docs-radius, .375rem);font-size:var(--docs-body-size, .8125rem);font-weight:500}\n"], dependencies: [{ kind: "directive", type: i1.NgSwitch, selector: "[ngSwitch]", inputs: ["ngSwitch"] }, { kind: "directive", type: i1.NgSwitchCase, selector: "[ngSwitchCase]", inputs: ["ngSwitchCase"] }, { kind: "directive", type: i2.NgxPermissionsDirective, selector: "[ngxPermissionsOnly],[ngxPermissionsExcept]", inputs: ["ngxPermissionsOnly", "ngxPermissionsOnlyThen", "ngxPermissionsOnlyElse", "ngxPermissionsExcept", "ngxPermissionsExceptElse", "ngxPermissionsExceptThen", "ngxPermissionsThen", "ngxPermissionsElse", "ngxPermissionsOnlyAuthorisedStrategy", "ngxPermissionsOnlyUnauthorisedStrategy", "ngxPermissionsExceptUnauthorisedStrategy", "ngxPermissionsExceptAuthorisedStrategy", "ngxPermissionsUnauthorisedStrategy", "ngxPermissionsAuthorisedStrategy"], outputs: ["permissionsAuthorized", "permissionsUnauthorized"] }, { kind: "component", type: i3.NbButtonComponent, selector: "button[nbButton],a[nbButton],input[type=\"button\"][nbButton],input[type=\"submit\"][nbButton]", inputs: ["hero"] }, { kind: "component", type: i3.NbIconComponent, selector: "nb-icon", inputs: ["icon", "pack", "options", "status", "config"] }, { kind: "pipe", type: i4.TranslatePipe, name: "translate" }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: EmptyStateComponent, decorators: [{
            type: Component,
            args: [{ selector: 'gz-docs-empty-state', template: `
		<div class="docs-empty" [ngSwitch]="variant">
			<ng-container *ngSwitchCase="'first-run'">
				<nb-icon icon="file-add-outline" class="docs-empty-icon"></nb-icon>
				<h6>{{ 'DOCS.EMPTY.NO_DOCUMENTS' | translate }}</h6>
	...
	`, standalone: false, styles: [":host{display:block;width:100%}.docs-empty{display:flex;flex-direction:column;align-items:center;gap:.5rem;padding:2rem 1.25rem;text-align:center;color:var(--docs-text-muted, var(--text-hint-color))}.docs-empty h6{margin:0;font-size:var(--docs-body-size, .8125rem);font-weight:600;color:var(--docs-text, var(--text-basic-color))}.docs-empty p{margin:0;max-width:26rem;font-size:var(--docs-meta-size, .75rem)}.docs-empty-icon{font-size:2rem;color:var(--docs-text-muted, var(--text-hint-color));opacity:.75}.docs-empty-icon.success{color:var(--color-success-default);opacity:1}.docs-empty-icon.danger{color:var(--color-danger-default);opacity:1}.docs-empty-actions{display:flex;flex-wrap:wrap;justify-content:center;gap:.375rem;margin-top:.25rem}.docs-empty button[nbButton]{display:inline-flex;align-items:center;gap:.375rem;height:var(--docs-control-height, 2rem);min-height:var(--docs-control-height, 2rem);padding-inline:.75rem;border-radius:var(--docs-radius, .375rem);font-size:var(--docs-body-size, .8125rem);font-weight:500}\n"] }]
