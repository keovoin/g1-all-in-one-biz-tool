...
export const DOCS_PERMISSIONS = Object.freeze({
    read: Object.freeze([PermissionsEnum.DOCS_READ]),
    create: Object.freeze([PermissionsEnum.DOCS_CREATE]),
    update: Object.freeze([PermissionsEnum.DOCS_UPDATE]),
    delete: Object.freeze([PermissionsEnum.DOCS_DELETE]),
    manage: Object.freeze([PermissionsEnum.DOCS_MANAGE]),
    review: Object.freeze([PermissionsEnum.DOCS_REVIEW]),
    aiImport: Object.freeze([PermissionsEnum.DOCS_AI_IMPORT])
});
//# sourceMappingURL=docs-permission-groups.js.map