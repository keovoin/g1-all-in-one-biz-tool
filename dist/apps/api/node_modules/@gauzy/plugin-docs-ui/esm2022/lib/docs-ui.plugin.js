 ...
 * browse chunk.
 */
export const DOCS_SETTINGS_ROUTE = {
    location: 'settings-sections',
    path: DOCS_SETTINGS_PATH,
    loadComponent: () => import('./pages/settings/docs-settings-page.component').then((m) => m.DocsSettingsPageComponent),
 ...
 */
export const DOCS_INBOUND_SETTINGS_ROUTE = {
    location: 'settings-sections',
    path: DOCS_INBOUND_SETTINGS_PATH,
    loadComponent: () => import('./pages/settings/docs-inbound-settings-page.component').then((m) => m.DocsInboundSettingsPageComponent),
    canActivate: [PermissionsGuard],
    data: {
        permissions: {
            only: [PermissionsEnum.DOCS_MANAGE],
...
//# sourceMappingURL=docs-ui.plugin.js.map