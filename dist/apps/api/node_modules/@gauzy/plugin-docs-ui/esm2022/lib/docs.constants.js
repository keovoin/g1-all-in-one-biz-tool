...
export const DOCS_SECTIONS_LOCATION = 'documents-sections';
...
export const DOCS_UPLOAD_ACCEPT = '.pdf,.docx,.xlsx,.pptx,.odt,.ods,.csv,.txt,.md,.html,.png,.jpg,.jpeg,.webp,.gif';
 ...
 */
export const DOCS_PREVIEW_DIALOG_CONFIG = {
    closeOnEsc: true,
