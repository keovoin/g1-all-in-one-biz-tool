...
import { IComment, ICommentCreateInput, ICommentUpdateInput, ID, IPagination } from '@gauzy/contracts';
import { Store } from '@gauzy/ui-core/core';
import * as i0 from "@angular/core";
/** `PaginationQueryDTO.take` is `@Max(100)`; asking for more is a 400, not a bigger page. */
export declare const COMMENTS_PAGE_SIZE = 100;
/**
 ...
 */
export declare class DocumentCommentsService {
    ...
    private orgContext;
    static ɵfac: i0.ɵɵFactoryDeclaration<DocumentCommentsService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<DocumentCommentsService>;
}
