 ...
 */
export declare function renderMarkdownToSanitizedHtml(markdown: string | null | undefined, sanitizer: DomSanitizer): string | null;
/**
 ...
 */
export declare function sanitizeHtml(html: string | null | undefined, sanitizer: DomSanitizer): string | null;
