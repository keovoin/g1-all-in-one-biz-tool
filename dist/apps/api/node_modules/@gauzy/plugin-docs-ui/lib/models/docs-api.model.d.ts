import { DocumentKindEnum, DocumentKnowledgeStatusEnum, DocumentReviewStatusEnum, DocumentSourceEnum, DocumentStatusEnum, DocumentVisibilityEnum, ID, IDocument } from '@gauzy/contracts';
/**
 ...
 */
export declare const DOCUMENT_SORT_FIELDS: readonly ["name", "updatedAt", "createdAt", "size", "kind"];
 ...
 */
export declare const DOCUMENT_CONTENT_SEARCH_MIN_CHARS = 3;
/** `PaginationQueryDTO.take` is `@Max(100)` — a larger window is a 400, not a bigger page. */
export declare const DOCUMENT_MAX_TAKE = 100;
/**
 ...
 * one is an empty hub.
 */
export declare function toDocumentsQueryParams(input?: IDocumentFindInput): IDocumentsQueryParams;
 ...
 */
export declare function normalizeDocumentFacets(raw: IDocumentFacetsWire | null | undefined): IDocumentFacets;
/**
 ...
 * work happens.
 */
export type DocumentBulkAction = 'ARCHIVE' | 'UNARCHIVE' | 'DELETE' | 'MOVE' | 'SET_CATEGORIES' | 'ADD_TAGS' | 'REMOVE_TAGS' | 'KNOWLEDGE_IMPORT' | 'KNOWLEDGE_EXCLUDE' | 'REVIEW_APPROVE' | 'REVIEW_REJECT';
 ...
 */
export declare function normalizeDocumentStorage(settings: IDocumentSettings | null | undefined): IDocumentSettingsStorage | null;
