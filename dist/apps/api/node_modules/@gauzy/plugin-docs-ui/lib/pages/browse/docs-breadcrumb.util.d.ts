 ...
 */
export declare function toDocsBreadcrumb(segments: IDocumentPathSegment[] | null | undefined, folderId: ID, nameOf: (id: ID) => string | undefined): IDocsBreadcrumbSegment[] | null;
