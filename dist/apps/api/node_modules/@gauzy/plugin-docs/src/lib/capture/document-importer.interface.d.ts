...
export interface IDocumentImporter {
    ...
    mapToDocument(context: IDocumentImporterContext, ref: IExternalDocumentRef, payload: IDocumentImporterPayload): IMappedDocument | Promise<IMappedDocument>;
}
/**
 ...
 */
export declare class DocumentImporterRegistry {
    private static readonly logger;
    private static readonly importers;
    /**
