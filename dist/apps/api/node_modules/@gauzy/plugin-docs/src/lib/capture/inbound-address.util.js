...
exports.isSenderAllowedBy = exports.normalizeInboundLocalPart = exports.normalizeInboundDomain = exports.normalizeRecipientAddress = void 0;
 ...
 */
const normalizeRecipientAddress = (recipient) => {
...
exports.normalizeRecipientAddress = normalizeRecipientAddress;
/**
 ...
 */
const normalizeInboundDomain = (value) => {
...
exports.normalizeInboundDomain = normalizeInboundDomain;
/**
 * Validates and lower-cases a mailbox name.
 *
 * @returns the normalized local part, or `null` when invalid.
 */
const normalizeInboundLocalPart = (value) => {
    const localPart = String(value ?? '')
        .trim()
        .toLowerCase();
    return docs_constants_1.DOCS_INBOUND_LOCAL_PART_PATTERN.test(localPart) ? localPart : null;
};
exports.normalizeInboundLocalPart = normalizeInboundLocalPart;
/**
 ...
 */
const isSenderAllowedBy = (allowlist, sender) => {
...
exports.isSenderAllowedBy = isSenderAllowedBy;
/**
 ...
 */
const normalizeRecipientAddressForSender = (sender) => {
    if (!sender.includes('@')) {
        return null;
    }
...
//# sourceMappingURL=inbound-address.util.js.map