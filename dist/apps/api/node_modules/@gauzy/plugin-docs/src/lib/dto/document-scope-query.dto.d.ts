...
declare const DocumentScopeQueryDTO_base: import("@nestjs/common").Type<Partial<TenantOrganizationBaseDTO>>;
/**
 ...
 */
export declare class DocumentScopeQueryDTO extends DocumentScopeQueryDTO_base {
}
export {};
