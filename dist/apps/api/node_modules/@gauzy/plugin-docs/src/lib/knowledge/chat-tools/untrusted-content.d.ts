 ...
 */
export declare function stripPromptControlMarkers(text: string): string;
/**
 ...
 */
export declare function fenceUntrustedContent(id: string, content: string): string;
/**
 ...
 */
export declare function hardenUntrustedContent(id: string, content: string): string;
