 ...
 */
let PdfRasterizerService = PdfRasterizerService_1 = class PdfRasterizerService {
    constructor() {
        this.logger = new common_1.Logger(PdfRasterizerService_1.name);
    }
    /**
     ...
     */
    async renderPages(buffer, maxPages) {
        ...
        try {
            ...
            this.logger.debug(`PDF rasterization could not open the document: ${error.message}`);
            return null;
        }
        ...
        try {
            ...
            throw new errors_1.DocsTransientError('The PDF pages could not be rendered for transcription.', error);
        }
        finally {
     ...
     */
    async renderPage(renderer, document, pageNumber) {
        ...
        try {
            ...
            const nominalScale = exports.PDF_RASTER_DPI / 72;
            const base = page.getViewport({ scale: nominalScale });
            const longest = Math.max(base.width, base.height);
            const scale = longest > exports.PDF_RASTER_MAX_PX ? nominalScale * (exports.PDF_RASTER_MAX_PX / longest) : nominalScale;
    ...
    async loadRenderer() {
        ...
        try {
            ...
            const canvas = await importOptional('@napi-rs/canvas');
            ...
            this.logger.log(`PDF rasterizer unavailable (${error.message}) — PDF thumbnails are skipped and ` +
...
exports.PdfRasterizerService = PdfRasterizerService;
exports.PdfRasterizerService = PdfRasterizerService = PdfRasterizerService_1 = tslib_1.__decorate([
 ...
 */
function resolvePdfjsAssetOptions() {
    try {
...
//# sourceMappingURL=pdf-rasterizer.service.js.map