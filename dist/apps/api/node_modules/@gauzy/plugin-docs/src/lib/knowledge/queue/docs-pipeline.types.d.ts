 ...
 */
export declare const DOCS_PIPELINE_RUNNER = "DOCS_PIPELINE_RUNNER";
/**
 ...
 */
export declare const DOCS_INLINE_JOB_ATTEMPTS = 1;
/**
 ...
 */
export declare function fromBullJob<T>(job: Job<T>): IDocsStageJob<T>;
/**
 ...
 */
export declare function inlineStageJob<T>(jobId: string, data: T): IDocsStageJob<T>;
