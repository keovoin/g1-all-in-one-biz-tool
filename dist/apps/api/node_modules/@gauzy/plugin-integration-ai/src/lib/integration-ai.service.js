...
let IntegrationAIService = class IntegrationAIService {
    ...
    async create(input) {
        try {
            ...
            throw new common_1.HttpException(`Error while creating Sastra AI integration: ${error.message}`, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    /**
    ...
    async update(integrationId, input) {
        try {
            ...
            throw new common_1.HttpException(`Error while updating Sastra AI integration: ${error.message}`, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    /**
