"use strict";
var ZapierWebhookService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ZapierWebhookService = void 0;
...
let ZapierWebhookService = ZapierWebhookService_1 = class ZapierWebhookService {
    constructor(zapierWebhookSubscriptionRepository, _httpService) {
        this.zapierWebhookSubscriptionRepository = zapierWebhookSubscriptionRepository;
         ...
         */
        this.recentlyDelivered = new Map();
        /**
    ...
    async createSubscription(input) {
        try {
            ...
            (0, webhook_url_validator_1.assertSafeZapierWebhookUrl)(targetUrl);
    ...
    async deleteSubscription(id, tenantId) {
        try {
            ...
            if (!subscription) {
                ...
                throw new common_1.NotFoundException(`No webhook subscription found with id ${id}`);
            }
            if (subscription.tenantId !== tenantId) {
                this.logger.warn(`Unauthorized deletion attempt: Subscription ID ${id} does not belong to tenant ${tenantId}`);
                throw new common_1.ForbiddenException('You do not have permission to delete this webhook subscription.');
            }
     ...
     */
    async notifyTimerStatusChanged(timerData) {
        ...
        await Promise.all(subscriptions.map(async (sub) => {
            ...
            try {
                (0, webhook_url_validator_1.assertSafeZapierWebhookUrl)(sub.targetUrl);
            }
            catch (error) {
                this.logger.warn(`Skipping Zapier webhook ${sub.id} — unsafe target URL: ${error instanceof Error ? error.message : error}`);
                return null;
            }
            ...
            if (deliveryKey !== null) {
                ...
                this.inFlight.set(deliveryKey, new Promise((resolve) => (releaseReservation = resolve)));
            }
            try {
                const result = await (0, rxjs_1.firstValueFrom)(this._httpService
                    .post(sub.targetUrl, {
                    event: 'timer.status.changed',
                    data: timerData
                }, {
                    ...
                    return (0, rxjs_1.of)(null); // swallow error so other calls continue
                })));
...
exports.ZapierWebhookService = ZapierWebhookService = ZapierWebhookService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [type_orm_zapier_webhook_subscription_repository_1.TypeOrmZapierWebhookSubscriptionRepository,
        axios_1.HttpService])
], ZapierWebhookService);
//# sourceMappingURL=zapier-webhook.service.js.map