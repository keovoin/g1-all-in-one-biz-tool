...
exports.ZAPIER_REDIRECT_URI = exports.ZAPIER_TOKEN_URL = exports.ZAPIER_CALLBACK_URL = exports.ZAPIER_AUTHORIZATION_URL = exports.ZAPIER_TOKEN_EXPIRATION_TIME = exports.ZAPIER_OAUTH_SCOPES = exports.ZAPIER_API_URL = exports.ZAPIER_BASE_URL = void 0;
/**
 * Zapier base API URL
 */
exports.ZAPIER_BASE_URL = 'https://zapier.com';
/**
 * Zapier API URL
 */
exports.ZAPIER_API_URL = 'https://api.zapier.com';
/**
 ...
 */
exports.ZAPIER_OAUTH_SCOPES = 'zap zap:all zap:account:all zap:write authentication';
/**
 * Zapier token expiration time (in seconds)
 * 10 hours = 36000 seconds
 * Default to shorter expiration in production for security
 */
exports.ZAPIER_TOKEN_EXPIRATION_TIME = process.env['NODE_ENV'] === 'production' ? 7200 : 36000;
/** URL for initiating OAuth authorization flow with Gauzy */
exports.ZAPIER_AUTHORIZATION_URL = `${process.env['API_BASE_URL']}/api/integration/zapier/oauth/authorize`;
/** URL for OAuth callback after user authorization */
exports.ZAPIER_CALLBACK_URL = `${process.env['API_BASE_URL']}/api/integration/zapier/oauth/callback`;
/** URL for obtaining OAuth access tokens from Gauzy */
exports.ZAPIER_TOKEN_URL = `${process.env['API_BASE_URL']}/api/integration/zapier/oauth/token`;
/** URL for redirecting users after OAuth authorization */
exports.ZAPIER_REDIRECT_URI = 'https://zapier.com/dashboard/auth/oauth/return/App221848CLIAPI/';
//# sourceMappingURL=zapier.config.js.map