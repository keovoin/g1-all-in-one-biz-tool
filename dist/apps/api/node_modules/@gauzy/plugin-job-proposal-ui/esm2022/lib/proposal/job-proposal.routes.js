...
import { ProposalComponent, ProposalDetailsComponent, ProposalEditComponent, ProposalRegisterComponent } from './components';
...
const PROPOSAL_LIST_SELECTORS = { project: false, team: false };
/** Selectors for proposal register. */
const PROPOSAL_REGISTER_SELECTORS = { employee: false, project: false, team: false };
/**
 ...
 */
export const JOB_PROPOSAL_SALES_ROUTE = {
 ...
 */
export function getProposalsRoutes(pageRouteRegistryService) {
    return [
        {
            path: '',
...
//# sourceMappingURL=job-proposal.routes.js.map