 ...
 */
export const ProposalDetailsResolver = (route) => {
    ...
    return _proposalsService.getById(proposalId, ['employee', 'employee.user', 'tags', 'organizationContact']).pipe(catchError(() => {
        _router.navigate(['/pages/employees']);
        return of(null);
    }));
};
//# sourceMappingURL=proposal-details.resolver.js.map