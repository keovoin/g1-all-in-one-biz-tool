 ...
 */
export const PublicOrganizationResolver = (route) => {
    ...
    return _organizationsService.getByProfileLink(profileLink, organizationId, relations).pipe(catchError((error) => {
        // Log the error
...
//# sourceMappingURL=public-organization.resolver.js.map