...
import { PluginRecommendationsController, PluginTagsController, TagPluginsController } from './plugin-tag-management.controller';
import { PluginTagController } from './plugin-tag.controller';
import { PluginTenantController } from './plugin-tenant.controller';
import { PluginUserAssignmentController, PluginUserAssignmentManagementController, UserPluginAssignmentController } from './plugin-user-assignment.controller';
...
export declare const controllers: (typeof PluginActivationController | typeof PluginAnalyticsController | typeof PluginBillingController | typeof PluginCategoryController | typeof PluginInstallationController | typeof PluginManagementController | typeof PluginSecurityController | typeof PluginSettingController | typeof PluginSourceController | typeof PluginSubscriptionAccessController | typeof PluginSubscriptionAnalyticsController | typeof PluginSubscriptionPlanController | typeof PluginSubscriptionController | typeof PluginTagsController | typeof PluginRecommendationsController | typeof TagPluginsController | typeof PluginTagController | typeof PluginTenantController | typeof PluginUserAssignmentController | typeof UserPluginAssignmentController | typeof PluginUserAssignmentManagementController | typeof PluginVersionController | typeof PluginController | typeof UserSubscribedPluginsController)[];
