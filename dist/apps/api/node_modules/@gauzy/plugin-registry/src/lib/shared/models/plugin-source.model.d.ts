import type { FileStorageProviderEnum, ID, PluginOSArch, PluginOSType, IPluginSource as PluginSourceModel, PluginSourceType } from '@gauzy/contracts';
...
export interface IPluginSourceStatic {
    ...
    createCdnSource(url: string, operatingSystem?: PluginOSType, architecture?: PluginOSArch, options?: {
        integrity?: string;
        crossOrigin?: string;
    }): IPluginSource;
    createNpmSource(name: string, operatingSystem?: PluginOSType, architecture?: PluginOSArch, options?: {
        registry?: string;
        scope?: string;
        private?: boolean;
    }): IPluginSource;
    createFileSource(fileName: string, filePath: string, fileSize: number, operatingSystem?: PluginOSType, architecture?: PluginOSArch, options?: {
        mimeType?: string;
        fileKey?: string;
    }): IPluginSource;
