import { collectPluginIds, flattenPlugins } from './plugin-ui.types';
 ...
 * ```
 */
export async function loadPluginUiConfig(configuration) {
    ...
    if (!uiPluginConfig.availableLanguages.includes(uiPluginConfig.defaultLanguage)) {
        throw new Error(`[PluginUiConfig] "defaultLanguage" (${uiPluginConfig.defaultLanguage}) must be listed in "availableLanguages".`);
    }
    ...
    console.log(`[PluginUiConfig] Loaded — ` +
...
//# sourceMappingURL=plugin-ui-config-loader.js.map