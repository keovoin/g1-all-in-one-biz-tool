 ...
 */
export declare const PAGE_EXTENSION_SLOTS: {
    ...
    readonly DASHBOARD_WINDOWS: "dashboard-windows";
    /** Settings page tabs (use with PageTabRegistryService tabsetIds). */
    readonly SETTINGS_TABS: "settings-tabs";
    /** Integrations list items (e.g. integration tiles). */
    readonly INTEGRATIONS_LIST: "integrations-list";
    /** Top-level page sections (alternative to page-sections routes). */
    readonly PAGE_SECTIONS: "page-sections";
    /** User menu dropdown items. */
    readonly USER_MENU_ITEMS: "user-menu-items";
    /** Header toolbar actions. */
    readonly HEADER_TOOLBAR: "header-toolbar";
    /** Sidebar footer. */
    readonly SIDEBAR_FOOTER: "sidebar-footer";
    /** Dashboard tabs (tabset: dashboard-page). */
    readonly DASHBOARD_TABS: "dashboard-page";
    /** Timesheet tabs (tabset: timesheet-page). */
    readonly TIMESHEET_TABS: "timesheet-page";
    /** Time & activity tabs (tabset: time-activity-page). */
    readonly TIME_ACTIVITY_TABS: "time-activity-page";
    /** Employee edit tabs (tabset: employee-edit-page). */
    readonly EMPLOYEE_EDIT_TABS: "employee-edit-page";
};
/** Tab slot ids that map to PageTabRegistryService tabsetIds. */
export declare const TAB_EXTENSION_SLOTS: readonly ["dashboard-page", "timesheet-page", "time-activity-page", "employee-edit-page"];
 ...
 */
export interface PageExtensionDefinition<T = unknown> extends ExtensionLifecycleHooks, ExtensionVisibilityConfig {
