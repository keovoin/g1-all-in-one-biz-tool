 ...
 * ```
 */
export declare function defineFrameworkExtension<TProps = unknown, TContext = unknown>(config: FrameworkExtensionConfig<TProps, TContext>): FrameworkExtensionDefinition<TProps, TContext>;
/**
 ...
 */
export declare function isFrameworkExtension(ext: PageExtensionDefinition): ext is FrameworkExtensionDefinition;
/**
 * Get the framework ID from an extension if it's a framework extension.
 */
export declare function getExtensionFrameworkId(ext: PageExtensionDefinition): UiBridgeFramework | undefined;
