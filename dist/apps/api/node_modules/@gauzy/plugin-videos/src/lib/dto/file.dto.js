...
tslib_1.__decorate([
    ...
    (0, class_validator_1.Matches)(/\.(mp4)$/, {
        message: 'File must be a valid video format mp4 and contain only letters, numbers, spaces, hyphens, or underscores'
    }),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    ...
    (0, class_validator_1.Matches)(/^video\/(mp4)$/, {
