...
exports.ENV_WORKER_QUEUE_ENABLED = exports.ENV_SCHEDULER_QUEUE_ENABLED = void 0;
exports.isSchedulerQueueRootEnabled = isSchedulerQueueRootEnabled;
/**
 ...
 */
exports.ENV_SCHEDULER_QUEUE_ENABLED = 'SCHEDULER_QUEUE_ENABLED';
/**
 ...
 */
exports.ENV_WORKER_QUEUE_ENABLED = 'WORKER_QUEUE_ENABLED';
/**
 ...
 */
function isSchedulerQueueRootEnabled() {
    // An explicit opt-out always wins, so an operator can disable queueing without touching Redis.
    if (process.env[exports.ENV_SCHEDULER_QUEUE_ENABLED] === 'false') {
        return false;
    }
    ...
    // never to a crash.
    if (process.env[exports.ENV_WORKER_QUEUE_ENABLED] === 'false') {
        return false;
    }
...
//# sourceMappingURL=is-queue-root-enabled.js.map