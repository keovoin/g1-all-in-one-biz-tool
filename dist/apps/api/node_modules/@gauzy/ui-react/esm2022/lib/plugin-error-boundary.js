    ...
    render() {
        ...
        if (fallback !== undefined) {
            if (typeof fallback === 'function') {
                return fallback(errorInfo, this._handleRetry);
            }
            return fallback;
        }
        // Default fallback
...
function DefaultErrorFallback({ error, pluginId, onRetry }) {
    const label = pluginId ? `Plugin "${pluginId}" encountered an error` : 'A component encountered an error';
    return React.createElement('div', { style: fallbackStyles['container'] }, React.createElement('div', { style: fallbackStyles['header'] }, React.createElement('span', { style: fallbackStyles['title'] }, label), React.createElement('button', {
        style: fallbackStyles['button'],
        onClick: onRetry,
        type: 'button'
    }, 'Retry')), React.createElement('div', { style: fallbackStyles['message'] }, error.message));
}
//# sourceMappingURL=plugin-error-boundary.js.map