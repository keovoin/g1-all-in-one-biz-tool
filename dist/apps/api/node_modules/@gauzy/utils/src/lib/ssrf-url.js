...
exports.getUnsafeOutboundUrlReason = getUnsafeOutboundUrlReason;
 ...
 */
function getUnsafeOutboundUrlReason(url, options) {
 ...
 * @param options.allowHttp - Allow plain `http:` in addition to `https:` (default `false`).
 */
function isSafeOutboundUrl(url, options) {
    return getUnsafeOutboundUrlReason(url, options) === null;
}
//# sourceMappingURL=ssrf-url.js.map