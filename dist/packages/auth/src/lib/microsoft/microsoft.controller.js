...
let MicrosoftController = class MicrosoftController {
    constructor(service) {
     ...
     */
    async microsoftLoginCallback(context, res) {
        const { user } = context;
...
], MicrosoftController.prototype, "microsoftLogin", null);
tslib_1.__decorate([
...
], MicrosoftController.prototype, "microsoftLoginCallback", null);
exports.MicrosoftController = MicrosoftController = tslib_1.__decorate([
    (0, common_1.UseGuards)(common_2.FeatureFlagEnabledGuard, (0, passport_1.AuthGuard)('microsoft')),
    (0, common_2.FeatureFlag)(contracts_1.FeatureEnum.FEATURE_MICROSOFT_LOGIN),
    (0, common_2.Public)(),
