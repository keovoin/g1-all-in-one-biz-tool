import { IActivepiecesConfig, IAppIntegrationConfig, IAuth0Config, IAwsConfig, ICloudinaryConfig, IFiverrConfig, IGithubIntegrationConfig, IHubstaffConfig, IJitsuConfig, ISMTPConfig, ISimConfig, IUnleashConfig, IUpworkConfig, IWasabiConfig, IJiraIntegrationConfig, IDigitalOceanConfig, IMakeComConfig, IPosthogConfig, IZapierConfig } from '@gauzy/common';
