...
exports.DEFAULT_SCREENSHOT_FREQUENCY_OPTIONS = exports.DEFAULT_ACTIVITY_PROOF_DURATIONS = exports.DEFAULT_INACTIVITY_TIME_LIMITS = exports.DEFAULT_DATE_FORMATS = exports.DEFAULT_INVITE_EXPIRY_PERIOD = exports.DEFAULT_REVENUE_BASED_BONUS = exports.DEFAULT_PROFIT_BASED_BONUS = exports.DEFAULT_STANDARD_WORK_HOURS_PER_DAY = exports.DEFAULT_TIME_FORMATS = void 0;
/**
 * Array containing the default time formats.
 */
exports.DEFAULT_TIME_FORMATS = [12, 24];
/**
 * Default standard work hours per day.
 * - Typically set to 8 hours, aligning with standard full-time work schedules.
 */
exports.DEFAULT_STANDARD_WORK_HOURS_PER_DAY = 8;
/**
 ...
 */
exports.DEFAULT_INVITE_EXPIRY_PERIOD = 7;
/**
 ...
 */
exports.DEFAULT_DATE_FORMATS = ['L', 'LL', 'dddd, LL'];
/**
 ...
 */
exports.DEFAULT_INACTIVITY_TIME_LIMITS = [1, 5, 10, 20, 30];
/**
 ...
 */
exports.DEFAULT_ACTIVITY_PROOF_DURATIONS = [1, 3, 5, 10];
/**
 ...
 * - Common values: 1, 3, 5, 10 minutes.
 */
exports.DEFAULT_SCREENSHOT_FREQUENCY_OPTIONS = [1, 3, 5, 10];
