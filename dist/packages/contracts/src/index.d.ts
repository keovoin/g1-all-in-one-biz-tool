...
export { ActorTypeEnum, BaseEntityEnum, IBaseEntityModel as BaseEntityModel, IBasePerEntityType, IBasePerTenantAndOrganizationEntityModel, IBasePerTenantEntityModel, IBaseRelationsEntityModel, IBaseSoftDeleteEntityModel, ID, JsonData } from './lib/base-entity.model';
