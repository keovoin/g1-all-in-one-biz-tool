 ...
 */
export declare enum EmployeeNotificationTypeEnum {
 ...
 */
export interface IEmployeeNotificationUpdateInput extends OmitFields<IEmployeeNotification, 'receiverEmployee' | 'receiverEmployeeId' | 'sentByEmployee' | 'sentByEmployeeId'> {
}
/**
