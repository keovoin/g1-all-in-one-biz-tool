...
export declare enum DiscountTaxTypeEnum {
    PERCENT = "PERCENT",
    FLAT_VALUE = "FLAT"
}
export declare enum InvoiceStatusTypesEnum {
    DRAFT = "DRAFT",
    SENT = "SENT",
    VIEWED = "VIEWED",
...
export declare enum EstimateStatusTypesEnum {
    DRAFT = "DRAFT",
    SENT = "SENT",
    VIEWED = "VIEWED",
    ACCEPTED = "ACCEPTED",
...
export declare enum InvoiceColumnsEnum {
...
export declare enum EstimateColumnsEnum {
...
export declare enum InvoiceTabsEnum {
    ACTIONS = "ACTIONS",
    SEARCH = "SEARCH",
    HISTORY = "HISTORY"
}
export declare enum TaxCalculationTypeEnum {
    SIMPLE = "SIMPLE",
    COMPOSED = "COMPOSED"
}
