...
export declare enum OrganizationContactBudgetTypeEnum {
    HOURS = "hours",
    COST = "cost"
}
...
export interface IOrganizationContact extends IBaseEntityWithMembers, IRelationalImageAsset, IOrganizationContactAssociations {
    name: string;
...
export interface IOrganizationContactCreateInput extends IContactCreateInput, IBasePerTenantAndOrganizationEntityMutationInput, IRelationalImageAsset, IOrganizationContactAssociations {
    name: string;
    primaryEmail?: string;
    primaryPhone?: string;
    phones?: string[];
...
export declare enum ContactOrganizationInviteStatus {
