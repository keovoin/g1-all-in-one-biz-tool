...
export interface IOrganizationRecurringExpenseFindInput extends IBasePerTenantAndOrganizationEntityModel {
    month?: number;
    year?: number;
    categoryName?: string;
    value?: number;
...
export interface IOrganizationRecurringExpenseByMonthFindInput extends IBasePerTenantAndOrganizationEntityModel {
    month?: number;
    year?: number;
}
