...
export declare enum SprintStartDayEnum {
    SUNDAY = 1,
    MONDAY = 2,
    TUESDAY = 3,
    WEDNESDAY = 4,
...
export declare enum OrganizationSprintStatusEnum {
    ACTIVE = "active",
    COMPLETED = "completed",
    DRAFT = "draft",
    UPCOMING = "upcoming"
...
export interface IOrganizationSprintEmployee extends IBasePerTenantAndOrganizationEntityModel, IEmployeeEntityInput, IRelationalRole, IManagerAssignable {
    organizationSprint: IOrganizationSprint;
    organizationSprintId: ID;
}
