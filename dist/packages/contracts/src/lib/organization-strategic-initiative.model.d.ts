 ...
 */
export declare enum OrganizationStrategicStateEnum {
    DRAFT = "draft",
    ACTIVE = "active",
    RESOLVED = "resolved",
    RETIRED = "retired"
 ...
 */
export declare enum OrganizationStrategicVisibilityScopeEnum {
 ...
 */
export declare enum OrganizationStrategicConfidenceLevelEnum {
    LOW = "low",
    MEDIUM = "medium",
    HIGH = "high"
}
 ...
 */
export declare enum OrganizationStrategicPerceivedMomentumEnum {
    STALLED = "stalled",
 ...
 */
export interface IOrganizationStrategicInitiative extends IBasePerTenantAndOrganizationEntityModel {
 ...
 */
export interface IOrganizationStrategicInitiativeCreateInput extends OmitFields<IOrganizationStrategicInitiative, 'projects' | 'goals' | 'steward'> {
    stewardId?: ID;
}
/**
 * Update input for organization strategic initiative
 */
export interface IOrganizationStrategicInitiativeUpdateInput extends Partial<OmitFields<IOrganizationStrategicInitiative, 'projects' | 'goals' | 'steward'>> {
    stewardId?: ID;
}
/**
 ...
 */
export interface IOrganizationStrategicInitiativeFindInput extends Partial<Pick<IOrganizationStrategicInitiative, 'state' | 'visibilityScope' | 'stewardId' | 'isActive' | 'isArchived'>> {
