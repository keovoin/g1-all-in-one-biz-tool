...
export interface IOrganizationTeamJoinRequestFindInput extends IBasePerTenantAndOrganizationEntityModel, Pick<IOrganizationTeamJoinRequest, 'organizationTeamId' | 'status'> {
}
export declare enum OrganizationTeamJoinRequestStatusEnum {
    REQUESTED = "REQUESTED",
    ACCEPTED = "ACCEPTED",
    REJECTED = "REJECTED"
}
