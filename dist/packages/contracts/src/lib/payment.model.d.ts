...
export interface IPaymentUpdateInput extends Pick<IPayment, 'amount' | 'note' | 'currency' | 'paymentDate'>, IBasePerTenantAndOrganizationEntityModel {
}
export interface IPaymentFindInput extends Pick<IPayment, 'invoiceId' | 'projectId'>, IBasePerTenantAndOrganizationEntityModel {
}
