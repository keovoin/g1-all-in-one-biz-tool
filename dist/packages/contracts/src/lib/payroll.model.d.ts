 ...
 */
export declare enum PayrollRunStatusEnum {
    DRAFT = "DRAFT",
 ...
 */
export declare enum PayrollFrequencyEnum {
    WEEKLY = "WEEKLY",
    BI_WEEKLY = "BI_WEEKLY",
 ...
 */
export declare enum PayrollItemTypeEnum {
 ...
 */
export declare enum PayrollItemCategoryEnum {
    EARNING = "EARNING",
    DEDUCTION = "DEDUCTION"
}
/**
