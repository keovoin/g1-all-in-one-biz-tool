 ...
 * Proposal Find Input
 */
export interface IProposalFindInput extends Omit<IProposalBase, 'jobPostLink' | 'jobPostContent' | 'proposalContent' | 'jobPostUrl'> {
}
/**
 * Proposal View Model
 */
export interface IProposalViewModel extends IRelationalOrganizationContact, IEmployeeEntityInput, Partial<IProposalBase> {
    valueDate?: Date;
    jobPostLink?: string;
    author?: IEmployee;
}
