 ...
 */
export interface ITagFindInput extends IBasePerTenantAndOrganizationEntityModel, Partial<Pick<ITag, 'name' | 'color' | 'textColor' | 'description' | 'isSystem' | 'tagTypeId' | 'organizationTeamId'>> {
}
/**
