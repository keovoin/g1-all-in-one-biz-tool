...
import { FileStorageProviderEnum, ICloudinaryFileStorageProviderConfig, IS3FileStorageProviderConfig, IWasabiFileStorageProviderConfig } from './file-provider';
 ...
 */
export declare enum PreferredUiEnum {
...
export declare const PREFERRED_UI_SETTING_KEY = "preferredUi";
