 ...
 */
export declare function globalAccountingTemplateWhere({ languageCode, templateType }: IAccountingTemplateLookup): FindOptionsWhere<IAccountingTemplate>;
/**
 ...
 */
export declare function globalAccountingTemplateMikroWhere({ languageCode, templateType }: IAccountingTemplateLookup): MikroFilterQuery<IAccountingTemplate>;
/**
 ...
 */
export declare function tenantAccountingTemplateWhere({ languageCode, templateType, tenantId, organizationId }: IAccountingTemplateScope): FindOptionsWhere<IAccountingTemplate>;
