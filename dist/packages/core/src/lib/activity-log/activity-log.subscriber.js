...
exports.ActivityLogSubscriber = void 0;
const tslib_1 = require("tslib");
const typeorm_1 = require("typeorm");
const config_1 = require("@gauzy/config");
const base_entity_event_subscriber_1 = require("../core/entities/subscribers/base-entity-event.subscriber");
const activity_log_entity_1 = require("./activity-log.entity");
let ActivityLogSubscriber = class ActivityLogSubscriber extends base_entity_event_subscriber_1.BaseEntityEventSubscriber {
    /**
     * Indicates that this subscriber only listen to ActivityLog events.
     */
    listenTo() {
        return activity_log_entity_1.ActivityLog;
    }
    /**
     ...
     */
    deserializeFields(entity, fields) {
        fields.forEach((field) => {
...
exports.ActivityLogSubscriber = ActivityLogSubscriber;
exports.ActivityLogSubscriber = ActivityLogSubscriber = tslib_1.__decorate([
    (0, typeorm_1.EventSubscriber)()
], ActivityLogSubscriber);
//# sourceMappingURL=activity-log.subscriber.js.map