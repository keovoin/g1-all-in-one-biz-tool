...
export declare class ApiCallLogSubscriber extends BaseEntityEventSubscriber<ApiCallLog> {
    private readonly logger;
    /**
     * Indicates that this subscriber only listen to ApiCallLog events.
     */
    listenTo(): typeof ApiCallLog;
    /**
     ...
     */
    beforeEntityCreate(entity: ApiCallLog): Promise<void>;
    /**
     ...
     */
    afterEntityLoad(entity: ApiCallLog, em?: MultiOrmEntityManager): Promise<void>;
}
