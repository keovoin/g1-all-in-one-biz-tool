...
exports.CreateTaskVersionTable1687974863736 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateTaskVersionTable1687974863736 {
    constructor() {
        this.name = 'CreateTaskVersionTable1687974863736';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "task_version" ADD CONSTRAINT "FK_379c8bd0ce203341148c1f99ee7" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_version" ADD CONSTRAINT "FK_9c845f353378371ee3aa60f6865" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "task_version" ADD CONSTRAINT "FK_91988120385964f213aec8aa84c" FOREIGN KEY ("projectId") REFERENCES "organization_project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_version" ADD CONSTRAINT "FK_959e77718a2e76ee56498c1106a" FOREIGN KEY ("organizationTeamId") REFERENCES "organization_team"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
...
exports.CreateTaskVersionTable1687974863736 = CreateTaskVersionTable1687974863736;
//# sourceMappingURL=1687974863736-CreateTaskVersionTable.js.map