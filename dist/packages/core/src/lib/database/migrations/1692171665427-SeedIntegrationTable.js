...
exports.SeedIntegrationTable1692171665427 = void 0;
...
class SeedIntegrationTable1692171665427 {
    constructor() {
        this.name = 'SeedIntegrationTable1692171665427';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteUpsertIntegrationsAndIntegrationTypes(queryRunner) {
        for await (const { name, imgSrc, isComingSoon, order, integrationTypesMap } of default_integration_1.DEFAULT_AI_INTEGRATIONS) {
            try {
...
exports.SeedIntegrationTable1692171665427 = SeedIntegrationTable1692171665427;
//# sourceMappingURL=1692171665427-SeedIntegrationTable.js.map