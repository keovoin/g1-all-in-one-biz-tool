...
exports.AlterTableTask1695570009125 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterTableTask1695570009125 {
    constructor() {
        this.name = 'AlterTableTask1695570009125';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_0cbe714983eb0aae5feeee8212b" FOREIGN KEY ("taskStatusId") REFERENCES "task_status"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_2f4bdd2593fd6038aaa91fd1076" FOREIGN KEY ("taskSizeId") REFERENCES "task_size"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_b8616deefe44d0622233e73fbf9" FOREIGN KEY ("taskPriorityId") REFERENCES "task_priority"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_b8616deefe44d0622233e73fbf9"`);
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_2f4bdd2593fd6038aaa91fd1076"`);
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_0cbe714983eb0aae5feeee8212b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b8616deefe44d0622233e73fbf"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2f4bdd2593fd6038aaa91fd107"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0cbe714983eb0aae5feeee8212"`);
        await queryRunner.query(`ALTER TABLE "task" DROP COLUMN "taskPriorityId"`);
        await queryRunner.query(`ALTER TABLE "task" DROP COLUMN "taskSizeId"`);
        await queryRunner.query(`ALTER TABLE "task" DROP COLUMN "taskStatusId"`);
    }
    /**
...
exports.AlterTableTask1695570009125 = AlterTableTask1695570009125;
//# sourceMappingURL=1695570009125-AlterTableTask.js.map