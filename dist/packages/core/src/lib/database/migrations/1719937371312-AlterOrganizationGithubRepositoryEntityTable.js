...
exports.AlterOrganizationGithubRepositoryEntityTable1719937371312 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterOrganizationGithubRepositoryEntityTable1719937371312 {
    constructor() {
        this.name = 'AlterOrganizationGithubRepositoryEntityTable1719937371312';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_github_repository" ALTER COLUMN "repositoryId" SET NOT NULL`);
    ...
    async postgresDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_github_repository" ALTER COLUMN "repositoryId" TYPE integer`);
        await queryRunner.query(`ALTER TABLE "organization_github_repository" ALTER COLUMN "repositoryId" SET NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_ca0fa80f50baed7287a499dc2c" ON "organization_github_repository" ("repositoryId") `);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_organization_github_repository" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "repositoryId" integer NOT NULL, "name" varchar NOT NULL, "fullName" varchar NOT NULL, "owner" varchar NOT NULL, "integrationId" varchar, "issuesCount" integer, "hasSyncEnabled" boolean DEFAULT (1), "private" boolean DEFAULT (0), "status" varchar, "deletedAt" datetime, CONSTRAINT "FK_480158f21938444e4f62fb31857" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_69d75a47af6bfcda545a865691b" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_add7dbec156589dd0b27e2e0c49" FOREIGN KEY ("integrationId") REFERENCES "integration_tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_9e8a77c1d330554fab9230100a"`);
        await queryRunner.query(`DROP INDEX "IDX_add7dbec156589dd0b27e2e0c4"`);
        await queryRunner.query(`CREATE TABLE "temporary_organization_github_repository" ("id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "repositoryId" bigint NOT NULL, "name" varchar NOT NULL, "fullName" varchar NOT NULL, "owner" varchar NOT NULL, "integrationId" varchar, "issuesCount" integer, "hasSyncEnabled" boolean DEFAULT (1), "private" boolean DEFAULT (0), "status" varchar, "deletedAt" datetime, CONSTRAINT "FK_480158f21938444e4f62fb31857" FOREIGN KEY ("tenantId") REFERENCES "tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_69d75a47af6bfcda545a865691b" FOREIGN KEY ("organizationId") REFERENCES "organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_add7dbec156589dd0b27e2e0c49" FOREIGN KEY ("integrationId") REFERENCES "integration_tenant" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_organization_github_repository"("id", "createdAt", "updatedAt", "isActive", "isArchived", "tenantId", "organizationId", "repositoryId", "name", "fullName", "owner", "integrationId", "issuesCount", "hasSyncEnabled", "private", "status", "deletedAt") SELECT "id", "createdAt", "updatedAt", "isActive", "isArchived", "tenantId", "organizationId", "repositoryId", "name", "fullName", "owner", "integrationId", "issuesCount", "hasSyncEnabled", "private", "status", "deletedAt" FROM "organization_github_repository"`);
        await queryRunner.query(`DROP TABLE "organization_github_repository"`);
        await queryRunner.query(`ALTER TABLE "temporary_organization_github_repository" RENAME TO "organization_github_repository"`);
        await queryRunner.query(`CREATE INDEX "IDX_59407d03d189560ac1a0a4b0eb" ON "organization_github_repository" ("status") `);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`organization_github_repository\` MODIFY COLUMN \`repositoryId\` bigint NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_ca0fa80f50baed7287a499dc2c\` ON \`organization_github_repository\` (\`repositoryId\`)`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`DROP INDEX \`IDX_ca0fa80f50baed7287a499dc2c\` ON \`organization_github_repository\``);
        await queryRunner.query(`ALTER TABLE \`organization_github_repository\` MODIFY COLUMN \`repositoryId\` int NOT NULL`);
        await queryRunner.query(`CREATE INDEX \`IDX_ca0fa80f50baed7287a499dc2c\` ON \`organization_github_repository\` (\`repositoryId\`)`);
    }
}
exports.AlterOrganizationGithubRepositoryEntityTable1719937371312 = AlterOrganizationGithubRepositoryEntityTable1719937371312;
//# sourceMappingURL=1719937371312-AlterOrganizationGithubRepositoryEntityTable.js.map