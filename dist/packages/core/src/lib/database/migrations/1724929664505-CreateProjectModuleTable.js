...
exports.CreateProjectModuleTable1724929664505 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateProjectModuleTable1724929664505 {
    constructor() {
        this.name = 'CreateProjectModuleTable1724929664505';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "project_module_sprint" ("organizationProjectModuleId" uuid NOT NULL, "organizationSprintId" uuid NOT NULL, CONSTRAINT "PK_7e6929079783cb90588e0f93762" PRIMARY KEY ("organizationProjectModuleId", "organizationSprintId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c91ef400079e93fec908cf9384" ON "project_module_sprint" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7af935d75a7e21fd76f072fbc0" ON "project_module_sprint" ("organizationSprintId") `);
        await queryRunner.query(`CREATE TABLE "project_module_team" ("organizationProjectModuleId" uuid NOT NULL, "organizationTeamId" uuid NOT NULL, CONSTRAINT "PK_64723331f528c88f4037f0bf437" PRIMARY KEY ("organizationProjectModuleId", "organizationTeamId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_42c46289259b3fcdf2dc61744a" ON "project_module_team" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d14aeb1b3e08d80eb32dd05934" ON "project_module_team" ("organizationTeamId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e9fd7310fc93849b1d55e64d28" ON "project_module_employee" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_18e428e909e48a4b7df43d7e01" ON "project_module_employee" ("employeeId") `);
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_module" ADD CONSTRAINT "FK_8a7a4d4206c003c3827c5afe5dc" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" ADD CONSTRAINT "FK_cd928adcb5ebb00c9f2c57e3908" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" ADD CONSTRAINT "FK_4bb6fbfa64cf5d5977c2e5346a9" FOREIGN KEY ("parentId") REFERENCES "organization_project_module"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" ADD CONSTRAINT "FK_7fd3c8f54c01943b283080aefa3" FOREIGN KEY ("projectId") REFERENCES "organization_project"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" ADD CONSTRAINT "FK_8f2054a6a2d4b9c17624b9c8a01" FOREIGN KEY ("creatorId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_579534d8e12f22d308d6bd5f428" FOREIGN KEY ("projectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project_module_sprint" ADD CONSTRAINT "FK_c91ef400079e93fec908cf93845" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_sprint" ADD CONSTRAINT "FK_7af935d75a7e21fd76f072fbc03" FOREIGN KEY ("organizationSprintId") REFERENCES "organization_sprint"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_team" ADD CONSTRAINT "FK_42c46289259b3fcdf2dc61744a7" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_team" ADD CONSTRAINT "FK_d14aeb1b3e08d80eb32dd05934b" FOREIGN KEY ("organizationTeamId") REFERENCES "organization_team"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_employee" ADD CONSTRAINT "FK_e9fd7310fc93849b1d55e64d280" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_employee" ADD CONSTRAINT "FK_18e428e909e48a4b7df43d7e01e" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "project_module_employee" DROP CONSTRAINT "FK_18e428e909e48a4b7df43d7e01e"`);
        await queryRunner.query(`ALTER TABLE "project_module_employee" DROP CONSTRAINT "FK_e9fd7310fc93849b1d55e64d280"`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_module" DROP CONSTRAINT "FK_8f2054a6a2d4b9c17624b9c8a01"`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" DROP CONSTRAINT "FK_7fd3c8f54c01943b283080aefa3"`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" DROP CONSTRAINT "FK_4bb6fbfa64cf5d5977c2e5346a9"`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" DROP CONSTRAINT "FK_cd928adcb5ebb00c9f2c57e3908"`);
        await queryRunner.query(`ALTER TABLE "organization_project_module" DROP CONSTRAINT "FK_8a7a4d4206c003c3827c5afe5dc"`);
    ...
    async sqliteUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "organization_project_module" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "description" text, "status" varchar, "startDate" datetime, "endDate" datetime, "public" boolean DEFAULT (0), "isFavorite" boolean DEFAULT (0), "parentId" varchar, "projectId" varchar, "creatorId" varchar, "managerId" varchar)`);
        await queryRunner.query(`CREATE INDEX "IDX_f33638d289aff2306328c32a8c" ON "organization_project_module" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_a56086e95fb2627ba2a3dd2eaa" ON "organization_project_module" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_8a7a4d4206c003c3827c5afe5d" ON "organization_project_module" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_cd928adcb5ebb00c9f2c57e390" ON "organization_project_module" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_8f2054a6a2d4b9c17624b9c8a0" ON "organization_project_module" ("creatorId") `);
        await queryRunner.query(`CREATE INDEX "IDX_e6b6555e5fc6c5120110a0195c" ON "organization_project_module" ("managerId") `);
        await queryRunner.query(`CREATE TABLE "project_module_sprint" ("organizationProjectModuleId" varchar NOT NULL, "organizationSprintId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "organizationSprintId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c91ef400079e93fec908cf9384" ON "project_module_sprint" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_7af935d75a7e21fd76f072fbc0" ON "project_module_sprint" ("organizationSprintId") `);
        await queryRunner.query(`CREATE TABLE "project_module_team" ("organizationProjectModuleId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "organizationTeamId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_42c46289259b3fcdf2dc61744a" ON "project_module_team" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d14aeb1b3e08d80eb32dd05934" ON "project_module_team" ("organizationTeamId") `);
        ...
        await queryRunner.query(`INSERT INTO "temporary_project_module_sprint"("organizationProjectModuleId", "organizationSprintId") SELECT "organizationProjectModuleId", "organizationSprintId" FROM "project_module_sprint"`);
        await queryRunner.query(`DROP TABLE "project_module_sprint"`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "project_module_employee" ("organizationProjectModuleId" varchar NOT NULL, "employeeId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "employeeId"))`);
        await queryRunner.query(`INSERT INTO "project_module_employee"("organizationProjectModuleId", "employeeId") SELECT "organizationProjectModuleId", "employeeId" FROM "temporary_project_module_employee"`);
        ...
        await queryRunner.query(`CREATE TABLE "project_module_team" ("organizationProjectModuleId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "organizationTeamId"))`);
        await queryRunner.query(`INSERT INTO "project_module_team"("organizationProjectModuleId", "organizationTeamId") SELECT "organizationProjectModuleId", "organizationTeamId" FROM "temporary_project_module_team"`);
        ...
        await queryRunner.query(`CREATE TABLE "project_module_sprint" ("organizationProjectModuleId" varchar NOT NULL, "organizationSprintId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "organizationSprintId"))`);
        await queryRunner.query(`INSERT INTO "project_module_sprint"("organizationProjectModuleId", "organizationSprintId") SELECT "organizationProjectModuleId", "organizationSprintId" FROM "temporary_project_module_sprint"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`organization_project_module\` (\`deletedAt\` datetime(6) NULL, \`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isActive\` tinyint NULL DEFAULT 1, \`isArchived\` tinyint NULL DEFAULT 0, \`tenantId\` varchar(255) NULL, \`organizationId\` varchar(255) NULL, \`name\` varchar(255) NOT NULL, \`description\` text NULL, \`status\` varchar(255) NULL, \`startDate\` datetime NULL, \`endDate\` datetime NULL, \`public\` tinyint NULL DEFAULT 0, \`isFavorite\` tinyint NULL DEFAULT 0, \`parentId\` varchar(255) NULL, \`projectId\` varchar(255) NULL, \`creatorId\` varchar(255) NULL, \`managerId\` varchar(255) NULL, INDEX \`IDX_f33638d289aff2306328c32a8c\` (\`isActive\`), INDEX \`IDX_a56086e95fb2627ba2a3dd2eaa\` (\`isArchived\`), INDEX \`IDX_8a7a4d4206c003c3827c5afe5d\` (\`tenantId\`), INDEX \`IDX_cd928adcb5ebb00c9f2c57e390\` (\`organizationId\`), INDEX \`IDX_86438fbaa1d857f32f66b24885\` (\`status\`), INDEX \`IDX_7fd3c8f54c01943b283080aefa\` (\`projectId\`), INDEX \`IDX_8f2054a6a2d4b9c17624b9c8a0\` (\`creatorId\`), INDEX \`IDX_e6b6555e5fc6c5120110a0195c\` (\`managerId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`project_module_sprint\` (\`organizationProjectModuleId\` varchar(36) NOT NULL, \`organizationSprintId\` varchar(36) NOT NULL, INDEX \`IDX_c91ef400079e93fec908cf9384\` (\`organizationProjectModuleId\`), INDEX \`IDX_7af935d75a7e21fd76f072fbc0\` (\`organizationSprintId\`), PRIMARY KEY (\`organizationProjectModuleId\`, \`organizationSprintId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`project_module_team\` (\`organizationProjectModuleId\` varchar(36) NOT NULL, \`organizationTeamId\` varchar(36) NOT NULL, INDEX \`IDX_42c46289259b3fcdf2dc61744a\` (\`organizationProjectModuleId\`), INDEX \`IDX_d14aeb1b3e08d80eb32dd05934\` (\`organizationTeamId\`), PRIMARY KEY (\`organizationProjectModuleId\`, \`organizationTeamId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`project_module_employee\` (\`organizationProjectModuleId\` varchar(36) NOT NULL, \`employeeId\` varchar(36) NOT NULL, INDEX \`IDX_e9fd7310fc93849b1d55e64d28\` (\`organizationProjectModuleId\`), INDEX \`IDX_18e428e909e48a4b7df43d7e01\` (\`employeeId\`), PRIMARY KEY (\`organizationProjectModuleId\`, \`employeeId\`)) ENGINE=InnoDB`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`project_module_employee\` DROP FOREIGN KEY \`FK_18e428e909e48a4b7df43d7e01e\``);
        await queryRunner.query(`ALTER TABLE \`project_module_employee\` DROP FOREIGN KEY \`FK_e9fd7310fc93849b1d55e64d280\``);
        await queryRunner.query(`ALTER TABLE \`project_module_team\` DROP FOREIGN KEY \`FK_d14aeb1b3e08d80eb32dd05934b\``);
        await queryRunner.query(`ALTER TABLE \`project_module_team\` DROP FOREIGN KEY \`FK_42c46289259b3fcdf2dc61744a7\``);
        await queryRunner.query(`ALTER TABLE \`project_module_sprint\` DROP FOREIGN KEY \`FK_7af935d75a7e21fd76f072fbc03\``);
        await queryRunner.query(`ALTER TABLE \`project_module_sprint\` DROP FOREIGN KEY \`FK_c91ef400079e93fec908cf93845\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_module\` DROP FOREIGN KEY \`FK_8f2054a6a2d4b9c17624b9c8a01\``);
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_module\` DROP FOREIGN KEY \`FK_8a7a4d4206c003c3827c5afe5dc\``);
...
exports.CreateProjectModuleTable1724929664505 = CreateProjectModuleTable1724929664505;
//# sourceMappingURL=1724929664505-CreateProjectModuleTable.js.map