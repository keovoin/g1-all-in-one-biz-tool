...
exports.AddColumnsToOrganizationProjectEntity1725956395183 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddColumnsToOrganizationProjectEntity1725956395183 {
    constructor() {
        this.name = 'AddColumnsToOrganizationProjectEntity1725956395183';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d6e002ae2ed0e1b0c9a52d8acf" ON "organization_project" ("archiveTasksIn") `);
        await queryRunner.query(`CREATE INDEX "IDX_f44648e75dbfafe2a807bd25df" ON "organization_project" ("closeTasksIn") `);
        await queryRunner.query(`CREATE INDEX "IDX_489012234f53089d4b508f4aa1" ON "organization_project" ("defaultAssigneeId") `);
        await queryRunner.query(`ALTER TABLE "organization_project" ADD CONSTRAINT "FK_489012234f53089d4b508f4aa12" FOREIGN KEY ("defaultAssigneeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`organization_project\` DROP FOREIGN KEY \`FK_489012234f53089d4b508f4aa12\``);
...
exports.AddColumnsToOrganizationProjectEntity1725956395183 = AddColumnsToOrganizationProjectEntity1725956395183;
//# sourceMappingURL=1725956395183-AddColumnsToOrganizationProjectEntity.js.map