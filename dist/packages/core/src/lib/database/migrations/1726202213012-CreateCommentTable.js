...
exports.CreateCommentTable1726202213012 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateCommentTable1726202213012 {
    constructor() {
        this.name = 'CreateCommentTable1726202213012';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "comment_employee" ("commentId" uuid NOT NULL, "employeeId" uuid NOT NULL, CONSTRAINT "PK_84f5039d23d11d672d1b25ed7de" PRIMARY KEY ("commentId", "employeeId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment_team" ("commentId" uuid NOT NULL, "organizationTeamId" uuid NOT NULL, CONSTRAINT "PK_33383797d72fffc0ffb16ac14b8" PRIMARY KEY ("commentId", "organizationTeamId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_afe39187fb8616dc2e7788d7af" ON "comment_team" ("commentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_53d72df8d6de8de0b5ba78c366" ON "comment_team" ("organizationTeamId") `);
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_8f58834bed39f0f9e85f048eafe" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_a3422826753d4e6b079dea98342" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "comment" ADD CONSTRAINT "FK_c9409c81aa283c1aae70fd5f4c3" FOREIGN KEY ("resolvedById") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "comment_employee" ADD CONSTRAINT "FK_3c3be7039bf788872d073e87351" FOREIGN KEY ("commentId") REFERENCES "comment"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "comment_employee" ADD CONSTRAINT "FK_6e1fd409e3619b83e19e8419357" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "comment_team" ADD CONSTRAINT "FK_afe39187fb8616dc2e7788d7aff" FOREIGN KEY ("commentId") REFERENCES "comment"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "comment_team" ADD CONSTRAINT "FK_53d72df8d6de8de0b5ba78c3669" FOREIGN KEY ("organizationTeamId") REFERENCES "organization_team"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "comment" ("deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "entity" varchar NOT NULL, "entityId" varchar NOT NULL, "comment" text NOT NULL, "actorType" varchar, "resolved" boolean, "resolvedAt" datetime, "editedAt" datetime, "creatorId" varchar, "resolvedById" varchar, "parentId" varchar)`);
        await queryRunner.query(`CREATE INDEX "IDX_3620aeff4ac5c977176226017e" ON "comment" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_da3cd25ed3a6ce76770f00c3da" ON "comment" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_8f58834bed39f0f9e85f048eaf" ON "comment" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a3422826753d4e6b079dea9834" ON "comment" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c9409c81aa283c1aae70fd5f4c" ON "comment" ("resolvedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_e3aebe2bd1c53467a07109be59" ON "comment" ("parentId") `);
        await queryRunner.query(`CREATE TABLE "comment_employee" ("commentId" varchar NOT NULL, "employeeId" varchar NOT NULL, PRIMARY KEY ("commentId", "employeeId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_3c3be7039bf788872d073e8735" ON "comment_employee" ("commentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6e1fd409e3619b83e19e841935" ON "comment_employee" ("employeeId") `);
        await queryRunner.query(`CREATE TABLE "comment_team" ("commentId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("commentId", "organizationTeamId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_afe39187fb8616dc2e7788d7af" ON "comment_team" ("commentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_53d72df8d6de8de0b5ba78c366" ON "comment_team" ("organizationTeamId") `);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "comment_team" ("commentId" varchar NOT NULL, "organizationTeamId" varchar NOT NULL, PRIMARY KEY ("commentId", "organizationTeamId"))`);
        await queryRunner.query(`INSERT INTO "comment_team"("commentId", "organizationTeamId") SELECT "commentId", "organizationTeamId" FROM "temporary_comment_team"`);
        ...
        await queryRunner.query(`CREATE TABLE "comment_employee" ("commentId" varchar NOT NULL, "employeeId" varchar NOT NULL, PRIMARY KEY ("commentId", "employeeId"))`);
        await queryRunner.query(`INSERT INTO "comment_employee"("commentId", "employeeId") SELECT "commentId", "employeeId" FROM "temporary_comment_employee"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`comment\` (\`deletedAt\` datetime(6) NULL, \`id\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`isActive\` tinyint NULL DEFAULT 1, \`isArchived\` tinyint NULL DEFAULT 0, \`archivedAt\` datetime NULL, \`tenantId\` varchar(255) NULL, \`organizationId\` varchar(255) NULL, \`entity\` varchar(255) NOT NULL, \`entityId\` varchar(255) NOT NULL, \`comment\` text(255) NOT NULL, \`actorType\` varchar(255) NULL, \`resolved\` tinyint NULL, \`resolvedAt\` datetime NULL, \`editedAt\` datetime NULL, \`creatorId\` varchar(255) NULL, \`resolvedById\` varchar(255) NULL, \`parentId\` varchar(255) NULL, INDEX \`IDX_3620aeff4ac5c977176226017e\` (\`isActive\`), INDEX \`IDX_da3cd25ed3a6ce76770f00c3da\` (\`isArchived\`), INDEX \`IDX_8f58834bed39f0f9e85f048eaf\` (\`tenantId\`), INDEX \`IDX_a3422826753d4e6b079dea9834\` (\`organizationId\`), INDEX \`IDX_097e339f6cb990306d19880a4c\` (\`entity\`), INDEX \`IDX_2950cfa146fc50334efa61a70b\` (\`entityId\`), INDEX \`IDX_eecd6e41f9acb6bf59e474d518\` (\`actorType\`), INDEX \`IDX_b6bf60ecb9f6c398e349adff52\` (\`creatorId\`), INDEX \`IDX_c9409c81aa283c1aae70fd5f4c\` (\`resolvedById\`), INDEX \`IDX_e3aebe2bd1c53467a07109be59\` (\`parentId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comment_employee\` (\`commentId\` varchar(36) NOT NULL, \`employeeId\` varchar(36) NOT NULL, INDEX \`IDX_3c3be7039bf788872d073e8735\` (\`commentId\`), INDEX \`IDX_6e1fd409e3619b83e19e841935\` (\`employeeId\`), PRIMARY KEY (\`commentId\`, \`employeeId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comment_team\` (\`commentId\` varchar(36) NOT NULL, \`organizationTeamId\` varchar(36) NOT NULL, INDEX \`IDX_afe39187fb8616dc2e7788d7af\` (\`commentId\`), INDEX \`IDX_53d72df8d6de8de0b5ba78c366\` (\`organizationTeamId\`), PRIMARY KEY (\`commentId\`, \`organizationTeamId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD CONSTRAINT \`FK_8f58834bed39f0f9e85f048eafe\` FOREIGN KEY (\`tenantId\`) REFERENCES \`tenant\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD CONSTRAINT \`FK_a3422826753d4e6b079dea98342\` FOREIGN KEY (\`organizationId\`) REFERENCES \`organization\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD CONSTRAINT \`FK_b6bf60ecb9f6c398e349adff52f\` FOREIGN KEY (\`creatorId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`comment\` ADD CONSTRAINT \`FK_c9409c81aa283c1aae70fd5f4c3\` FOREIGN KEY (\`resolvedById\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
...
exports.CreateCommentTable1726202213012 = CreateCommentTable1726202213012;
//# sourceMappingURL=1726202213012-CreateCommentTable.js.map