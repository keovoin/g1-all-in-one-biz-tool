...
exports.CreateProjectModuleTaskTable1727152443794 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateProjectModuleTaskTable1727152443794 {
    constructor() {
        this.name = 'CreateProjectModuleTaskTable1727152443794';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "project_module_task" ("organizationProjectModuleId" uuid NOT NULL, "taskId" uuid NOT NULL, CONSTRAINT "PK_524eec559972ae7bd85df1ac492" PRIMARY KEY ("organizationProjectModuleId", "taskId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_58941b9cf23de12b2ecea4a959" ON "project_module_task" ("organizationProjectModuleId") `);
        ...
        await queryRunner.query(`ALTER TABLE "project_module_task" ADD CONSTRAINT "FK_58941b9cf23de12b2ecea4a959f" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "project_module_task" ADD CONSTRAINT "FK_d056d5ba005e15ff92d4d7a8ca5" FOREIGN KEY ("taskId") REFERENCES "task"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX "IDX_579534d8e12f22d308d6bd5f42"`);
        await queryRunner.query(`CREATE TABLE "project_module_task" ("organizationProjectModuleId" varchar NOT NULL, "taskId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "taskId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_58941b9cf23de12b2ecea4a959" ON "project_module_task" ("organizationProjectModuleId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d056d5ba005e15ff92d4d7a8ca" ON "project_module_task" ("taskId") `);
        await queryRunner.query(`DROP INDEX "IDX_ca2f7edd5a5ce8f14b257c9d54"`);
        await queryRunner.query(`DROP INDEX "IDX_3e16c81005c389a4db83c0e5e3"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_project_module_task" ("organizationProjectModuleId" varchar NOT NULL, "taskId" varchar NOT NULL, CONSTRAINT "FK_58941b9cf23de12b2ecea4a959f" FOREIGN KEY ("organizationProjectModuleId") REFERENCES "organization_project_module" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_d056d5ba005e15ff92d4d7a8ca5" FOREIGN KEY ("taskId") REFERENCES "task" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("organizationProjectModuleId", "taskId"))`);
        await queryRunner.query(`INSERT INTO "temporary_project_module_task"("organizationProjectModuleId", "taskId") SELECT "organizationProjectModuleId", "taskId" FROM "project_module_task"`);
        await queryRunner.query(`DROP TABLE "project_module_task"`);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "project_module_task" ("organizationProjectModuleId" varchar NOT NULL, "taskId" varchar NOT NULL, PRIMARY KEY ("organizationProjectModuleId", "taskId"))`);
        await queryRunner.query(`INSERT INTO "project_module_task"("organizationProjectModuleId", "taskId") SELECT "organizationProjectModuleId", "taskId" FROM "temporary_project_module_task"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`project_module_task\` (\`organizationProjectModuleId\` varchar(36) NOT NULL, \`taskId\` varchar(36) NOT NULL, INDEX \`IDX_58941b9cf23de12b2ecea4a959\` (\`organizationProjectModuleId\`), INDEX \`IDX_d056d5ba005e15ff92d4d7a8ca\` (\`taskId\`), PRIMARY KEY (\`organizationProjectModuleId\`, \`taskId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`task\` DROP COLUMN \`projectModuleId\``);
        await queryRunner.query(`ALTER TABLE \`project_module_task\` ADD CONSTRAINT \`FK_58941b9cf23de12b2ecea4a959f\` FOREIGN KEY (\`organizationProjectModuleId\`) REFERENCES \`organization_project_module\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`project_module_task\` ADD CONSTRAINT \`FK_d056d5ba005e15ff92d4d7a8ca5\` FOREIGN KEY (\`taskId\`) REFERENCES \`task\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`project_module_task\` DROP FOREIGN KEY \`FK_d056d5ba005e15ff92d4d7a8ca5\``);
        await queryRunner.query(`ALTER TABLE \`project_module_task\` DROP FOREIGN KEY \`FK_58941b9cf23de12b2ecea4a959f\``);
...
exports.CreateProjectModuleTaskTable1727152443794 = CreateProjectModuleTaskTable1727152443794;
//# sourceMappingURL=1727152443794-CreateProjectModuleTaskTable.js.map