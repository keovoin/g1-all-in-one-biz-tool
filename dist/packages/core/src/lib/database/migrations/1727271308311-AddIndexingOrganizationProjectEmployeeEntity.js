...
exports.AddIndexingOrganizationProjectEmployeeEntity1727271308311 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddIndexingOrganizationProjectEmployeeEntity1727271308311 {
    constructor() {
        this.name = 'AddIndexingOrganizationProjectEmployeeEntity1727271308311';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "organization_project_employee" RENAME TO "temporary_organization_project_employee"`);
        await queryRunner.query(`CREATE TABLE "organization_project_employee" ("employeeId" varchar NOT NULL, "organizationProjectId" varchar NOT NULL, "deletedAt" datetime, "id" varchar PRIMARY KEY NOT NULL, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "isManager" boolean DEFAULT (0), "assignedAt" datetime, "roleId" varchar)`);
        await queryRunner.query(`INSERT INTO "organization_project_employee"("employeeId", "organizationProjectId", "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "isManager", "assignedAt", "roleId") SELECT "employeeId", "organizationProjectId", "deletedAt", "id", "createdAt", "updatedAt", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "isManager", "assignedAt", "roleId" FROM "temporary_organization_project_employee"`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` MODIFY \`organizationProjectId\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` MODIFY \`employeeId\` varchar(255) NOT NULL`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` MODIFY \`employeeId\` varchar(36) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` MODIFY \`organizationProjectId\` varchar(36) NOT NULL`);
        console.log('Step 4: Re-adding the foreign key constraints...');
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD CONSTRAINT \`FK_6b5b0c3d994f59d9c800922257f\` FOREIGN KEY (\`employeeId\`) REFERENCES \`employee\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`organization_project_employee\` ADD CONSTRAINT \`FK_2ba868f42c2301075b7c141359e\` FOREIGN KEY (\`organizationProjectId\`) REFERENCES \`organization_project\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
}
exports.AddIndexingOrganizationProjectEmployeeEntity1727271308311 = AddIndexingOrganizationProjectEmployeeEntity1727271308311;
//# sourceMappingURL=1727271308311-AddIndexingOrganizationProjectEmployeeEntity.js.map