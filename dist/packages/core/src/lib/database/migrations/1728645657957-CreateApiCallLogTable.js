...
exports.CreateApiCallLogTable1728645657957 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateApiCallLogTable1728645657957 {
    constructor() {
        this.name = 'CreateApiCallLogTable1728645657957';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "api_call_log" ADD CONSTRAINT "FK_94c4d067f73d90faaad8c2d3dbd" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "api_call_log" ADD CONSTRAINT "FK_89292145eeceb7ff32dac0de83b" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "api_call_log" ADD CONSTRAINT "FK_ada33b1685138be7798aea280b2" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
...
exports.CreateApiCallLogTable1728645657957 = CreateApiCallLogTable1728645657957;
//# sourceMappingURL=1728645657957-CreateApiCallLogTable.js.map