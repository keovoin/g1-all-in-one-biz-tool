...
exports.CreateEmployeeNotificationTable1739269734150 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateEmployeeNotificationTable1739269734150 {
    constructor() {
        this.name = 'CreateEmployeeNotificationTable1739269734150';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "employee_notification" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "entity" character varying NOT NULL, "entityId" character varying NOT NULL, "title" character varying, "message" character varying, "type" integer, "isRead" boolean NOT NULL DEFAULT false, "readAt" TIMESTAMP, "onHoldUntil" TIMESTAMP, "sentById" uuid, "receiverId" uuid, CONSTRAINT "PK_4123ffa3739c135a12cea285964" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d966bfd3404cbb285ac27f10da" ON "employee_notification" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_8b7d5e4ea44334201702b94439" ON "employee_notification" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_6f82155f53ac73b468200ee995" ON "employee_notification" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a7740fc0a794549142743373f7" ON "employee_notification" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d7df050beb5ed8c5b72243c1f5" ON "employee_notification" ("entity") `);
        await queryRunner.query(`CREATE INDEX "IDX_8ca39a79d0dfd72bb8b9c9b0da" ON "employee_notification" ("entityId") `);
        await queryRunner.query(`CREATE INDEX "IDX_72b91233f9b7e95df7ab0dc12c" ON "employee_notification" ("type") `);
        await queryRunner.query(`CREATE INDEX "IDX_84554498767210c8b960dc2c7b" ON "employee_notification" ("sentById") `);
        await queryRunner.query(`CREATE INDEX "IDX_da490fa82625eb794ec5336fbd" ON "employee_notification" ("receiverId") `);
        await queryRunner.query(`ALTER TABLE "employee_notification" ADD CONSTRAINT "FK_6f82155f53ac73b468200ee995b" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_notification" ADD CONSTRAINT "FK_a7740fc0a794549142743373f7c" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "employee_notification" ADD CONSTRAINT "FK_84554498767210c8b960dc2c7b5" FOREIGN KEY ("sentById") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_notification" ADD CONSTRAINT "FK_da490fa82625eb794ec5336fbd5" FOREIGN KEY ("receiverId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_da490fa82625eb794ec5336fbd5\``);
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_84554498767210c8b960dc2c7b5\``);
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_a7740fc0a794549142743373f7c\``);
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_6f82155f53ac73b468200ee995b\``);
...
exports.CreateEmployeeNotificationTable1739269734150 = CreateEmployeeNotificationTable1739269734150;
//# sourceMappingURL=1739269734150-CreateEmployeeNotificationTable.js.map