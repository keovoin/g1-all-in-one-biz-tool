...
exports.AlterEmployeeNotificationEntityTable1739881882070 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterEmployeeNotificationEntityTable1739881882070 {
    constructor() {
        this.name = 'AlterEmployeeNotificationEntityTable1739881882070';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a218a9bd93a882a32e33d6c35b" ON "employee_notification" ("sentByEmployeeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dd1a1a634c937f77be394ceaca" ON "employee_notification" ("receiverEmployeeId") `);
        await queryRunner.query(`ALTER TABLE "employee_notification"
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_dd1a1a634c937f77be394ceaca4\``);
        await queryRunner.query(`ALTER TABLE \`employee_notification\` DROP FOREIGN KEY \`FK_a218a9bd93a882a32e33d6c35b8\``);
...
exports.AlterEmployeeNotificationEntityTable1739881882070 = AlterEmployeeNotificationEntityTable1739881882070;
//# sourceMappingURL=1739881882070-AlterEmployeeNotificationEntityTable.js.map