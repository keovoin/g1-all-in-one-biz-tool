...
exports.AlterDashboardEntityTable1739950092274 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterDashboardEntityTable1739950092274 {
    constructor() {
        this.name = 'AlterDashboardEntityTable1739950092274';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "dashboard" ADD CONSTRAINT "FK_b34e5ae765e0f8d674e06046210" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "dashboard" ADD CONSTRAINT "FK_30613c8cd1a1df1b176dfb696ba" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
		...
		`);
        await queryRunner.query(`INSERT INTO "temporary_dashboard" (
				"deletedAt",
				"id",
				"createdAt",
				"updatedAt",
...
exports.AlterDashboardEntityTable1739950092274 = AlterDashboardEntityTable1739950092274;
//# sourceMappingURL=1739950092274-AlterDashboardEntityTable.js.map