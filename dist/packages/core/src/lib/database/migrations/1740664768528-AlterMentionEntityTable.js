...
exports.AlterMentionEntityTable1740664768528 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterMentionEntityTable1740664768528 {
    constructor() {
        this.name = 'AlterMentionEntityTable1740664768528';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "mention" ADD CONSTRAINT "FK_a123435acf8d70e5df978e759f9" FOREIGN KEY ("mentionedEmployeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mention" ADD CONSTRAINT "FK_465f1a9281f338ae38cc961c2a5" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
...
exports.AlterMentionEntityTable1740664768528 = AlterMentionEntityTable1740664768528;
//# sourceMappingURL=1740664768528-AlterMentionEntityTable.js.map