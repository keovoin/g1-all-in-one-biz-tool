...
exports.AlterOrganizationContactEntityTable1741013208083 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AlterOrganizationContactEntityTable1741013208083 {
    constructor() {
        this.name = 'AlterOrganizationContactEntityTable1741013208083';
    }
    /**
     * Up Migration
     *
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_organization_contact" (
        ...
        await queryRunner.query(`INSERT INTO "temporary_organization_contact" (
				"id",
				"createdAt",
				"updatedAt",
				"tenantId",
        ...
        await queryRunner.query(`CREATE INDEX "IDX_f8df3dea1e42ef16ae7f411304" ON "organization_contact" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_53bb1086e10d553249483b267c" ON "organization_contact" ("createdByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b5589e035e86d23ebb54ea2728" ON "organization_contact" ("updatedByUserId") `);
    }
    /**
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "organization_contact" (
				"id" varchar PRIMARY KEY NOT NULL,
				"createdAt" datetime NOT NULL DEFAULT (datetime('now')),
				"updatedAt" datetime NOT NULL DEFAULT (datetime('now')),
				"tenantId" varchar,
        ...
        await queryRunner.query(`INSERT INTO "organization_contact" (
					"id",
					"createdAt",
					"updatedAt",
					"tenantId",
...
exports.AlterOrganizationContactEntityTable1741013208083 = AlterOrganizationContactEntityTable1741013208083;
//# sourceMappingURL=1741013208083-AlterOrganizationContactEntityTable.js.map