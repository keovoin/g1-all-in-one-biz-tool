...
exports.CreatePluginRegistryTables1744042852245 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreatePluginRegistryTables1744042852245 {
    constructor() {
        this.name = 'CreatePluginRegistryTables1744042852245';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "plugin_name_unique" ON "plugin" ("name", "tenantId", "organizationId") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_source_type_enum" AS ENUM('CDN', 'NPM', 'GAUZY')`);
        await queryRunner.query(`CREATE TYPE "public"."plugin_source_storageprovider_enum" AS ENUM('LOCAL', 'S3', 'WASABI', 'CLOUDINARY', 'DIGITALOCEAN')`);
        await queryRunner.query(`CREATE TABLE "plugin_source" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "type" "public"."plugin_source_type_enum" NOT NULL DEFAULT 'GAUZY', "url" character varying, "integrity" character varying, "crossOrigin" character varying, "name" character varying, "registry" character varying, "authToken" character varying, "scope" character varying, "filePath" character varying, "fileName" character varying, "fileSize" integer, "mimeType" character varying, "fileKey" character varying, "storageProvider" "public"."plugin_source_storageprovider_enum", CONSTRAINT "PK_71e0a0e707d4b9f820c17f86aae" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_27fdaefcb8465eb3cb6c20e186" ON "plugin_source" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_a69a8ef5d1c35133a727915eae" ON "plugin_source" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_834606ec25b3e69303f59d6589" ON "plugin_source" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ff61527634c5d822340f3e79ff" ON "plugin_source" ("storageProvider") `);
        await queryRunner.query(`CREATE TABLE "plugin_version" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "number" character varying NOT NULL, "changelog" character varying NOT NULL, "checksum" character varying, "signature" character varying, "releaseDate" TIMESTAMP, "downloadCount" integer DEFAULT '0', "pluginId" uuid, "sourceId" uuid, CONSTRAINT "PK_eeb07a209be95b5be49cba59506" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_26055fbc6d60ce8ef96c77e16c" ON "plugin_version" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_3971ab167afbeaaba96d6cb9a0" ON "plugin_version" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_1549236e0d968bd869822d1732" ON "plugin_version" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ffadd2f2026dac3093d91146b6" ON "plugin_version" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "version_number_unique" ON "plugin_version" ("number", "pluginId", "organizationId") `);
        await queryRunner.query(`CREATE TYPE "public"."plugin_installation_status_enum" AS ENUM('INSTALLED', 'UNINSTALLED', 'FAILED', 'IN_PROGRESS')`);
        await queryRunner.query(`CREATE TABLE "plugin_installation" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "pluginId" uuid, "versionId" uuid, "installedById" uuid, "installedAt" TIMESTAMP, "uninstalledAt" TIMESTAMP, "status" "public"."plugin_installation_status_enum" NOT NULL DEFAULT 'IN_PROGRESS', CONSTRAINT "PK_02e4e7b02c67f804402cb4024fc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0e5f736f4bae285465ce05d81f" ON "plugin_installation" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_eb5347a4524869ce01ad22b410" ON "plugin_installation" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_c7c4af328bc85385d0d7a4db44" ON "plugin_installation" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b2736edd3271ae93ac74562d8d" ON "plugin_installation" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_8a364835e06cb9808ca4b93b4a" ON "plugin_installation" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_731d86983d8b3dc7cebc0ceb8f" ON "plugin_installation" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_42b298829d83d366ae2376f2cb" ON "plugin_installation" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_03620f08161e043b2ba2b54962" ON "plugin_installation" ("pluginId") `);
        await queryRunner.query(`CREATE INDEX "IDX_d5acaca47cfe43f77a762f8f52" ON "plugin_installation" ("versionId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f9ac2acfa7ac5ce3fbfe5b8eaf" ON "plugin_installation" ("installedById") `);
        await queryRunner.query(`CREATE INDEX "IDX_3003252e5d74975894d7ed4177" ON "plugin_installation" ("installedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_c8e4d312492e0a580a242389a6" ON "plugin_installation" ("uninstalledAt") `);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_7c3688c98c2cdfd05c3b7bb88de" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_220e5b9a8ba6d2e516c0fa7ff4a" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_d68bb86d4cc9696720cf02f3277" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_5c6a707a544a1a99fe812ad197a" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_cdd4d6e608dbac3d35cadc0b28a" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin" ADD CONSTRAINT "FK_923ef271a64240756c418e417eb" FOREIGN KEY ("uploadedById") REFERENCES "employee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_27fdaefcb8465eb3cb6c20e1861" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_a69a8ef5d1c35133a727915eae8" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_834606ec25b3e69303f59d65893" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_9acdcb59ff7adecbac0a6ebeb5c" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_source" ADD CONSTRAINT "FK_b93bd5d3d1c0b78e2e87a351305" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_26055fbc6d60ce8ef96c77e16c7" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_3971ab167afbeaaba96d6cb9a05" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_1549236e0d968bd869822d1732f" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_216cf6b8c20a2e0a9380c17c6b7" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_ffadd2f2026dac3093d91146b64" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_b2675c6a056281d5155b1b7bb86" FOREIGN KEY ("pluginId") REFERENCES "plugin"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_version" ADD CONSTRAINT "FK_e459ef09a96deb0763e27822634" FOREIGN KEY ("sourceId") REFERENCES "plugin_source"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_0e5f736f4bae285465ce05d81f8" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_eb5347a4524869ce01ad22b4103" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_c7c4af328bc85385d0d7a4db444" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_731d86983d8b3dc7cebc0ceb8f4" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_42b298829d83d366ae2376f2cbf" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_03620f08161e043b2ba2b549629" FOREIGN KEY ("pluginId") REFERENCES "plugin"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_d5acaca47cfe43f77a762f8f528" FOREIGN KEY ("versionId") REFERENCES "plugin_version"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "plugin_installation" ADD CONSTRAINT "FK_f9ac2acfa7ac5ce3fbfe5b8eaf5" FOREIGN KEY ("installedById") REFERENCES "employee"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b93bd5d3d1c0b78e2e87a35130" ON "plugin_source" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ff61527634c5d822340f3e79ff" ON "plugin_source" ("storageProvider") `);
        await queryRunner.query(`CREATE TABLE "plugin_version" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "number" varchar NOT NULL, "changelog" varchar NOT NULL, "checksum" varchar, "signature" varchar, "releaseDate" datetime, "downloadCount" integer DEFAULT (0), "pluginId" varchar, "sourceId" varchar)`);
        await queryRunner.query(`CREATE INDEX "IDX_26055fbc6d60ce8ef96c77e16c" ON "plugin_version" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_3971ab167afbeaaba96d6cb9a0" ON "plugin_version" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_1549236e0d968bd869822d1732" ON "plugin_version" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b113606a9ed1b208e91a090e57" ON "plugin_version" ("isActive") `);
    ...
    async sqliteDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "plugin_version" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "number" varchar NOT NULL, "changelog" varchar NOT NULL, "checksum" varchar, "signature" varchar, "releaseDate" datetime, "downloadCount" integer DEFAULT (0), "pluginId" varchar, "sourceId" varchar)`);
        await queryRunner.query(`INSERT INTO "plugin_version"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId", "sourceId") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "number", "changelog", "checksum", "signature", "releaseDate", "downloadCount", "pluginId", "sourceId" FROM "temporary_plugin_version"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin_source" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "type" varchar CHECK( "type" IN ('CDN','NPM','GAUZY') ) NOT NULL DEFAULT ('GAUZY'), "url" varchar, "integrity" varchar, "crossOrigin" varchar, "name" varchar, "registry" varchar, "authToken" varchar, "scope" varchar, "filePath" varchar, "fileName" varchar, "fileSize" integer, "mimeType" varchar, "fileKey" varchar, "storageProvider" varchar CHECK( "storageProvider" IN ('LOCAL','S3','WASABI','CLOUDINARY','DIGITALOCEAN') ))`);
        await queryRunner.query(`INSERT INTO "plugin_source"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type", "url", "integrity", "crossOrigin", "name", "registry", "authToken", "scope", "filePath", "fileName", "fileSize", "mimeType", "fileKey", "storageProvider") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "type", "url", "integrity", "crossOrigin", "name", "registry", "authToken", "scope", "filePath", "fileName", "fileSize", "mimeType", "fileKey", "storageProvider" FROM "temporary_plugin_source"`);
        ...
        await queryRunner.query(`CREATE TABLE "plugin" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "name" varchar NOT NULL, "description" varchar, "type" varchar CHECK( "type" IN ('DESKTOP','WEB','MOBILE') ) NOT NULL DEFAULT ('DESKTOP'), "status" varchar CHECK( "status" IN ('ACTIVE','INACTIVE','DEPRECATED','ARCHIVED') ) NOT NULL DEFAULT ('ACTIVE'), "author" varchar, "license" varchar, "homepage" varchar, "repository" varchar, "uploadedById" varchar, "uploadedAt" datetime, "lastDownloadedAt" datetime)`);
        await queryRunner.query(`INSERT INTO "plugin"("deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "name", "description", "type", "status", "author", "license", "homepage", "repository", "uploadedById", "uploadedAt", "lastDownloadedAt") SELECT "deletedAt", "createdAt", "updatedAt", "createdByUserId", "updatedByUserId", "deletedByUserId", "id", "isActive", "isArchived", "archivedAt", "tenantId", "organizationId", "name", "description", "type", "status", "author", "license", "homepage", "repository", "uploadedById", "uploadedAt", "lastDownloadedAt" FROM "temporary_plugin"`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_f9ac2acfa7ac5ce3fbfe5b8eaf5\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_d5acaca47cfe43f77a762f8f528\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_03620f08161e043b2ba2b549629\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_42b298829d83d366ae2376f2cbf\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_731d86983d8b3dc7cebc0ceb8f4\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_c7c4af328bc85385d0d7a4db444\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_eb5347a4524869ce01ad22b4103\``);
        await queryRunner.query(`ALTER TABLE \`plugin_installation\` DROP FOREIGN KEY \`FK_0e5f736f4bae285465ce05d81f8\``);
...
exports.CreatePluginRegistryTables1744042852245 = CreatePluginRegistryTables1744042852245;
//# sourceMappingURL=1744042852245-CreatePluginRegistryTables.js.map