...
exports.CreateEmployeeRecentVisitTable1746005191501 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateEmployeeRecentVisitTable1746005191501 {
    constructor() {
        this.name = 'CreateEmployeeRecentVisitTable1746005191501';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "employee_recent_visit" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "entity" character varying NOT NULL, "entityId" character varying NOT NULL, "visitedAt" TIMESTAMP NOT NULL, "data" jsonb, "employeeId" uuid, CONSTRAINT "PK_337d10740e5c38a4dd99e9168a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_29a13d42e1686288790b91631d0" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_603d9f9c3b23f6cbf87a761aa9d" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_1c472474d0a5a5d777a12d42009" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_effb569c0a0b84712024421280b" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_d6b98339cd0a8b36e7b929cfd95" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "employee_recent_visit" ADD CONSTRAINT "FK_45efdea12a6aead0412829553e4" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_45efdea12a6aead0412829553e4\``);
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_d6b98339cd0a8b36e7b929cfd95\``);
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_effb569c0a0b84712024421280b\``);
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_1c472474d0a5a5d777a12d42009\``);
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_603d9f9c3b23f6cbf87a761aa9d\``);
        await queryRunner.query(`ALTER TABLE \`employee_recent_visit\` DROP FOREIGN KEY \`FK_29a13d42e1686288790b91631d0\``);
...
exports.CreateEmployeeRecentVisitTable1746005191501 = CreateEmployeeRecentVisitTable1746005191501;
//# sourceMappingURL=1746005191501-CreateEmployeeRecentVisitTable.js.map