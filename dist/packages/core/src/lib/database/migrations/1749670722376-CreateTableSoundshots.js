...
exports.CreateTableSoundshots1749670722376 = void 0;
const config_1 = require("@gauzy/config");
const chalk = require("chalk");
class CreateTableSoundshots1749670722376 {
    constructor() {
        this.name = 'CreateTableSoundshots1749670722376';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_e8346a8a54e1fdfe54297b0297f" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_8e6ff08e6d1dcf820bb24c545a4" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_216d2023361c849e419146f330c" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_7de627bf0f59aa175f971b6d642" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_6d2c1146b1e3de4209b6aada016" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_b6f509649ae24881b1a74049f24" FOREIGN KEY ("timeSlotId") REFERENCES "time_slot"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_fa9d656c6685b38aa0a36d0054b" FOREIGN KEY ("uploadedById") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "soundshots" ADD CONSTRAINT "FK_1f078ed6d16319d2fcf8344f7a2" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
...
exports.CreateTableSoundshots1749670722376 = CreateTableSoundshots1749670722376;
//# sourceMappingURL=1749670722376-CreateTableSoundshots.js.map