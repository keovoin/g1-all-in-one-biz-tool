...
exports.AddEmployeeAgentTimerSettings1752368969352 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddEmployeeAgentTimerSettings1752368969352 {
    constructor() {
        this.name = 'AddEmployeeAgentTimerSettings1752368969352';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "employee" ADD "trackKeyboardMouseActivity" boolean NOT NULL DEFAULT false`);
    ...
    async mysqlUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`employee\` ADD \`trackKeyboardMouseActivity\` tinyint NOT NULL DEFAULT 0`);
...
exports.AddEmployeeAgentTimerSettings1752368969352 = AddEmployeeAgentTimerSettings1752368969352;
//# sourceMappingURL=1752368969352-AddEmployeeAgentTimerSettings.js.map