...
exports.AddTimeSlotSessionEntity1757149401754 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddTimeSlotSessionEntity1757149401754 {
    constructor() {
        this.name = 'AddTimeSlotSessionEntity1757149401754';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "time_slot_session" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "sessionId" character varying NOT NULL, "startTime" TIMESTAMP, "lastActivity" TIMESTAMP, "timeSlotId" uuid NOT NULL, "employeeId" uuid NOT NULL, CONSTRAINT "PK_92509d6a10a5b8faff66101e83d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_63d9e137716eb1bdfe93ccf23d" ON "time_slot_session" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f120aba634b63389a3a351a4f5" ON "time_slot_session" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f955d4fc2146d3696c9af8f068" ON "time_slot_session" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_674bdff03d51898ca8a237f163" ON "time_slot_session" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_aed773ef44611150e65749733b" ON "time_slot_session" ("lastActivity") `);
        ...
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_63d9e137716eb1bdfe93ccf23d2" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_f120aba634b63389a3a351a4f57" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_f955d4fc2146d3696c9af8f0688" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_228e69500a55e2f311c0219d9fc" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_674bdff03d51898ca8a237f1630" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_8966a6ed4ff080f259844c38b9d" FOREIGN KEY ("timeSlotId") REFERENCES "time_slot"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_slot_session" ADD CONSTRAINT "FK_dc605390f47dd26469f855307dc" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
    /**
    ...
    async sqliteUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "time_slot_session" ("deletedAt" datetime, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "createdByUserId" varchar, "updatedByUserId" varchar, "deletedByUserId" varchar, "id" varchar PRIMARY KEY NOT NULL, "isActive" boolean DEFAULT (1), "isArchived" boolean DEFAULT (0), "archivedAt" datetime, "tenantId" varchar, "organizationId" varchar, "sessionId" varchar NOT NULL, "startTime" datetime, "lastActivity" datetime, "timeSlotId" varchar NOT NULL, "employeeId" varchar NOT NULL)`);
        await queryRunner.query(`CREATE INDEX "IDX_63d9e137716eb1bdfe93ccf23d" ON "time_slot_session" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f120aba634b63389a3a351a4f5" ON "time_slot_session" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f955d4fc2146d3696c9af8f068" ON "time_slot_session" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_382c80e92aa263e9cd2e98a664" ON "time_slot_session" ("isActive") `);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_dc605390f47dd26469f855307dc\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_8966a6ed4ff080f259844c38b9d\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_674bdff03d51898ca8a237f1630\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_228e69500a55e2f311c0219d9fc\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_f955d4fc2146d3696c9af8f0688\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_f120aba634b63389a3a351a4f57\``);
        await queryRunner.query(`ALTER TABLE \`time_slot_session\` DROP FOREIGN KEY \`FK_63d9e137716eb1bdfe93ccf23d2\``);
...
exports.AddTimeSlotSessionEntity1757149401754 = AddTimeSlotSessionEntity1757149401754;
//# sourceMappingURL=1757149401754-AddTimeSlotSessionEntity.js.map