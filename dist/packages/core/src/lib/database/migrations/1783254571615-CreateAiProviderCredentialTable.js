...
exports.CreateAiProviderCredentialTable1783254571615 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateAiProviderCredentialTable1783254571615 {
    constructor() {
        this.name = 'CreateAiProviderCredentialTable1783254571615';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "ai_provider_credential" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "providerId" character varying NOT NULL, "apiKey" text, "baseUrl" character varying, "enabled" boolean NOT NULL DEFAULT true, "isDefault" boolean NOT NULL DEFAULT false, "defaultModel" character varying, CONSTRAINT "PK_ff8dcfd873bfb854530888b36bc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_ai_provider_credential_tenant_provider" ON "ai_provider_credential" ("tenantId", "providerId") `);
        await queryRunner.query(`ALTER TABLE "ai_provider_credential" ADD CONSTRAINT "FK_91d67d330af8977f70ef04621c1" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_provider_credential" ADD CONSTRAINT "FK_75e914e1e807641505d7087b5f2" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_provider_credential" ADD CONSTRAINT "FK_d8699f7283e0e764834e621e0eb" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_provider_credential" ADD CONSTRAINT "FK_3ff5f4914d7180d24c81328b7df" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_provider_credential" ADD CONSTRAINT "FK_506bd348f082e306fa106c31f3b" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
...
exports.CreateAiProviderCredentialTable1783254571615 = CreateAiProviderCredentialTable1783254571615;
//# sourceMappingURL=1783254571615-CreateAiProviderCredentialTable.js.map