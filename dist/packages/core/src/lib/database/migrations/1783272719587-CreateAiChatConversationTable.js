...
exports.CreateAiChatConversationTable1783272719587 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class CreateAiChatConversationTable1783272719587 {
    constructor() {
        this.name = 'CreateAiChatConversationTable1783272719587';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "ai_chat_conversation" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "userId" character varying NOT NULL, "title" character varying NOT NULL, "messages" text NOT NULL, CONSTRAINT "PK_bd32361512fc47c6e1b86691f28" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_chat_conversation" ADD CONSTRAINT "FK_92d267aecde262cc5405651cbf4" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_chat_conversation" ADD CONSTRAINT "FK_2334c91fa21922b73ab5a56c359" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_chat_conversation" ADD CONSTRAINT "FK_cbbf346d07f83de71482c0f39c1" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_chat_conversation" ADD CONSTRAINT "FK_50a06f8e70623fd1ea8df0e9212" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_chat_conversation" ADD CONSTRAINT "FK_d683aef79816b0d49e6949d45c9" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
...
exports.CreateAiChatConversationTable1783272719587 = CreateAiChatConversationTable1783272719587;
//# sourceMappingURL=1783272719587-CreateAiChatConversationTable.js.map