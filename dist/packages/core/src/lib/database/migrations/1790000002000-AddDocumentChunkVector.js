...
exports.AddDocumentChunkVector1790000002000 = void 0;
const chalk = require("chalk");
const config_1 = require("@gauzy/config");
class AddDocumentChunkVector1790000002000 {
    constructor() {
        this.name = 'AddDocumentChunkVector1790000002000';
    }
    /**
     * Up Migration
     *
    ...
    */
    async postgresUpQueryRunner(queryRunner) {
        ...
        try {
            ...
            console.log(chalk.yellow(`pgvector extension unavailable — "document_chunk"."embedding" stays text and retrieval degrades to lexical-only: ${error}`));
        }
...
exports.AddDocumentChunkVector1790000002000 = AddDocumentChunkVector1790000002000;
//# sourceMappingURL=1790000002000-AddDocumentChunkVector.js.map