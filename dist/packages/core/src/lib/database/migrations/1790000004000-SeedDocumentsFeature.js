...
exports.SeedDocumentsFeature1790000004000 = void 0;
const chalk = require("chalk");
const uuid_1 = require("uuid");
const contracts_1 = require("@gauzy/contracts");
const config_1 = require("@gauzy/config");
class SeedDocumentsFeature1790000004000 {
    constructor() {
        this.name = 'SeedDocumentsFeature1790000004000';
        /**
    ...
    async down(queryRunner) {
        ...
        switch (queryRunner.connection.options.type) {
            case config_1.DatabaseTypeEnum.sqlite:
            case config_1.DatabaseTypeEnum.betterSqlite3:
                await queryRunner.query(`DELETE FROM "feature_organization" WHERE "featureId" IN (SELECT "id" FROM "feature" WHERE "code" = ?)`, [this.feature.code]);
                await queryRunner.query(`DELETE FROM "feature" WHERE "code" = ?`, [this.feature.code]);
                break;
            case config_1.DatabaseTypeEnum.postgres:
                await queryRunner.query(`DELETE FROM "feature_organization" WHERE "featureId" IN (SELECT "id" FROM "feature" WHERE "code" = $1)`, [this.feature.code]);
    ...
    async postgresUpQueryRunner(queryRunner) {
         ...
         */
        await queryRunner.query(`INSERT INTO "feature" ("id", "name", "code", "description", "image", "link", "status", "icon")
			 SELECT gen_random_uuid(), $1, $2::varchar, $3, $4, $5, $6, $7
			 WHERE NOT EXISTS (SELECT 1 FROM "feature" WHERE "code" = $2::varchar)`, [name, code, description, image, link, status, icon]);
        /**
         ...
         */
        await queryRunner.query(`INSERT INTO "feature_organization" ("id", "tenantId", "featureId", "isEnabled")
    ...
    async sqliteUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "feature" ("id", "name", "code", "description", "image", "link", "status", "icon")
			 SELECT ?, ?, ?, ?, ?, ?, ?, ?
			 WHERE NOT EXISTS (SELECT 1 FROM "feature" WHERE "code" = ?)`, [(0, uuid_1.v4)(), name, code, description, image, link, status, icon, code]);
        /**
         ...
         */
        const rows = await queryRunner.query(`SELECT "tenant"."id" AS "tenantId", "feature"."id" AS "featureId"
			 FROM "tenant", "feature"
			 WHERE "feature"."code" = ?
			   AND "tenant"."deletedAt" IS NULL
			   AND NOT EXISTS (
        ...
        for (const row of rows ?? []) {
            await queryRunner.query(`INSERT INTO "feature_organization" ("id", "tenantId", "featureId", "isEnabled") VALUES (?, ?, ?, ?)`, [(0, uuid_1.v4)(), row.tenantId, row.featureId, 1]);
        }
    }
    /**
     * MySQL Up Migration
...
exports.SeedDocumentsFeature1790000004000 = SeedDocumentsFeature1790000004000;
//# sourceMappingURL=1790000004000-SeedDocumentsFeature.js.map