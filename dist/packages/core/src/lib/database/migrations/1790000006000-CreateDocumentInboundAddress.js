...
exports.CreateDocumentInboundAddress1790000006000 = void 0;
 ...
 */
class CreateDocumentInboundAddress1790000006000 {
    constructor() {
        this.name = 'CreateDocumentInboundAddress1790000006000';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "document_inbound_address" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "kind" character varying(16) NOT NULL DEFAULT 'PLATFORM', "token" character varying(128), "domain" character varying(255), "localPart" character varying(64), "address" character varying(320) NOT NULL, "domainStatus" character varying(16) NOT NULL DEFAULT 'PENDING', "domainVerificationToken" character varying(128), "domainVerifiedAt" TIMESTAMP, "domainLastCheckedAt" TIMESTAMP, "webhookSecretHash" character varying(64), "senderAllowlistRaw" text, "importBodyAsNote" boolean NOT NULL DEFAULT false, "lastMessageAt" TIMESTAMP, "messageCount" integer NOT NULL DEFAULT 0, CONSTRAINT "CHK_document_inbound_address_kind_shape" CHECK ((("kind" = 'PLATFORM' AND "token" IS NOT NULL AND "domain" IS NULL AND "localPart" IS NULL) OR ("kind" = 'CUSTOM_DOMAIN' AND "token" IS NULL AND "domain" IS NOT NULL AND "localPart" IS NOT NULL))), CONSTRAINT "PK_document_inbound_address_id" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_createdByUserId" ON "document_inbound_address" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_updatedByUserId" ON "document_inbound_address" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_deletedByUserId" ON "document_inbound_address" ("deletedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_isActive" ON "document_inbound_address" ("isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_isArchived" ON "document_inbound_address" ("isArchived") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_tenantId" ON "document_inbound_address" ("tenantId") `);
        await queryRunner.query(`CREATE INDEX "IDX_doc_inbound_addr_organizationId" ON "document_inbound_address" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_document_inbound_address_token" ON "document_inbound_address" ("token") `);
        await queryRunner.query(`CREATE INDEX "IDX_document_inbound_address_tenant_org" ON "document_inbound_address" ("tenantId", "organizationId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_document_inbound_address_address" ON "document_inbound_address" ("address") `);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" ADD CONSTRAINT "FK_doc_inbound_addr_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" ADD CONSTRAINT "FK_doc_inbound_addr_updatedByUserId" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" ADD CONSTRAINT "FK_doc_inbound_addr_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" ADD CONSTRAINT "FK_doc_inbound_addr_tenantId" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" ADD CONSTRAINT "FK_doc_inbound_addr_organizationId" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    /**
    ...
    async postgresDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE "document_inbound_address" DROP CONSTRAINT "FK_doc_inbound_addr_organizationId"`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" DROP CONSTRAINT "FK_doc_inbound_addr_tenantId"`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" DROP CONSTRAINT "FK_doc_inbound_addr_deletedByUserId"`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" DROP CONSTRAINT "FK_doc_inbound_addr_updatedByUserId"`);
        await queryRunner.query(`ALTER TABLE "document_inbound_address" DROP CONSTRAINT "FK_doc_inbound_addr_createdByUserId"`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`document_inbound_address\` DROP FOREIGN KEY \`FK_doc_inbound_addr_organizationId\``);
        await queryRunner.query(`ALTER TABLE \`document_inbound_address\` DROP FOREIGN KEY \`FK_doc_inbound_addr_tenantId\``);
        await queryRunner.query(`ALTER TABLE \`document_inbound_address\` DROP FOREIGN KEY \`FK_doc_inbound_addr_deletedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`document_inbound_address\` DROP FOREIGN KEY \`FK_doc_inbound_addr_updatedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`document_inbound_address\` DROP FOREIGN KEY \`FK_doc_inbound_addr_createdByUserId\``);
        await queryRunner.query(`DROP TABLE \`document_inbound_address\``);
    }
}
exports.CreateDocumentInboundAddress1790000006000 = CreateDocumentInboundAddress1790000006000;
//# sourceMappingURL=1790000006000-CreateDocumentInboundAddress.js.map