...
exports.CreateTimeOffLeaveManagement1790000011000 = void 0;
 ...
 */
class CreateTimeOffLeaveManagement1790000011000 {
    constructor() {
        this.name = 'CreateTimeOffLeaveManagement1790000011000';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        await queryRunner.query(`CREATE TABLE "official_holiday" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "name" character varying NOT NULL, "countryCode" character varying(2) NOT NULL, "date" date NOT NULL, "endDate" date, "isRecurring" boolean DEFAULT true, CONSTRAINT "PK_official_holiday_id" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_createdByUserId" ON "official_holiday" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_updatedByUserId" ON "official_holiday" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_deletedByUserId" ON "official_holiday" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_organizationId" ON "official_holiday" ("organizationId") `);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_name" ON "official_holiday" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_countryCode" ON "official_holiday" ("countryCode") `);
        await queryRunner.query(`CREATE INDEX "IDX_official_holiday_date" ON "official_holiday" ("date") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_official_holiday_unique" ON "official_holiday" ("tenantId", "organizationId", "countryCode", "date", "name") `);
        await queryRunner.query(`ALTER TABLE "official_holiday" ADD CONSTRAINT "FK_official_holiday_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "official_holiday" ADD CONSTRAINT "FK_official_holiday_updatedByUserId" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "official_holiday" ADD CONSTRAINT "FK_official_holiday_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "official_holiday" ADD CONSTRAINT "FK_official_holiday_tenantId" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "official_holiday" ADD CONSTRAINT "FK_official_holiday_organizationId" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`CREATE TABLE "time_off_balance" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "year" integer NOT NULL, "accrued" numeric(10,2) NOT NULL DEFAULT '0', "taken" numeric(10,2) NOT NULL DEFAULT '0', "carriedForward" numeric(10,2) NOT NULL DEFAULT '0', "carriedOut" numeric(10,2) NOT NULL DEFAULT '0', "remaining" numeric(10,2) NOT NULL DEFAULT '0', "employeeId" uuid NOT NULL, "policyId" uuid NOT NULL, CONSTRAINT "PK_time_off_balance_id" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_time_off_balance_createdByUserId" ON "time_off_balance" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_time_off_balance_updatedByUserId" ON "time_off_balance" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_time_off_balance_deletedByUserId" ON "time_off_balance" ("deletedByUserId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_time_off_balance_organizationId" ON "time_off_balance" ("organizationId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_time_off_balance_unique" ON "time_off_balance" ("tenantId", "organizationId", "employeeId", "policyId", "year") `);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_updatedByUserId" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_tenantId" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_organizationId" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_employeeId" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "time_off_balance" ADD CONSTRAINT "FK_time_off_balance_policyId" FOREIGN KEY ("policyId") REFERENCES "time_off_policy"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async mysqlDownQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`time_off_balance\` DROP FOREIGN KEY \`FK_time_off_balance_organizationId\``);
        await queryRunner.query(`ALTER TABLE \`time_off_balance\` DROP FOREIGN KEY \`FK_time_off_balance_tenantId\``);
        await queryRunner.query(`ALTER TABLE \`time_off_balance\` DROP FOREIGN KEY \`FK_time_off_balance_deletedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`time_off_balance\` DROP FOREIGN KEY \`FK_time_off_balance_updatedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`time_off_balance\` DROP FOREIGN KEY \`FK_time_off_balance_createdByUserId\``);
        await queryRunner.query(`DROP TABLE \`time_off_balance\``);
        await queryRunner.query(`ALTER TABLE \`official_holiday\` DROP FOREIGN KEY \`FK_official_holiday_organizationId\``);
        await queryRunner.query(`ALTER TABLE \`official_holiday\` DROP FOREIGN KEY \`FK_official_holiday_tenantId\``);
        await queryRunner.query(`ALTER TABLE \`official_holiday\` DROP FOREIGN KEY \`FK_official_holiday_deletedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`official_holiday\` DROP FOREIGN KEY \`FK_official_holiday_updatedByUserId\``);
        await queryRunner.query(`ALTER TABLE \`official_holiday\` DROP FOREIGN KEY \`FK_official_holiday_createdByUserId\``);
        await queryRunner.query(`DROP TABLE \`official_holiday\``);
    }
}
exports.CreateTimeOffLeaveManagement1790000011000 = CreateTimeOffLeaveManagement1790000011000;
//# sourceMappingURL=1790000011000-CreateTimeOffLeaveManagement.js.map