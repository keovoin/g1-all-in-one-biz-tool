...
exports.CreatePayrollTables1790000012000 = void 0;
 ...
 */
class CreatePayrollTables1790000012000 {
    constructor() {
        this.name = 'CreatePayrollTables1790000012000';
    }
    /**
     * Up Migration
     *
    ...
    async postgresUpQueryRunner(queryRunner) {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_payroll_run_approvedByUserId" ON "payroll_run" ("approvedByUserId") `);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_updatedByUserId" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_tenantId" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_organizationId" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "payroll_run" ADD CONSTRAINT "FK_payroll_run_approvedByUserId" FOREIGN KEY ("approvedByUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE TABLE "payroll_item" ("deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdByUserId" uuid, "updatedByUserId" uuid, "deletedByUserId" uuid, "id" uuid NOT NULL DEFAULT gen_random_uuid(), "isActive" boolean DEFAULT true, "isArchived" boolean DEFAULT false, "archivedAt" TIMESTAMP, "tenantId" uuid, "organizationId" uuid, "type" character varying NOT NULL, "category" character varying NOT NULL, "description" character varying, "amount" numeric(14,2) NOT NULL DEFAULT '0', "quantity" numeric(14,4), "unitPrice" numeric(14,2), "taxable" boolean NOT NULL DEFAULT true, "payrollRunId" uuid NOT NULL, "employeeId" uuid, CONSTRAINT "PK_payroll_item_id" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_payroll_item_createdByUserId" ON "payroll_item" ("createdByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_payroll_item_updatedByUserId" ON "payroll_item" ("updatedByUserId") `);
        await queryRunner.query(`CREATE INDEX "IDX_payroll_item_deletedByUserId" ON "payroll_item" ("deletedByUserId") `);
        ...
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_createdByUserId" FOREIGN KEY ("createdByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_updatedByUserId" FOREIGN KEY ("updatedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_deletedByUserId" FOREIGN KEY ("deletedByUserId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_tenantId" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_organizationId" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_payrollRunId" FOREIGN KEY ("payrollRunId") REFERENCES "payroll_run"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_item" ADD CONSTRAINT "FK_payroll_item_employeeId" FOREIGN KEY ("employeeId") REFERENCES "employee"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }
    /**
...
exports.CreatePayrollTables1790000012000 = CreatePayrollTables1790000012000;
//# sourceMappingURL=1790000012000-CreatePayrollTables.js.map