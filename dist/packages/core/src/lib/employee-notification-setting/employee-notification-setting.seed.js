...
exports.createRandomEmployeeNotificationSettings = exports.createDefaultEmployeeNotificationSettings = void 0;
 ...
 */
const generateRandomNotificationSettings = () => {
 ...
 */
const createDefaultEmployeeNotificationSettings = async (dataSource, tenant, organization, employees) => {
    ...
    const notificationSettings = employees.map((employee) => ({
        employee: employee,
        tenant: tenant,
...
exports.createDefaultEmployeeNotificationSettings = createDefaultEmployeeNotificationSettings;
/**
 ...
 * @returns A promise that resolves to an array of created EmployeeNotificationSetting entities.
 */
const createRandomEmployeeNotificationSettings = async (dataSource, tenants, tenantOrganizationsMap, organizationEmployeesMap) => {
    ...
    for (const tenant of tenants) {
        ...
        for (const organization of organizations) {
            ...
            const defaultSettings = generateRandomNotificationSettings();
            // Map employees to notification settings
            const settings = organizationEmployees.map((employee) => ({
                employee: employee,
                tenant: tenant,
                organization: organization,
                ...defaultSettings
...
exports.createRandomEmployeeNotificationSettings = createRandomEmployeeNotificationSettings;
/**
 ...
 */
const insertEmployeeNotificationSettings = async (dataSource, settings) => {
    ...
    try {
        ...
        const repository = dataSource.getRepository(employee_notification_setting_entity_1.EmployeeNotificationSetting);
...
//# sourceMappingURL=employee-notification-setting.seed.js.map