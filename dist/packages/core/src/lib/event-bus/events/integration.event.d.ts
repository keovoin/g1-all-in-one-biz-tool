 ...
 */
export declare class IntegrationEvent extends BaseEntityEvent<IntegrationTenant, IntegrationInputTypes> {
    /**
     ...
     */
    constructor(ctx: RequestContext, entity: IntegrationTenant, type: BaseEntityEventType, input?: IntegrationInputTypes);
}
export {};
