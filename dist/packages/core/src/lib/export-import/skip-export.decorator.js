...
function SkipExport() {
    return (target) => {
        Reflect.defineMetadata(exports.SKIP_EXPORT_METADATA, true, target);
    };
}
/**
 ...
 */
function skipExport(...entities) {
    for (const entity of entities) {
        if ((0, utils_1.isFunction)(entity)) {
            Reflect.defineMetadata(exports.SKIP_EXPORT_METADATA, true, entity);
        }
    }
}
/**
 ...
 */
function isExportSkipped(entity) {
    return (0, utils_1.isFunction)(entity) && Reflect.getOwnMetadata(exports.SKIP_EXPORT_METADATA, entity) === true;
}
//# sourceMappingURL=skip-export.decorator.js.map