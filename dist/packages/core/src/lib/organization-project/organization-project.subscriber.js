...
let OrganizationProjectSubscriber = class OrganizationProjectSubscriber extends base_entity_event_subscriber_1.BaseEntityEventSubscriber {
    /**
    ...
    async updateProjectMembersCount(entity, em) {
        try {
            ...
            const dbType = (0, config_1.getConfig)().dbConnectionOptions.type;
            ...
            query = (0, utils_1.replacePlaceholders)(query, dbType);
            updateQuery = (0, utils_1.replacePlaceholders)(updateQuery, dbType);
            let totalMembers = 0;
            // Handle TypeORM specific logic - check both ORM type and instanceof
            if (ormType === utils_1.MultiORMEnum.TypeORM && em instanceof entity_event_subscriber_types_1.TypeOrmEntityManager) {
            ...
            else if (ormType === utils_1.MultiORMEnum.MikroORM && em instanceof entity_event_subscriber_types_1.MikroOrmEntityManager) {
...
exports.OrganizationProjectSubscriber = OrganizationProjectSubscriber;
exports.OrganizationProjectSubscriber = OrganizationProjectSubscriber = tslib_1.__decorate([
