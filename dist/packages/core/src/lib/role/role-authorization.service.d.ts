 ...
 */
export declare class RoleAuthorizationService {
    ...
    constructor(typeOrmRoleRepository: TypeOrmRoleRepository, mikroOrmRoleRepository: MikroOrmRoleRepository, cacheManager: Cache);
    /**
     ...
     */
    getAuthorizationState(roleId: ID): Promise<IRoleAuthorizationState | null>;
    /**
     ...
     */
    attachAuthorizationState<T extends IAuthenticatedUser>(user: T): Promise<T>;
    /**
     ...
     */
    private findRoleWithPermissions;
}
