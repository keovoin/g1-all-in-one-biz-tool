 ...
 */
export declare const ORGANIZATION_POLICY_TARGET_METADATA = "organizationPolicyTarget";
/**
 ...
 */
export declare const OrganizationPolicyTarget: (entity: Type<unknown>, param?: string) => import("@nestjs/common").CustomDecorator<string>;
