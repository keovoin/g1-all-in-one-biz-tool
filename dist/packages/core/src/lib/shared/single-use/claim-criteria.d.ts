 ...
 */
export declare const passwordResetConsumeWhere: (id: ID) => {
    id: string;
};
/**
 ...
 */
export declare const magicCodeClaimWhere: (email: string, code: string) => {
    email: string;
    code: string;
};
/**
 ...
 */
export declare const emailVerificationClaimWhere: (id: ID, code: string, tenantId: ID, now: Date) => {
    id: string;
    code: string;
    tenantId: string;
    codeExpireAt: import("typeorm").FindOperator<Date>;
};
/**
 ...
 */
export declare const emailVerificationClaimWhereMikroOrm: (id: ID, code: string, tenantId: ID, now: Date) => {
    id: string;
    code: string;
    tenantId: string;
    codeExpireAt: {
 ...
 */
export declare const inviteClaimWhere: (id: ID) => {
    id: string;
 ...
 */
export declare const inviteRejectWhere: (id: ID) => {
    id: string;
    status: InviteStatusEnum;
};
/**
 ...
 */
export declare const inviteReleaseWhere: (id: ID) => {
    id: string;
    status: InviteStatusEnum;
};
