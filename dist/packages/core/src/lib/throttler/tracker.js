...
exports.IPV6_TRACKER_PREFIX_GROUPS = exports.UNRESOLVED_THROTTLER_TRACKER = void 0;
exports.normalizeTrackerIp = normalizeTrackerIp;
exports.resolveThrottlerTracker = resolveThrottlerTracker;
 ...
 */
exports.UNRESOLVED_THROTTLER_TRACKER = 'unresolved-client';
/**
 ...
 */
exports.IPV6_TRACKER_PREFIX_GROUPS = 4;
/**
 ...
 */
function normalizeTrackerIp(value) {
    ...
    const withoutPort = (0, node_net_1.isIP)(unbracketed) === 0 && unbracketed.split(':').length === 2 ? unbracketed.split(':')[0] : unbracketed;
    const family = (0, node_net_1.isIP)(withoutPort);
    if (family === 4) {
        return withoutPort;
    }
    if (family !== 6) {
    ...
    const prefix = groups
        .slice(0, exports.IPV6_TRACKER_PREFIX_GROUPS)
        .map((group) => group.toString(16))
        .join(':');
    return `${prefix}::/${exports.IPV6_TRACKER_PREFIX_GROUPS * 16}`;
}
/**
 ...
 */
function resolveThrottlerTracker(req, options) {
    ...
    return normalizeTrackerIp(req?.ip) ?? exports.UNRESOLVED_THROTTLER_TRACKER;
}
