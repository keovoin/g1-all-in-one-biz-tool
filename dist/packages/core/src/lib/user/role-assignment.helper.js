...
exports.assertRoleAssignmentAllowed = assertRoleAssignmentAllowed;
 ...
 */
function assertRoleAssignmentAllowed(roleName, canEditSuperAdmin) {
    if (!roleName) {
        throw new common_1.BadRequestException('The specified role does not exist in this tenant.');
    }
    if (roleName === contracts_1.RolesEnum.SUPER_ADMIN && !canEditSuperAdmin) {
        throw new common_1.ForbiddenException('Only a super admin may assign the super admin role.');
    }
}
//# sourceMappingURL=role-assignment.helper.js.map