...
import { PLUGIN_OPTIONS, PLUGIN_DEFINITION } from '../plugin-ui.types';
...
export class DynamicPluginLoaderService {
    ...
    _loaded$ = new BehaviorSubject(new Set());
    /**
     ...
     */
    async _loadModulePlugin(definition) {
        const resolvedModule = definition.module ?? (definition.loadModule ? await definition.loadModule() : undefined);
        if (!resolvedModule) {
     ...
     */
    async _loadDeclarativePlugin(definition) {
        const options = definition.options ?? {};
        const childInjector = Injector.create({
            providers: [
                { provide: PLUGIN_OPTIONS, useValue: options },
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DynamicPluginLoaderService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DynamicPluginLoaderService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DynamicPluginLoaderService, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
//# sourceMappingURL=dynamic-plugin-loader.service.js.map