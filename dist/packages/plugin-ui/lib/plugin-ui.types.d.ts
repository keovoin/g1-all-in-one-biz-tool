 ...
 */
export declare const PLUGIN_UI_CONFIG: InjectionToken<PluginUiConfig>;
/**
 ...
 */
export declare const PLUGIN_OPTIONS: InjectionToken<Record<string, unknown>>;
/**
 ...
 */
export declare const PLUGIN_DEFINITION: InjectionToken<PluginUiDefinition>;
/**
 ...
 * ```
 */
export declare const PLUGIN_ACTIVATION_PREDICATE: InjectionToken<(definition: PluginUiDefinition) => boolean | Promise<boolean>>;
/**
 ...
 */
export declare function orderPluginsByDependencies(plugins: PluginUiDefinition[]): PluginUiDefinition[];
/**
 ...
 */
export declare function flattenPlugins(plugins: PluginUiDefinition[]): PluginUiDefinition[];
/**
 * Collects all plugin IDs from a plugin tree (including nested plugins).
 */
export declare function collectPluginIds(plugins: PluginUiDefinition[]): string[];
/**
 * Checks whether a specific plugin is present in the configuration.
 */
export declare function isPluginActive(config: PluginUiConfig, pluginId: string): boolean;
/**
 * Returns all plugins whose `location` matches the given value.
 */
export declare function getPluginsByLocation(config: PluginUiConfig, location: string): PluginUiDefinition[];
/**
 * Returns the Angular module classes for all plugins that match a given location.
 */
export declare function getPluginModulesByLocation(config: PluginUiConfig, location: string): Type<any>[];
/**
 ...
 */
export declare function getPluginDefinition(config: PluginUiConfig, pluginId: string): PluginUiDefinition | undefined;
/**
 * Returns the plugin definition that provides the given module class.
 */
export declare function getPluginDefinitionByModule(config: PluginUiConfig, moduleType: Type<any>): PluginUiDefinition | undefined;
