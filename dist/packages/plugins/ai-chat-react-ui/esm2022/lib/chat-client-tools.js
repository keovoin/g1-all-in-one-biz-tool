...
export const CLIENT_TOOL_NAMES = ['list_pages', 'open_page', 'read_page', 'fill_form', 'submit_form'];
export function isClientTool(toolName) {
    return CLIENT_TOOL_NAMES.includes(toolName);
}
/**
 ...
 */
export async function executeClientTool(injector, toolName, input) {
    switch (toolName) {
        case 'list_pages': {
...
//# sourceMappingURL=chat-client-tools.js.map