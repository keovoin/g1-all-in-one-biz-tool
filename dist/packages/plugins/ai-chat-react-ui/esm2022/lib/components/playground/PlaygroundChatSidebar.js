...
export function PlaygroundChatSidebar() {
    ...
    return (_jsxs("div", { style: containerStyle, children: [_jsx("style", { children: `
				...
				${chatMarkdownCss}
			` }), _jsxs("div", { style: headerStyle, children: [_jsx("span", { style: titleStyle, children: "AI Chat" }), messages.length > 0 && (_jsxs("button", { type: "button", style: newChatBtnStyle, onClick: handleNewChat, children: [_jsx("svg", { width: "12", height: "12", viewBox: "0 0 16 16", fill: "currentColor", children: _jsx("path", { d: "M8 2.5a.5.5 0 01.5.5v4.5H13a.5.5 0 010 1H8.5V13a.5.5 0 01-1 0V8.5H3a.5.5 0 010-1h4.5V3a.5.5 0 01.5-.5z" }) }), "New Chat"] }))] }), _jsx(PlaygroundChatPanel, { messages: messages, onSend: handleSend, status: status, error: error ? error.message || 'Something went wrong.' : undefined, onRetry: () => void regenerate() })] }));
}
//# sourceMappingURL=PlaygroundChatSidebar.js.map