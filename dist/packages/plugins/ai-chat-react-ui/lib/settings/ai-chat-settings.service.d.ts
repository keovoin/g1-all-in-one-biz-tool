...
import { IAiChatConfig, IAiChatModelCatalogue, IAiProviderCredential, IAiProviderCredentialCreateInput, IAiProviderCredentialUpdateInput, ID, IPagination } from '@gauzy/contracts';
 ...
 */
export declare class AiChatSettingsService {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<AiChatSettingsService, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<AiChatSettingsService>;
}
