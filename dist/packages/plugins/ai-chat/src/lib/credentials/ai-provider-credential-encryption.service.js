"use strict";
var AiProviderCredentialEncryptionService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AiProviderCredentialEncryptionService = exports.AI_CREDENTIAL_ENCRYPTION_ALGORITHM = void 0;
 ...
 */
exports.AI_CREDENTIAL_ENCRYPTION_ALGORITHM = 'aes-256-gcm';
/**
 ...
 */
let AiProviderCredentialEncryptionService = AiProviderCredentialEncryptionService_1 = class AiProviderCredentialEncryptionService {
    constructor() {
        this.logger = new common_1.Logger(AiProviderCredentialEncryptionService_1.name);
        this.algorithm = exports.AI_CREDENTIAL_ENCRYPTION_ALGORITHM;
        /**
        ...
        if (process.env.ENCRYPTION_KEY) {
            ...
            this.logger.warn('ENCRYPTION_KEY is not set. Generating a temporary key for this session. ' +
    ...
    assertUsableKey() {
        if (this.keyError) {
            throw new common_1.ServiceUnavailableException(this.keyError);
        }
    }
    /**
...
exports.AiProviderCredentialEncryptionService = AiProviderCredentialEncryptionService;
exports.AiProviderCredentialEncryptionService = AiProviderCredentialEncryptionService = AiProviderCredentialEncryptionService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [])
], AiProviderCredentialEncryptionService);
//# sourceMappingURL=ai-provider-credential-encryption.service.js.map