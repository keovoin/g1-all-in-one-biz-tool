...
exports.elevenLabsProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.ELEVENLABS;
...
const transcribeAudio = async (audio, mimeType, credentials, options) => (0, plugin_ai_chat_1.transcribeMultipart)({
    url: `${(0, plugin_ai_chat_1.trimTrailingSlash)(credentials.baseUrl || DEFAULT_BASE_URL)}/speech-to-text`,
    audio,
    mimeType,
    fields: {
 ...
 */
exports.elevenLabsProviderDefinition = {
    id: PROVIDER_ID,
    label: 'ElevenLabs',
    ...
    async createModel(_modelId, _credentials) {
        throw new Error('ElevenLabs is a speech-to-text provider and cannot serve chat — select another provider for chat.');
    }
};
//# sourceMappingURL=ai-provider-elevenlabs.provider.js.map