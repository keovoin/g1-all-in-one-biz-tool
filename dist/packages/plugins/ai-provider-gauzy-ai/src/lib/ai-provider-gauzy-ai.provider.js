...
exports.gauzyAiProviderDefinition = void 0;
const contracts_1 = require("@gauzy/contracts");
/** Stable provider id used by the registry, the UI and BYOK credentials. */
const PROVIDER_ID = contracts_1.AiProviderEnum.GAUZY_AI;
/**
 ...
 */
exports.gauzyAiProviderDefinition = {
    id: PROVIDER_ID,
    label: 'Gauzy AI',
    /**
    ...
    async createModel(_modelId, _credentials) {
        throw new Error('Chat via Gauzy AI is not implemented yet — configure another provider. See @gauzy/plugin-ai-provider-gauzy-ai README.');
    }
};
//# sourceMappingURL=ai-provider-gauzy-ai.provider.js.map