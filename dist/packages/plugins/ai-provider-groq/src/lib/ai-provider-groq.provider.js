...
exports.groqProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.GROQ;
...
const listCatalogue = async (credentials) => (0, plugin_ai_chat_1.keyedCatalogue)({
    ...
    load: async (resolved) => {
        const body = await (0, plugin_ai_chat_1.fetchCatalogueJson)(`${DEFAULT_BASE_URL}/models`, {
 ...
 */
exports.groqProviderDefinition = {
    id: PROVIDER_ID,
    label: 'Groq',
...
//# sourceMappingURL=ai-provider-groq.provider.js.map