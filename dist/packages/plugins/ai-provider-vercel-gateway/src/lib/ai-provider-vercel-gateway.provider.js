...
exports.vercelGatewayProviderDefinition = void 0;
...
const PROVIDER_ID = contracts_1.AiProviderEnum.VERCEL_GATEWAY;
/**
...
const listCatalogue = async () => (0, plugin_ai_chat_1.publicCatalogue)({
    ...
    load: async () => {
        const body = await (0, plugin_ai_chat_1.fetchCatalogueJson)('https://ai-gateway.vercel.sh/v1/models');
        return (body.data ?? [])
 ...
 */
exports.vercelGatewayProviderDefinition = {
    id: PROVIDER_ID,
    ...
    async createModel(modelId, credentials) {
        const { createGateway } = await (0, plugin_ai_chat_1.importEsm)('@ai-sdk/gateway');
...
//# sourceMappingURL=ai-provider-vercel-gateway.provider.js.map