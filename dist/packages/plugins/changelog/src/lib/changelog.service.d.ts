...
export declare class ChangelogService extends CrudService<Changelog> {
    /**
     ...
     */
    private static readonly MAX_PUBLIC_ITEMS;
    constructor(typeOrmChangelogRepository: TypeOrmChangelogRepository, mikroOrmChangelogRepository: MikroOrmChangelogRepository);
    /**
     ...
     * @returns
     */
    findAllChangelogs(where?: FindOptionsWhere<Changelog>): Promise<IPagination<IChangelog>>;
}
