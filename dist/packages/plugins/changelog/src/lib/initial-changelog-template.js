...
exports.INITIAL_CHANGELOG_TEMPLATE = void 0;
/**
 ...
 */
exports.INITIAL_CHANGELOG_TEMPLATE = [
    {
        icon: 'message-circle-outline',
        title: 'Meet your AI Assistant',
        date: new Date('2026-08-05T00:00:00.000Z'),
        content: 'Chat with an AI agent that knows your workspace: it can navigate pages, read data, fill forms and answer questions — with voice dictation and file attachments built in.',
        isFeature: false,
    ...
    },
    {
        ...
        isFeature: false,
        content: 'Upload, organize and share company files and wiki pages — and attach any document to the AI chat to discuss it.',
    ...
    },
    {
        ...
        isFeature: false,
        content: 'Build your own dashboards: drag & drop widgets from the palette, configure each one, and switch between named layouts.',
    ...
    },
    {
        ...
        isFeature: false,
        content: 'Redesigned navigation, denser tables, refreshed dark themes and a full-height AI chat column across the whole app.',
    ...
    },
    {
        ...
        date: new Date('2026-08-05T00:00:00.000Z'),
        isFeature: true,
        content: 'An embedded AI assistant that knows your workspace: chat, dictate, attach documents and let it do the clicking for you.',
        learnMoreUrl: 'https://docs.gauzy.co/features/ai-agent-chat',
...
//# sourceMappingURL=initial-changelog-template.js.map