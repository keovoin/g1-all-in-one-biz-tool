...
import { preferredUiCanMatch, standardDashboardGuard } from '@gauzy/ui-core/core';
 ...
 */
export const DASHBOARD_TIME_TRACKING_ROUTE = {
    ...
    loadChildren: () => import('./dashboard-time-track-angular-ui.module').then((m) => m.DashboardTimeTrackAngularUiModule)
};
//# sourceMappingURL=dashboard-time-track-angular-ui.constants.js.map