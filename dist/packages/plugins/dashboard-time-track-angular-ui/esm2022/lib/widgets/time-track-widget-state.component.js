...
export class TimeTrackWidgetStateComponent {
    constructor() {
         ...
         */
        this.emptyMessageKey = input('SM_TABLE.NO_DATA_MESSAGE', ...(ngDevMode ? [{ debugName: "emptyMessageKey" }] : []));
...
//# sourceMappingURL=time-track-widget-state.component.js.map