...
import { DASHBOARD_TIME_TRACK_PATH, DASHBOARD_TIME_TRACK_ROUTE, LEGACY_DASHBOARD_TIME_TRACK_REDIRECT_ROUTE } from './dashboard-time-track-react-ui.routes';
...
export const DashboardTimeTrackReactUiPlugin = defineDeclarativePlugin('dashboard-time-track-react-ui', {
    ...
    // ── Routes ───────────────────────────────────────────────────
    routes: [DASHBOARD_TIME_TRACK_ROUTE, LEGACY_DASHBOARD_TIME_TRACK_REDIRECT_ROUTE],
    ...
    tabs: [
        {
            ...
            tabTitle: (_i18n) => _i18n.getTranslation('TIMESHEET.TIME_TRACKING'),
...
//# sourceMappingURL=dashboard-time-track-react-ui.plugin.js.map