...
import { BookmarkQueryParamsResolver, preferredUiCanMatch, standardDashboardGuard } from '@gauzy/ui-core/core';
 ...
 */
export const DASHBOARD_TIME_TRACK_ROUTE = {
 ...
 */
export const LEGACY_DASHBOARD_TIME_TRACK_REDIRECT_ROUTE = {
    location: 'dashboard-sections',
    path: LEGACY_DASHBOARD_TIME_TRACK_PATH,
    redirectTo: `/pages/dashboard/${DASHBOARD_TIME_TRACK_PATH}`,
    route: { pathMatch: 'full' }
};
//# sourceMappingURL=dashboard-time-track-react-ui.routes.js.map