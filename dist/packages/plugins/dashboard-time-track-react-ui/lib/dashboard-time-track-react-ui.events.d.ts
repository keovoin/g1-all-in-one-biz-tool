 ...
 * ```
 */
export declare const DashboardRefreshedEvent: import("@gauzy/plugin-ui").PluginEventContract<DashboardRefreshedPayload>;
/**
 ...
 */
export declare const WidgetVisibilityChangedEvent: import("@gauzy/plugin-ui").PluginEventContract<WidgetVisibilityPayload>;
