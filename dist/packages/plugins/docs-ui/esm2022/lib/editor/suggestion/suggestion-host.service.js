...
export class SuggestionHostService {
    ...
    update(props, ariaLabelKey) {
        if (!this.list)
            return;
        this.list.onSelect = (item) => props.command(item);
        this.list.setItems(props.items ?? [], this.translate.instant('DOCS.EDITOR.SLASH.NO_RESULTS'), this.translate.instant(ariaLabelKey));
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SuggestionHostService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SuggestionHostService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SuggestionHostService, decorators: [{
            type: Injectable
        }] });
//# sourceMappingURL=suggestion-host.service.js.map