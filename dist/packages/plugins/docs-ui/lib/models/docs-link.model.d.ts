...
export declare const DOCS_LINK_ENTITIES: IDocsLinkEntityDescriptor[];
/** Descriptor lookup; `undefined` for entities outside the picker registry. */
export declare function findLinkEntityDescriptor(entity: BaseEntityEnum): IDocsLinkEntityDescriptor | undefined;
