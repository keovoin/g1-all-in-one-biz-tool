 ...
 */
export declare const DOCS_SAVED_VIEW_EXCLUDED_PARAMS: readonly ["id", "folder", "page", "upload", "newPage"];
/**
 ...
 */
export declare const DOCS_SAVED_VIEW_PARAMS: readonly ["q", "searchIn", "preset", "kind", "status", "knowledge", "source", "categories", "tags", "createdFrom", "createdTo", "updatedFrom", "updatedTo", "sort", "pageSize", "view"];
