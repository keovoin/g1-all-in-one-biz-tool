 ...
 */
export declare const DOCS_SHARE_ACCESS_LEVELS: DocumentShareAccessEnum[];
/** Backend `code` values the share endpoints can return (spec 03 §6). */
export declare const DOCS_SHARE_ERROR_CODES: {
    /** Both or neither of employee/team supplied. */
    readonly TARGET: "DOCS_SHARE_TARGET";
    /** The document is `ORGANIZATION`-visible — shares are meaningless there. */
    readonly NOT_PRIVATE: "DOCS_SHARE_NOT_PRIVATE";
};
