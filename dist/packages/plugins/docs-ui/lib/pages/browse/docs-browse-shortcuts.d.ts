 ...
 * focus.
 */
export declare const DOCS_BROWSE_SHORTCUT_SKIP_SELECTOR: string;
/**
 ...
 */
export declare const DOCS_BROWSE_OVERLAY_SELECTOR = "nb-dialog-container, nb-context-menu, .docs-bulk-popover";
/**
 ...
 */
export declare const DOCS_SEARCH_INPUT_ID = "docs-filter-search";
/**
 * Maps a raw keydown to the browse action it requests, or `null` when the page
 * must keep its hands off the event.
 */
export declare function docsBrowseShortcutOf(event: KeyboardEvent): DocsBrowseShortcut | null;
