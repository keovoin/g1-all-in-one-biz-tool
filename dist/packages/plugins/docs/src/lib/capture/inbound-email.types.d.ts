...
export declare const DOCS_INBOUND_EMAIL_ADAPTER = "DOCS_INBOUND_EMAIL_ADAPTER";
/**
...
export declare const DOCS_INBOUND_ADDRESS_RESOLVER = "DOCS_INBOUND_ADDRESS_RESOLVER";
/**
