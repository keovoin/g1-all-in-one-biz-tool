 ...
 */
export declare const getDocsConfig: () => IDocsConfig;
/**
 ...
 */
export declare const docsRateLimitTracker: (req: Record<string, any>) => string;
/**
 ...
 */
export declare const docsRateLimit: (limit: number) => {
    default: {
        limit: number;
        ttl: number;
 ...
 */
export declare const isDocsQueueEnabled: () => boolean;
/**
 ...
 */
export declare const isDocsQueueWorkerEnabled: () => boolean;
