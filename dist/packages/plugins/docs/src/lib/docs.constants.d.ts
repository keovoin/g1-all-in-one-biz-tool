 ...
 */
export declare const DOCS_FILE_VIA_UPLOAD = "DOCS_FILE_VIA_UPLOAD";
export declare const DOCS_PARENT_NOT_CONTAINER = "DOCS_PARENT_NOT_CONTAINER";
export declare const DOCS_CONTENT_JSON_REQUIRED = "DOCS_CONTENT_JSON_REQUIRED";
export declare const DOCS_CONTENT_CONFLICT = "DOCS_CONTENT_CONFLICT";
export declare const DOCS_LOCKED = "DOCS_LOCKED";
export declare const DOCS_EXTRACTED_TEXT_EDITED = "DOCS_EXTRACTED_TEXT_EDITED";
export declare const DOCS_TREE_CYCLE = "DOCS_TREE_CYCLE";
export declare const DOCS_REORDER_MIXED_PARENTS = "DOCS_REORDER_MIXED_PARENTS";
export declare const DOCS_DELETE_REQUIRES_ARCHIVE = "DOCS_DELETE_REQUIRES_ARCHIVE";
export declare const DOCS_NOT_A_FILE = "DOCS_NOT_A_FILE";
export declare const DOCS_NOT_A_PAGE = "DOCS_NOT_A_PAGE";
export declare const DOCS_NOT_READY = "DOCS_NOT_READY";
export declare const DOCS_REVIEW_NOT_PENDING = "DOCS_REVIEW_NOT_PENDING";
export declare const DOCS_QUERY_TOO_SHORT = "DOCS_QUERY_TOO_SHORT";
export declare const DOCS_SOURCE_RESERVED = "DOCS_SOURCE_RESERVED";
export declare const DOCS_FILE_TOO_LARGE = "DOCS_FILE_TOO_LARGE";
export declare const DOCS_FILE_TYPE_REJECTED = "DOCS_FILE_TYPE_REJECTED";
export declare const DOCS_CATEGORY_EXISTS = "DOCS_CATEGORY_EXISTS";
export declare const DOCS_CATEGORY_SYSTEM = "DOCS_CATEGORY_SYSTEM";
export declare const DOCS_SHARE_TARGET = "DOCS_SHARE_TARGET";
export declare const DOCS_SHARE_NOT_PRIVATE = "DOCS_SHARE_NOT_PRIVATE";
export declare const DOCS_BULK_ACTION_UNSUPPORTED = "DOCS_BULK_ACTION_UNSUPPORTED";
export declare const DOCS_NOT_INDEXABLE = "DOCS_NOT_INDEXABLE";
/** A share row for the same (document, employee|team) target already exists. */
export declare const DOCS_SHARE_EXISTS = "DOCS_SHARE_EXISTS";
/** The caller is neither the document's creator nor a `DOCS_MANAGE` holder. */
export declare const DOCS_SHARE_FORBIDDEN = "DOCS_SHARE_FORBIDDEN";
/** The caller may read the document but holds no write right on it (§3.4 ownership / `EDIT` share). */
export declare const DOCS_WRITE_FORBIDDEN = "DOCS_WRITE_FORBIDDEN";
/** No organization scope could be resolved for the request (neither payload nor request context). */
export declare const DOCS_ORGANIZATION_REQUIRED = "DOCS_ORGANIZATION_REQUIRED";
/** A `subtree` delete was requested while some descendants are still live (not archived). */
export declare const DOCS_SUBTREE_NOT_ARCHIVED = "DOCS_SUBTREE_NOT_ARCHIVED";
/** A bulk `MOVE` was requested without an explicit `parentId` (`null` = root is an opt-in). */
export declare const DOCS_BULK_MOVE_PARENT_REQUIRED = "DOCS_BULK_MOVE_PARENT_REQUIRED";
/** The organization storage quota would be exceeded by this upload. */
export declare const DOCS_QUOTA_EXCEEDED = "DOCS_QUOTA_EXCEEDED";
/** The inbound-email webhook is not enabled in this deployment. */
export declare const DOCS_INBOUND_DISABLED = "DOCS_INBOUND_DISABLED";
/** The inbound-email webhook signature did not verify. */
export declare const DOCS_INBOUND_SIGNATURE_INVALID = "DOCS_INBOUND_SIGNATURE_INVALID";
/** No armed capture address matches the recipient (unknown, inactive, or domain unverified). */
export declare const DOCS_INBOUND_UNKNOWN_RECIPIENT = "DOCS_INBOUND_UNKNOWN_RECIPIENT";
/** The inbound message exceeded the configured per-message size cap. */
export declare const DOCS_INBOUND_TOO_LARGE = "DOCS_INBOUND_TOO_LARGE";
/** The sender is not on the address's allowlist (spec 07 §17.2). */
export declare const DOCS_INBOUND_SENDER_NOT_ALLOWED = "DOCS_INBOUND_SENDER_NOT_ALLOWED";
/** The inbound message carried no importable attachment. */
export declare const DOCS_INBOUND_NO_ATTACHMENTS = "DOCS_INBOUND_NO_ATTACHMENTS";
/** The submitted `contentJson` is not a schema-valid TipTap document (`08` §6.1). */
export declare const DOCS_CONTENT_SCHEMA_INVALID = "DOCS_CONTENT_SCHEMA_INVALID";
/** The submitted `contentBinary` exceeds `GAUZY_DOCS_MAX_BINARY_BYTES` (`10` §7.1 P6). */
export declare const DOCS_CONTENT_BINARY_TOO_LARGE = "DOCS_CONTENT_BINARY_TOO_LARGE";
/**
 * Environment variable keys read by `docs.config.ts`.
 */
export declare const ENV_GAUZY_DOCS_MAX_FILE_SIZE = "GAUZY_DOCS_MAX_FILE_SIZE";
export declare const ENV_GAUZY_DOCS_MAX_BINARY_BYTES = "GAUZY_DOCS_MAX_BINARY_BYTES";
export declare const ENV_GAUZY_DOCS_AI_ENABLED = "GAUZY_DOCS_AI_ENABLED";
export declare const ENV_GAUZY_DOCS_EMBEDDING_MODEL = "GAUZY_DOCS_EMBEDDING_MODEL";
export declare const ENV_GAUZY_DOCS_CLASSIFY_MODEL = "GAUZY_DOCS_CLASSIFY_MODEL";
export declare const ENV_GAUZY_DOCS_VERSION_DEBOUNCE_MINUTES = "GAUZY_DOCS_VERSION_DEBOUNCE_MINUTES";
export declare const ENV_GAUZY_DOCS_QUEUE_CONCURRENCY = "GAUZY_DOCS_QUEUE_CONCURRENCY";
/**
 ...
 */
export declare const ENV_GAUZY_DOCS_QUEUE_ENABLED = "GAUZY_DOCS_QUEUE_ENABLED";
/**
 ...
 */
export declare const ENV_GAUZY_DOCS_QUEUE_WORKER_ENABLED = "GAUZY_DOCS_QUEUE_WORKER_ENABLED";
export declare const ENV_GAUZY_DOCS_MAX_EXTRACTED_CHARS = "GAUZY_DOCS_MAX_EXTRACTED_CHARS";
export declare const ENV_GAUZY_DOCS_STUCK_THRESHOLD_MINUTES = "GAUZY_DOCS_STUCK_THRESHOLD_MINUTES";
export declare const ENV_GAUZY_DOCS_EMBEDDING_DIMS = "GAUZY_DOCS_EMBEDDING_DIMS";
export declare const ENV_GAUZY_DOCS_CHUNK_TOKENS = "GAUZY_DOCS_CHUNK_TOKENS";
export declare const ENV_GAUZY_DOCS_CHUNK_OVERLAP_TOKENS = "GAUZY_DOCS_CHUNK_OVERLAP_TOKENS";
export declare const ENV_GAUZY_DOCS_CLASSIFY_SAMPLE_CHARS = "GAUZY_DOCS_CLASSIFY_SAMPLE_CHARS";
export declare const ENV_GAUZY_DOCS_EMBED_BATCH_SIZE = "GAUZY_DOCS_EMBED_BATCH_SIZE";
export declare const ENV_GAUZY_DOCS_RETRIEVAL_TOPK_MAX = "GAUZY_DOCS_RETRIEVAL_TOPK_MAX";
export declare const ENV_GAUZY_DOCS_AUTO_REINDEX_ON_MODEL_CHANGE = "GAUZY_DOCS_AUTO_REINDEX_ON_MODEL_CHANGE";
export declare const ENV_GAUZY_DOCS_VECTOR_STORE = "GAUZY_DOCS_VECTOR_STORE";
export declare const ENV_GAUZY_DOCS_ORG_QUOTA_BYTES = "GAUZY_DOCS_ORG_QUOTA_BYTES";
export declare const ENV_GAUZY_DOCS_RETRIEVAL_LOG_ENABLED = "GAUZY_DOCS_RETRIEVAL_LOG_ENABLED";
/**
 ...
 */
export declare const ENV_GAUZY_DOCS_OCR_ENABLED = "GAUZY_DOCS_OCR_ENABLED";
/** Hard cap on OCR'd pages per document — the cost fuse of the OCR path. */
export declare const ENV_GAUZY_DOCS_OCR_MAX_PAGES = "GAUZY_DOCS_OCR_MAX_PAGES";
/**
 ...
 */
export declare const ENV_GAUZY_DOCS_UPLOAD_RATE_LIMIT = "GAUZY_DOCS_UPLOAD_RATE_LIMIT";
export declare const ENV_GAUZY_DOCS_SEARCH_RATE_LIMIT = "GAUZY_DOCS_SEARCH_RATE_LIMIT";
export declare const ENV_GAUZY_DOCS_ADMIN_OPS_RATE_LIMIT = "GAUZY_DOCS_ADMIN_OPS_RATE_LIMIT";
export declare const ENV_GAUZY_DOCS_INBOUND_EMAIL_ENABLED = "GAUZY_DOCS_INBOUND_EMAIL_ENABLED";
export declare const ENV_GAUZY_DOCS_INBOUND_WEBHOOK_SECRET = "GAUZY_DOCS_INBOUND_WEBHOOK_SECRET";
export declare const ENV_GAUZY_DOCS_INBOUND_MAX_MESSAGE_BYTES = "GAUZY_DOCS_INBOUND_MAX_MESSAGE_BYTES";
export declare const ENV_GAUZY_DOCS_INBOUND_DOMAIN = "GAUZY_DOCS_INBOUND_DOMAIN";
/**
 * Defaults for the environment variables above.
 */
export declare const DEFAULT_DOCS_MAX_FILE_SIZE = 52428800;
export declare const DEFAULT_DOCS_MAX_BINARY_BYTES = 10485760;
export declare const DEFAULT_DOCS_EMBEDDING_MODEL = "text-embedding-3-small";
export declare const DEFAULT_DOCS_VERSION_DEBOUNCE_MINUTES = 10;
export declare const DEFAULT_DOCS_QUEUE_CONCURRENCY = 2;
export declare const DEFAULT_DOCS_MAX_EXTRACTED_CHARS = 5000000;
export declare const DEFAULT_DOCS_STUCK_THRESHOLD_MINUTES = 30;
export declare const DEFAULT_DOCS_EMBEDDING_DIMS = 1536;
export declare const DEFAULT_DOCS_CHUNK_TOKENS = 512;
export declare const DEFAULT_DOCS_CHUNK_OVERLAP_TOKENS = 64;
export declare const DEFAULT_DOCS_CLASSIFY_SAMPLE_CHARS = 4000;
/** Default AND hard max — the embed stage clamps any configured value to 64. */
export declare const DEFAULT_DOCS_EMBED_BATCH_SIZE = 64;
export declare const DEFAULT_DOCS_RETRIEVAL_TOPK_MAX = 12;
export declare const DEFAULT_DOCS_RETRIEVAL_TOPK = 6;
/** 0 = unlimited organization storage (the documented default). */
export declare const DEFAULT_DOCS_ORG_QUOTA_BYTES = 0;
/** OCR page cap per document (07 §4 row 2) — pages beyond it are dropped with a visible note. */
export declare const DEFAULT_DOCS_OCR_MAX_PAGES = 20;
/** Per-message cap for the inbound-email webhook (25 MB). */
export declare const DEFAULT_DOCS_INBOUND_MAX_MESSAGE_BYTES = 26214400;
/** Requests/minute on the intake path — upload costs storage + pipeline + AI spend (§9). */
export declare const DEFAULT_DOCS_UPLOAD_RATE_LIMIT = 20;
/** Requests/minute on knowledge search — every query fans out to a query embedding (§9). */
export declare const DEFAULT_DOCS_SEARCH_RATE_LIMIT = 60;
/** Requests/minute on the fan-out admin operations (bulk actions, per-document re-index) (§9). */
export declare const DEFAULT_DOCS_ADMIN_OPS_RATE_LIMIT = 10;
/**
 ...
 * three of them.
 */
export declare const DOCS_RATE_LIMIT_WINDOW_MS = 60000;
/**
 ...
 */
export declare const DOCS_UPLOAD_MAX_FILES = 10;
/**
 ...
 */
export declare const DOCS_JOB_ATTEMPTS = 3;
export declare const DOCS_JOB_BACKOFF_DELAY_MS = 120000;
export declare const DOCS_JOB_REMOVE_ON_COMPLETE = 500;
export declare const DOCS_JOB_REMOVE_ON_FAIL = 1000;
/**
 ...
 */
export declare const DOCS_TENANT_AI_CONCURRENCY = 1;
/**
 ...
 */
export declare const DOCS_TENANT_BUSY_DEFER_DELAY_MS = 5000;
/**
 ...
 */
export declare const DOCS_BULK_IMPORT_JOB_PRIORITY = 10;
/**
 ...
 */
export declare const DOCS_FEATURE_CACHE_TTL_MS = 60000;
/**
 ...
 */
export declare const DOCS_FEATURE_DISABLED_PARK_DELAY_MS = 900000;
/**
 * Startup-recovery / reconcile sweep timing (§7.5 of the backend spec).
 */
export declare const DOCS_RECOVERY_STARTUP_DELAY_MS = 15000;
export declare const DOCS_RECOVERY_UPLOADED_STALE_MINUTES = 5;
export declare const DOCS_RECOVERY_FAILED_AFTER_HOURS = 24;
/**
 * Namespace prefix for the org-defaults settings persisted as `tenant_setting` rows
 * (`docs.<organizationId>.<key>`).
 */
export declare const DOCS_SETTING_PREFIX = "docs";
/**
 ...
 */
export declare const DOCS_SETTING_QUOTA_BYTES = "quotaBytes";
export declare const DOCS_SETTING_INBOUND_TOKEN = "inboundToken";
/**
 ...
 */
export declare const DOCS_INBOUND_SIGNATURE_TOLERANCE_MS = 300000;
/** Header names read by the generic signed-webhook reference adapter. */
export declare const DOCS_INBOUND_SIGNATURE_HEADER = "x-gauzy-docs-signature";
export declare const DOCS_INBOUND_TIMESTAMP_HEADER = "x-gauzy-docs-timestamp";
/**
 ...
 */
export declare const DOCS_INBOUND_ADDRESS_SECRET_HEADER = "x-gauzy-docs-address-secret";
/**
 ...
 */
export declare const DOCS_INBOUND_PLATFORM_LOCAL_PREFIX = "docs-";
/**
 ...
 */
export declare const DOCS_INBOUND_DOMAIN_TXT_PREFIX = "_gauzy-docs";
/**
 ...
 */
export declare const DOCS_INBOUND_DNS_TIMEOUT_MS = 5000;
/**
