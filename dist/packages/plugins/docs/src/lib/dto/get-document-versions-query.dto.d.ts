...
declare const GetDocumentVersionsQueryDTO_base: import("@nestjs/common").Type<Partial<TenantOrganizationBaseDTO> & Pick<BaseQueryDTO<unknown>, "take" | "skip">>;
/**
 ...
 */
export declare class GetDocumentVersionsQueryDTO extends GetDocumentVersionsQueryDTO_base {
}
export {};
