 ...
 */
export declare class DocumentEvent extends BaseEntityEvent<Document, DocumentInputTypes> {
    readonly context: IDocumentEventContext;
    /**
     ...
     */
    constructor(ctx: RequestContext, entity: Document, type: BaseEntityEventType, context?: IDocumentEventContext, input?: DocumentInputTypes);
}
export {};
