 ...
 */
export declare const DOCS_CITATIONS_DATA_PART: "data-docs-citations";
 ...
 */
export declare function toCitationUrl(documentId: ID, kind?: DocumentKindEnum | string): string;
