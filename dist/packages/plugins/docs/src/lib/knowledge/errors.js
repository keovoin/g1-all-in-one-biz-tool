...
exports.DocsPermanentError = exports.DocsTransientError = void 0;
 ...
 */
class DocsTransientError extends Error {
...
exports.DocsTransientError = DocsTransientError;
/**
 ...
 */
class DocsPermanentError extends Error {
    constructor(message, cause) {
        super(message);
        this.cause = cause;
...
exports.DocsPermanentError = DocsPermanentError;
