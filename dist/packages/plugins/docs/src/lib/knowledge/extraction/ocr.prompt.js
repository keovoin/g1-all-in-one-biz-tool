...
exports.OCR_MAX_OUTPUT_TOKENS = exports.OCR_USER_PROMPT = exports.OCR_SYSTEM_PROMPT = void 0;
exports.buildOcrCapNote = buildOcrCapNote;
exports.buildOcrPageFailureNote = buildOcrPageFailureNote;
/** System prompt shared by every OCR call (PDF pages and standalone images). */
exports.OCR_SYSTEM_PROMPT = [
...
exports.OCR_USER_PROMPT = 'Transcribe this page.';
/** Output-token ceiling of a single page transcription. */
exports.OCR_MAX_OUTPUT_TOKENS = 4000;
/**
 ...
 */
function buildOcrCapNote(transcribed, total) {
...
function buildOcrPageFailureNote(pageNumber) {
    return `_Page ${pageNumber} could not be transcribed._`;
}
//# sourceMappingURL=ocr.prompt.js.map