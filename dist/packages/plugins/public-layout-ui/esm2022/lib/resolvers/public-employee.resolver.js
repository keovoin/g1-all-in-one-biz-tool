 ...
 */
export const PublicEmployeeResolver = (route) => {
    ...
    return _employeesService.getPublicById(slug, employeeId, relations).pipe(catchError((error) => {
        // Logging the error
...
//# sourceMappingURL=public-employee.resolver.js.map