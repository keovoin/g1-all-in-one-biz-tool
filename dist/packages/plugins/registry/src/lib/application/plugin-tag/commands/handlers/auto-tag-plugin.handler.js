"use strict";
var AutoTagPluginHandler_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.AutoTagPluginHandler = void 0;
const tslib_1 = require("tslib");
const core_1 = require("@gauzy/core");
const common_1 = require("@nestjs/common");
const cqrs_1 = require("@nestjs/cqrs");
const auto_tag_plugin_command_1 = require("../auto-tag-plugin.command");
 ...
 */
let AutoTagPluginHandler = AutoTagPluginHandler_1 = class AutoTagPluginHandler {
    constructor(tagService, commandBus) {
        this.tagService = tagService;
        this.commandBus = commandBus;
        this.logger = new common_1.Logger(AutoTagPluginHandler_1.name);
    }
    /**
    ...
    async execute(command) {
        try {
            ...
            const result = await this.commandBus.execute(new bulk_create_plugin_tags_command_1.BulkCreatePluginTagsCommand({
                pluginId,
                tagIds,
                ...(tenantId && { tenantId }),
                ...(organizationId && { organizationId })
            ...
            throw new common_1.BadRequestException(`Auto-tagging failed: ${error.message}`);
        }
    }
    /**
     * Extract potential tag names from plugin data
     ...
     * @returns string[]
     */
    extractTagsFromPluginData(pluginData) {
        const tags = new Set();
        // Add type-based tags
        if (pluginData.type) {
        ...
        if (pluginData.keywords && Array.isArray(pluginData.keywords)) {
            pluginData.keywords.forEach((keyword) => {
        ...
        if (pluginData.technologies && Array.isArray(pluginData.technologies)) {
            pluginData.technologies.forEach((tech) => {
...
exports.AutoTagPluginHandler = AutoTagPluginHandler;
exports.AutoTagPluginHandler = AutoTagPluginHandler = AutoTagPluginHandler_1 = tslib_1.__decorate([
    (0, cqrs_1.CommandHandler)(auto_tag_plugin_command_1.AutoTagPluginCommand),
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [core_1.TagService, cqrs_1.CommandBus])
], AutoTagPluginHandler);
//# sourceMappingURL=auto-tag-plugin.handler.js.map