"use strict";
var PluginBillingFactory_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PluginBillingFactory = void 0;
 ...
 */
let PluginBillingFactory = PluginBillingFactory_1 = class PluginBillingFactory {
    constructor() {
        this.logger = new common_1.Logger(PluginBillingFactory_1.name);
    }
    /**
    ...
    async createFromInput(input) {
        ...
        const billingData = {
            ...
            status: input.status || contracts_1.PluginBillingStatus.PENDING,
        ...
        if (!billingData.billingPeriodEnd) {
            billingData.billingPeriodEnd = this.calculateBillingPeriodEnd(billingData.billingPeriodStart, billingData.billingPeriod);
        }
        return billingData;
    }
    /**
     ...
     */
    async createForRenewal(subscriptionId, plan, tenantId, organizationId) {
        ...
        this.logger.log(`Renewal billing - Full price: ${totalAmount} ${plan.currency || 'USD'} (no discounts applied)`);
        return {
            subscriptionId,
            amount: totalAmount,
     ...
     */
    async createForUpgrade(subscriptionId, proratedAmount, billingPeriod, tenantId, organizationId) {
     ...
     */
    async createInitialBilling(subscriptionId, plan, hasTrial = false, tenantId, organizationId) {
     ...
     */
    calculateBillingAmount(plan, includeSetupFee = false) {
        ...
        if (discountPercentage > 0) {
            breakdownParts.push(`One-time Discount (${discountPercentage}%): -${discountAmount.toFixed(2)} ${plan.currency || 'USD'}`);
     ...
     */
    calculateBillingPeriodEnd(startDate, period) {
...
exports.PluginBillingFactory = PluginBillingFactory;
exports.PluginBillingFactory = PluginBillingFactory = PluginBillingFactory_1 = tslib_1.__decorate([
    (0, common_1.Injectable)()
], PluginBillingFactory);
//# sourceMappingURL=plugin-billing.factory.js.map