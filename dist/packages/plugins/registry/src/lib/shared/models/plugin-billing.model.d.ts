 ...
 */
export interface IPluginBillingCreateInput extends Omit<IPluginBilling, 'id' | 'createdAt' | 'updatedAt' | 'subscription'> {
    subscriptionId: ID;
}
/**
 ...
 */
export interface IPluginBillingFindInput extends Partial<Pick<IPluginBilling, 'subscriptionId' | 'status' | 'billingPeriod' | 'currency' | 'billingDate'>> {
    dateRange?: {
        start: Date;
        end: Date;
    };
