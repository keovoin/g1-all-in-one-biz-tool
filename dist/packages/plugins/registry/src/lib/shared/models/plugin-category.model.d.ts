 ...
 */
export interface IPluginCategoryCreateInput extends Omit<IPluginCategory, 'id' | 'createdAt' | 'updatedAt' | 'parent' | 'children' | 'plugins' | 'defaultSettings'> {
    parentId?: ID;
}
/**
 ...
 */
export interface IPluginCategoryFindInput extends Partial<Pick<IPluginCategory, 'name' | 'slug' | 'isActive' | 'parentId'>> {
}
/**
