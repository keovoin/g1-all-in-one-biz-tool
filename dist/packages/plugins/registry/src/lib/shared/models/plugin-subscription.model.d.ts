import { ID, PluginScope, IPluginSubscription as PluginSubscriptionModel, IPluginSubscriptionPlan as PluginSubscriptionPlanModel, PluginSubscriptionStatus } from '@gauzy/contracts';
/**
...
export interface IPluginSubscriptionStatics {
     ...
     */
    createFreeSubscription(pluginId: string, pluginTenantId: string, tenantId: string, subscriberId?: string, organizationId?: string): IPluginSubscription;
    /**
     * Creates a trial subscription
     */
    createTrialSubscription(pluginId: string, pluginTenantId: string, tenantId: string, planId: string, trialDays: number, scope: PluginScope, subscriberId?: string, organizationId?: string): IPluginSubscription;
    /**
     * Creates a paid subscription
     */
    createPaidSubscription(pluginId: string, pluginTenantId: string, tenantId: string, planId: string, scope: PluginScope, endDate: Date, subscriberId?: string, organizationId?: string, paymentMethod?: string): IPluginSubscription;
    /**
 ...
 */
export interface IPluginSubscriptionUpdateInput extends Partial<Omit<IPluginSubscriptionCreateInput, 'pluginId' | 'pluginTenantId' | 'billings'>> {
}
/**
 * Interface for finding plugin subscriptions
 */
export interface IPluginSubscriptionFindInput extends Partial<Pick<IPluginSubscription, 'status' | 'scope' | 'pluginId' | 'pluginTenantId' | 'subscriberId'>> {
}
/**
 ...
 */
export interface IPluginSubscriptionPlanCreateInput extends Omit<IPluginSubscriptionPlan, 'id' | 'createdAt' | 'updatedAt' | 'plugin' | 'createdBy' | 'subscriptions'> {
    pluginId: ID;
    createdById?: ID;
}
/**
 ...
 */
export interface IPluginSubscriptionPlanUpdateInput extends Partial<Omit<IPluginSubscriptionPlanCreateInput, 'pluginId'>> {
}
/**
 * Interface for finding plugin subscription plans
 */
export interface IPluginSubscriptionPlanFindInput extends Partial<Pick<IPluginSubscriptionPlan, 'type' | 'isActive' | 'pluginId' | 'isPopular' | 'isRecommended' | 'billingPeriod'>> {
}
