...
import type { IPluginSubscriptionPlanCreateInput, IPluginSubscriptionPlanUpdateInput } from './plugin-subscription.model';
...
export interface IPluginUpdate {
    ...
    subscriptionPlans?: Array<IPluginSubscriptionPlanCreateInput | (IPluginSubscriptionPlanUpdateInput & {
        id: ID;
    })>;
}
