...
tslib_1.__decorate([
    ...
    (0, class_validator_1.Matches)(/\.(webm)$/, {
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: contracts_1.FileStorageProviderEnum.LOCAL,
        enum: contracts_1.FileStorageProviderEnum
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(contracts_1.FileStorageProviderEnum, { message: 'Invalid file storage provider' }),
    tslib_1.__metadata("design:type", String)
], FileDTO.prototype, "storageProvider", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
