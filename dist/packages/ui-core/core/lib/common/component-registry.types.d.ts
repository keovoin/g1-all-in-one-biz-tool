 ...
 */
export type PageRouteLocationId = 'auth-sections' | 'pages-sections' | 'dashboard-sections' | 'jobs-sections' | 'sales-sections' | 'proposals-sections' | 'time-activity-sections' | 'timesheet-sections' | 'timesheet-details-sections' | 'integrations-sections' | 'accounting-sections' | 'documents-sections' | 'employees-sections' | 'organization-sections' | 'goals-sections' | 'reports-sections' | 'settings-sections' | 'page-sections';
/**
 * @description
 ...
 */
export type PageTabsetPageId = 'dashboard-page' | 'timesheet-page' | 'time-activity-page' | 'employee-edit-page' | 'organization-edit-page';
/**
 * @description
