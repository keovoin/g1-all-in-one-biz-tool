 ...
 */
export declare function addNavMenuSection(config: NavMenuSectionItem, before?: string): EnvironmentProviders;
/**
 ...
 * @returns The provider configuration.
 */
export declare function addNavMenuItem(config: NavMenuSectionItem, sectionId: string, before?: string): EnvironmentProviders;
