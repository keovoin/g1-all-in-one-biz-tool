...
export type JitsuAnalyticsEvents = IUserCreatedEvent | IButtonClickedEvent | IPageViewEvent | IPageCreatedEvent | IUserUpgradedEvent | IUserSignedInEvent | IUserClickDownloadAppEvent | IMenuItemClickedEvent;
export declare enum JitsuAnalyticsEventsEnum {
