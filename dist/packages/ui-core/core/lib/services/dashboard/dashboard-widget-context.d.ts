 ...
 */
export declare const DASHBOARD_WIDGET_CONTEXT: InjectionToken<Observable<IDashboardWidgetContext>>;
/**
 ...
 */
export declare const DASHBOARD_WIDGET_CONFIG: InjectionToken<Record<string, unknown>>;
