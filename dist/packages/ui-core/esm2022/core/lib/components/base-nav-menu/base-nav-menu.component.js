...
let BaseNavMenuComponent = class BaseNavMenuComponent extends TranslationBaseComponent {
    constructor(_translateService) {
        ...
        this._favoriteStoreService = inject(FavoriteStoreService);
        this._dashboardStoreService = inject(DashboardStoreService);
        this._favoriteItems = [];
        this._customDashboards = [];
    }
    ngOnInit() {
    ...
    ngAfterViewInit() {
        combineLatest([
            ...
            this._store.selectedOrganization$.pipe(filter((organization) => !!organization), distinctUntilChange()),
            this._store.featureOrganizations$,
            this._store.featureTenant$,
            this._store.userRolePermissions$
        ])
            .pipe(debounceTime(50), tap(([favorites, dashboards]) => {
    ...
    _getDashboardChildren() {
        return [
            ...
            ...this._customDashboards.map((dashboard) => ({
                ...
                items: [
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/invoices/estimates/add', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ESTIMATES_EDIT)
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/invoices/add', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.INVOICES_EDIT)
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/income?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_INCOMES_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/expenses?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_EXPENSES_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/expense-recurring?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_EXPENSES_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/accounting/payments?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_PAYMENT_ADD_EDIT)
                        }
                    }
                ]
            }
                ...
                items: [
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/sales/invoices/estimates/add', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ESTIMATES_EDIT)
                        }
                    },
                    {
                        id: 'sales-invoices',
                        ...
                        data: {
                            ...
                            permissionKeys: [PermissionsEnum.ALL_ORG_VIEW, PermissionsEnum.INVOICES_VIEW],
                            featureKey: FeatureEnum.FEATURE_INVOICE,
                            ...this._addLink('/pages/sales/invoices/add', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.INVOICES_EDIT)
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            permissionKeys: [PermissionsEnum.ORG_PAYMENT_VIEW],
                            featureKey: FeatureEnum.FEATURE_PAYMENT,
                            ...this._addLink('/pages/sales/payments?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_PAYMENT_ADD_EDIT)
                        }
                    },
                    {
                        id: 'sales-pipelines',
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/sales/pipelines?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.EDIT_SALES_PIPELINES)
                        }
                    }
                ]
            }
                ...
                items: [
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/tasks/dashboard?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_TASK_ADD)
                        }
                    },
                    {
                        id: 'tasks-team',
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/tasks/team?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_TASK_ADD)
                        }
                    }
                ]
            }
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/employees/approvals?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.REQUEST_APPROVAL_EDIT)
                        }
                    },
                    {
                        id: 'employees-levels',
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/employees/time-off?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.TIME_OFF_ADD)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/employees/recurring-expenses?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.EMPLOYEE_EXPENSES_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/employees/candidates?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_CANDIDATES_EDIT)
                        }
                    }
                ]
            }
                ...
                items: [
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/equipment?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_EQUIPMENT_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/inventory/create', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.INVENTORY_GALLERY_ADD)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/tags?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_TAGS_ADD)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/vendors?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/projects/create', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_PROJECT_ADD)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/departments?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/teams?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_TEAM_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/documents?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/organization/employment-types?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            permissionKeys: [PermissionsEnum.ORG_EXPENSES_VIEW],
                            featureKey: FeatureEnum.FEATURE_ORGANIZATION_RECURRING_EXPENSE,
                            ...this._addLink('/pages/organization/expense-recurring?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_EXPENSES_EDIT)
                        }
                    },
                    {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/contacts/leads?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_CONTACT_EDIT)
                        }
                    },
                    {
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/contacts/customers?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_CONTACT_EDIT)
                        }
                    },
                    {
                        id: 'contacts-clients',
                        ...
                        data: {
                            ...
                            ...this._addLink('/pages/contacts/clients?openAddDialog=true', PermissionsEnum.ALL_ORG_EDIT, PermissionsEnum.ORG_CONTACT_EDIT)
                        }
                    }
                ]
            }
    ...
    ngOnDestroy() { }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: BaseNavMenuComponent, deps: [{ token: i1.TranslateService }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.7", type: BaseNavMenuComponent, isStandalone: true, selector: "[gaBaseNavMenu]", usesInheritance: true, ngImport: i0 }); }
};
BaseNavMenuComponent = __decorate([
    UntilDestroy(),
    __metadata("design:paramtypes", [TranslateService])
], BaseNavMenuComponent);
export { BaseNavMenuComponent };
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: BaseNavMenuComponent, decorators: [{
            type: Directive,
            args: [{
...
//# sourceMappingURL=base-nav-menu.component.js.map