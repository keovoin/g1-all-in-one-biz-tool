...
export class AuthRefreshInterceptor {
    ...
    intercept(req, next) {
        ...
        return next.handle(req).pipe(catchError((error) => {
            ...
            if (this.refreshTokenInProgress) {
                ...
                return this.refreshTokenSubject.pipe(take(1), switchMap((token) => next.handle(this.addToken(req, token))));
            }
            else {
                this.refreshTokenInProgress = true;
                return this.refreshAccessToken().pipe(switchMap((response) => {
                    if (response?.token) {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: AuthRefreshInterceptor, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: AuthRefreshInterceptor }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: AuthRefreshInterceptor, decorators: [{
            type: Injectable
        }] });
//# sourceMappingURL=auth-refresh.interceptor.js.map