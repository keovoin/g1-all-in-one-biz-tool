 ...
 */
export const customDashboardGuard = async (route) => {
 ...
 */
export const standardDashboardGuard = () => {
 ...
 */
export const defaultDashboardGuard = async () => {
    const router = inject(Router);
    const dashboardStore = inject(DashboardStoreService);
    try {
...
//# sourceMappingURL=dashboard.guards.js.map