...
export class IntegrationsService {
    ...
    fetchIntegrations(integrationTypeId, searchQuery = '', filter = 'all') {
        ...
        return this._http.get(`${API_PREFIX}/integration`, {
            params: { filters }
        });
    }
    fetchIntegrationGroups() {
        return this._http
            .get(`${API_PREFIX}/integration/types`)
            .pipe(map((groups) => groups.reduce((prev, current) => {
    ...
    getIntegrationByOptions(input) {
        ...
        return this._http.get(`${API_PREFIX}/integration-tenant/integration`, { params });
    }
    /**
    ...
    getIntegrationTenant(id, relations) {
        return this._http.get(`${API_PREFIX}/integration-tenant/${id}`, {
            params: toParams({ ...relations })
        });
    }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: IntegrationsService, deps: [{ token: i1.HttpClient }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: IntegrationsService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: IntegrationsService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
