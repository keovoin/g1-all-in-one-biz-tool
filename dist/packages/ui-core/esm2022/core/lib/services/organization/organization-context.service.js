...
export class OrganizationContextService {
    ...
    async switchOrganization(organization) {
        try {
            ...
            const response = await firstValueFrom(this.authService.switchOrganization(organization.id).pipe(catchError((error) => {
     ...
     */
    applyOrganizationData(response, organization) {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: OrganizationContextService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: OrganizationContextService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: OrganizationContextService, decorators: [{
            type: Injectable,
