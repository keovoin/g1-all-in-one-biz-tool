...
export class DateRangePickerBuilderService {
    constructor() {
        this.dates$ = new BehaviorSubject(DEFAULT_DATE_RANGE);
        this._datePickerConfig$ = new BehaviorSubject(null);
        this.datePickerConfig$ = this._datePickerConfig$.asObservable();
        this._selectedDateRange$ = new BehaviorSubject(null);
     ...
     */
    refreshDateRangePicker(date, timeZone) {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DateRangePickerBuilderService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DateRangePickerBuilderService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: DateRangePickerBuilderService, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
//# sourceMappingURL=date-range-picker-builder.service.js.map