...
import { NbCardModule, NbButtonModule, NbIconModule, NbStepperModule, NbInputModule, NbDatepickerModule, NbSelectModule, NbBadgeModule, NbCheckboxModule, NbRadioModule, NbTooltipModule } from '@nebular/theme';
...
export class CandidateInterviewMutationModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: CandidateInterviewMutationModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.7", ngImport: i0, type: CandidateInterviewMutationModule, declarations: [CandidateInterviewMutationComponent,
            ...
            CandidatePersonalQualitiesComponent], imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
            NbDatepickerModule,
            NbSelectModule,
            ...
            CandidateCalendarInfoModule, i1.TranslateModule], exports: [CandidateInterviewMutationComponent,
            CandidateInterviewFormComponent,
            CandidateCriterionsFormComponent,
            CandidateNotificationFormComponent,
            CandidateEmailComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: CandidateInterviewMutationModule, providers: [CandidateTechnologiesService], imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
            NbDatepickerModule,
            NbSelectModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: CandidateInterviewMutationModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
//# sourceMappingURL=candidate-interview-mutation.module.js.map