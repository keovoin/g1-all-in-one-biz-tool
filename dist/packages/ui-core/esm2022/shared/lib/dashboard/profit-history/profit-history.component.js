...
import * as i5 from "../../smart-data-layout/pagination/pagination-v2/pagination-v2.component";
...
let ProfitHistoryComponent = class ProfitHistoryComponent extends PaginationFilterBaseComponent {
    ...
    ngOnInit() {
        ...
        this._profitHistory$
            ...
            .subscribe();
        this.pagination$
            .pipe(debounceTime(100), distinctUntilChange(), tap(() => this._profitHistory$.next(true)), untilDestroyed(this))
            .subscribe();
