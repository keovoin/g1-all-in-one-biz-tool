...
// to avoid.
import { DEFAULT_RECORDS_HISTORY_TYPE, RECORDS_HISTORY_TYPES, RECORDS_HISTORY_TYPE_CONFIG_KEY, RECORDS_HISTORY_TYPE_LABELS } from './records-history.constants';
/**
...
const KPI_SUPPORTED_WIDTHS = [3, 4, 6, 12];
/**
 ...
 */
const KPI_CONTEXT = ['organization', 'dateRange'];
/**
...
const WIDE_SUPPORTED_WIDTHS = [4, 6, 8, 12];
/**
 ...
 */
const HISTORY_CONTEXT = ['organization', 'dateRange', 'employee'];
/**
 ...
 * builder's palette.
 */
export const ACCOUNTING_DASHBOARD_WIDGETS = [
    {
        location: 'dashboard',
        category: 'accounting',
    ...
    },
    {
        ...
        contextRequirements: KPI_CONTEXT,
        permissions: KPI_PERMISSIONS,
        loadComponent: () => import('./employee-statistics-widget.component').then((m) => m.EmployeeStatisticsWidgetComponent)
    },
    {
        location: 'dashboard',
        ...
        configSchema: [
            {
                ...
                type: 'select',
                options: RECORDS_HISTORY_TYPES.map((type) => ({
...
//# sourceMappingURL=accounting.widgets.js.map