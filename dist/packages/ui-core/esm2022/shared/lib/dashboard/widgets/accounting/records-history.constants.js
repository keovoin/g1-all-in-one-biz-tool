 ...
 */
export const RECORDS_HISTORY_TYPES = [
 ...
 * it drills into.
 */
export const RECORDS_HISTORY_TYPE_LABELS = {
 ...
 */
export function toRecordsHistoryType(value, fallback = DEFAULT_RECORDS_HISTORY_TYPE) {
    return RECORDS_HISTORY_TYPES.includes(value)
        ? value
        : fallback;
}
//# sourceMappingURL=records-history.constants.js.map