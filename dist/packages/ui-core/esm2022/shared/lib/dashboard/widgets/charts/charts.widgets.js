...
import { EMPLOYEE_CHART_KINDS, EMPLOYEE_CHART_KIND_LABELS, EMPLOYEE_CHART_TYPE_CONFIG_KEY, EmployeeChartKind } from './employee-chart.constants';
/**
...
const CHART_SUPPORTED_WIDTHS = [4, 6, 8, 12];
/**
 ...
 */
const CHART_CONTEXT = ['organization', 'dateRange', 'employee'];
/**
 ...
 */
export const CHART_DASHBOARD_WIDGETS = [
    {
        location: 'dashboard',
        category: 'hr',
        ...
        configSchema: [
            {
                ...
                type: 'select',
                options: EMPLOYEE_CHART_KINDS.map((kind) => ({
        ...
        loadComponent: () => import('./employee-statistics-chart-widget.component').then((m) => m.EmployeeStatisticsChartWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
        ...
        contextRequirements: CHART_CONTEXT,
        permissions: CHART_PERMISSIONS,
        loadComponent: () => import('./employee-horizontal-bar-chart-widget.component').then((m) => m.EmployeeHorizontalBarChartWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
        ...
        contextRequirements: CHART_CONTEXT,
        permissions: CHART_PERMISSIONS,
        loadComponent: () => import('./employee-doughnut-chart-widget.component').then((m) => m.EmployeeDoughnutChartWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
        ...
        contextRequirements: CHART_CONTEXT,
        permissions: CHART_PERMISSIONS,
        loadComponent: () => import('./employee-stacked-bar-chart-widget.component').then((m) => m.EmployeeStackedBarChartWidgetComponent)
    }
];
//# sourceMappingURL=charts.widgets.js.map