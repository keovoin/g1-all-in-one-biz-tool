 ...
 */
export var EmployeeChartKind;
(function (EmployeeChartKind) {
    EmployeeChartKind["DOUGHNUT"] = "doughnut";
    EmployeeChartKind["HORIZONTAL_BAR"] = "horizontal-bar";
    EmployeeChartKind["STACKED_BAR"] = "stacked-bar";
})(EmployeeChartKind || (EmployeeChartKind = {}));
/** Ordered list backing the switcher widget's dropdown. */
export const EMPLOYEE_CHART_KINDS = [
...
export const EMPLOYEE_CHART_KIND_LABELS = {
...
//# sourceMappingURL=employee-chart.constants.js.map