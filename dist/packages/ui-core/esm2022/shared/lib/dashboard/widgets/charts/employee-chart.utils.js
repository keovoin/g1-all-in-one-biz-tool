 ...
 */
export function resolveEmployeeChartPalette(variables, element) {
 ...
 */
export function sumEmployeeStatistics(statistics) {
    return toRows(statistics).reduce((totals, statistic) => ({
 ...
 */
export function toMonthLabels(statistics) {
 ...
 */
export function formatEmployeeCurrency(value, organization, currencyPipe, positionPipe) {
    let currency;
    try {
...
export function toChartType(kind) {
 ...
 */
export function toEmployeeChartKind(value, fallback = EmployeeChartKind.HORIZONTAL_BAR) {
    return EMPLOYEE_CHART_KINDS.includes(value) ? value : fallback;
}
/**
 ...
 */
export function buildDoughnutChartData(statistics, context) {
 ...
 * @returns A Chart.js data object.
 */
export function buildHorizontalBarChartData(statistics, context) {
 ...
 * @returns A Chart.js data object.
 */
export function buildStackedBarChartData(statistics, context) {
    const rows = toRows(statistics);
 ...
 */
function toProportion(statistic) {
 ...
 */
export function buildDoughnutChartOptions(palette) {
    return {
        responsive: true,
 ...
 * @returns Chart.js options.
 */
export function buildHorizontalBarChartOptions(palette) {
    return {
        responsive: true,
        maintainAspectRatio: false,
        indexAxis: 'y',
 ...
 * @returns Chart.js options.
 */
export function buildStackedBarChartOptions(palette, statistics, formatCurrency) {
    ...
    const format = formatCurrency ?? ((value) => `${value}`);
    return {
        responsive: true,
        maintainAspectRatio: false,
        indexAxis: 'y',
...
//# sourceMappingURL=employee-chart.utils.js.map