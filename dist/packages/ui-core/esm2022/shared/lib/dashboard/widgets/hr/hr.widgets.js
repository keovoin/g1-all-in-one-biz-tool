...
const BLOCK_SUPPORTED_WIDTHS = [4, 6, 8, 12];
/**
 ...
 */
const BLOCK_CONTEXT = ['organization', 'dateRange', 'employee'];
/**
 ...
 */
export const HR_DASHBOARD_WIDGETS = [
    {
        location: 'dashboard',
        category: 'hr',
    ...
    },
    {
        ...
        contextRequirements: BLOCK_CONTEXT,
        permissions: BLOCK_PERMISSIONS,
        loadComponent: () => import('./hr-expenses-without-salary-widget.component').then((m) => m.HrExpensesWithoutSalaryWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
        ...
        contextRequirements: BLOCK_CONTEXT,
        permissions: BLOCK_PERMISSIONS,
        loadComponent: () => import('./hr-total-expenses-widget.component').then((m) => m.HrTotalExpensesWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
    ...
    },
    {
        ...
        contextRequirements: BLOCK_CONTEXT,
        permissions: BLOCK_PERMISSIONS,
        loadComponent: () => import('./hr-total-direct-bonus-widget.component').then((m) => m.HrTotalDirectBonusWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'hr',
...
//# sourceMappingURL=hr.widgets.js.map