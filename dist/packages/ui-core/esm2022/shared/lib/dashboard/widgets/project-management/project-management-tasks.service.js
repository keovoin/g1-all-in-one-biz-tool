...
import { STATISTICS_CACHE_TTL_MS } from '@gauzy/ui-core/core';
...
const TASK_RELATIONS = ['project', 'tags'];
/**
 ...
 */
export function buildProjectManagementTasksRequest(context) {
...
export class ProjectManagementTasksService {
    ...
    getSnapshot(context) {
        ...
        return this._invalidated$.pipe(startWith(undefined), switchMap(() => this._cached(key, context)), 
    ...
    */
    ...
    _cached(key, context) {
        ...
        const request$ = this._http.get(endPoint, { params });
        const released$ = new Subject();
        ...
        takeUntil(released$), map((response) => buildProjectManagementSnapshot(response?.items ?? [], response?.total ?? 0)), shareReplay({ bufferSize: 1, refCount: false }), catchError((error) => {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ProjectManagementTasksService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ProjectManagementTasksService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ProjectManagementTasksService, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
//# sourceMappingURL=project-management-tasks.service.js.map