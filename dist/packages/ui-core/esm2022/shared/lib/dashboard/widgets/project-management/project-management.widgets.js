...
const LIST_SUPPORTED_WIDTHS = [3, 4, 6, 8, 12];
/**
 ...
 */
const PROJECT_MANAGEMENT_CONTEXT = ['organization'];
/**
 ...
 */
export const PROJECT_MANAGEMENT_DASHBOARD_WIDGETS = [
    {
        location: 'dashboard',
    ...
    },
    {
        ...
        contextRequirements: PROJECT_MANAGEMENT_CONTEXT,
        permissions: PROJECT_MANAGEMENT_PERMISSIONS,
        loadComponent: () => import('./most-viewed-projects-widget.component').then((m) => m.MostViewedProjectsWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'project-management',
        ...
        contextRequirements: PROJECT_MANAGEMENT_CONTEXT,
        permissions: PROJECT_MANAGEMENT_PERMISSIONS,
        loadComponent: () => import('./recently-assigned-widget.component').then((m) => m.RecentlyAssignedWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'project-management',
...
//# sourceMappingURL=project-management.widgets.js.map