 ...
 */
export class BaseTeamsWidgetComponent extends BaseDashboardWidgetComponent {
    constructor() {
        super(...arguments);
        this._statistics = inject(TeamsDashboardStatisticsService);
    ...
    observeSnapshot() {
        combineLatest([
            ...
            this.context$.pipe(distinctUntilChanged((previous, current) => teamsScopeKey(previous) === teamsScopeKey(current))),
        ...
        switchMap((context) => this._statistics.getSnapshot(context).pipe(catchError((error) => {
            this.setError(error);
            return of(null);
        }))), tap((snapshot) => {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: BaseTeamsWidgetComponent, deps: null, target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.7", type: BaseTeamsWidgetComponent, isStandalone: true, usesInheritance: true, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: BaseTeamsWidgetComponent, decorators: [{
            type: Directive
        }] });
//# sourceMappingURL=base-teams-widget.component.js.map