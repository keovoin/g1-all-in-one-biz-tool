...
const COUNTER_SUPPORTED_WIDTHS = [3, 4, 6, 12];
/**
 ...
 */
const TEAMS_CONTEXT = ['organization', 'dateRange'];
/**
 ...
 */
const TEAMS_PERMISSIONS = [PermissionsEnum.ADMIN_DASHBOARD_VIEW, PermissionsEnum.TEAM_DASHBOARD];
/**
 ...
 */
export const TEAMS_DASHBOARD_WIDGETS = [
    {
        location: 'dashboard',
        category: 'teams',
    ...
    },
    {
        ...
        contextRequirements: TEAMS_CONTEXT,
        permissions: TEAMS_PERMISSIONS,
        loadComponent: () => import('./teams-members-worked-widget.component').then((m) => m.TeamsMembersWorkedWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'teams',
        ...
        contextRequirements: TEAMS_CONTEXT,
        permissions: TEAMS_PERMISSIONS,
        loadComponent: () => import('./teams-projects-worked-widget.component').then((m) => m.TeamsProjectsWorkedWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'teams',
    ...
    },
    {
        ...
        contextRequirements: TEAMS_CONTEXT,
        permissions: TEAMS_PERMISSIONS,
        loadComponent: () => import('./team-member-details-widget.component').then((m) => m.TeamMemberDetailsWidgetComponent)
    },
    {
        location: 'dashboard',
        category: 'teams',
        ...
        contextRequirements: TEAMS_CONTEXT,
        permissions: TEAMS_PERMISSIONS,
        loadComponent: () => import('./team-status-chart-widget.component').then((m) => m.TeamStatusChartWidgetComponent)
    },
    {
        location: 'dashboard',
        ...
        loadComponent: () => import('./data-entry-shortcuts-widget.component').then((m) => m.DataEntryShortcutsWidgetComponent)
    }
];
//# sourceMappingURL=teams.widgets.js.map