import { ChangeDetectorRef, Directive, ElementRef, HostBinding, NgZone, Renderer2, inject } from '@angular/core';
 ...
 */
export class SmartTableFilterToggleDirective {
    constructor() {
        this.collapsed = true;
     ...
     */
    static { this.STORAGE_KEY = 'gauzy.smartTable.filtersOpen'; }
    /**
    ...
    ensureToggle() {
        ...
        const cell = titles.lastElementChild;
        if (!cell) {
            return;
        }
        if (!this.button) {
            ...
            this.teardownFns.push(this.renderer.listen(this.button, 'click', (event) => {
    ...
    hasActiveFilter() {
        ...
        const inputs = Array.from(filters.querySelectorAll('input, textarea'));
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SmartTableFilterToggleDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.7", type: SmartTableFilterToggleDirective, isStandalone: false, selector: "angular2-smart-table", host: { properties: { "class.ga-filters-collapsed": "this.collapsed" } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SmartTableFilterToggleDirective, decorators: [{
            type: Directive,
            args: [{
                ...
                type: HostBinding,
                args: ['class.ga-filters-collapsed']
            }] } });
//# sourceMappingURL=smart-table-filter-toggle.directive.js.map