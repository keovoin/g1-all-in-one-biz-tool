 ...
 */
export class SmartTableSettlingDirective {
    constructor(cdr) {
        this.cdr = cdr;
        this.settling = true;
    }
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SmartTableSettlingDirective, deps: [{ token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.0.7", type: SmartTableSettlingDirective, isStandalone: false, selector: "angular2-smart-table", host: { properties: { "class.ga-table-settling": "this.settling" } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: SmartTableSettlingDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: 'angular2-smart-table',
                    standalone: false
                }]
        }], ctorParameters: () => [{ type: i0.ChangeDetectorRef }], propDecorators: { settling: [{
                type: HostBinding,
                args: ['class.ga-table-settling']
            }] } });
//# sourceMappingURL=smart-table-settling.directive.js.map