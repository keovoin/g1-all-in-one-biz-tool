...
export class TableComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: TableComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.7", ngImport: i0, type: TableComponentsModule, declarations: [AllowScreenshotCaptureComponent,
            AssignedToComponent,
            ...
            VisibilityComponent,
            NonEditableNumberEditorComponent], imports: [CommonModule,
            FormsModule,
            NbBadgeModule,
            NbButtonModule,
            NbIconModule,
            NbToggleModule,
            NbTooltipModule, i1.TranslateModule, DirectivesModule,
            PipesModule,
            ComponentsModule,
            TaskBadgeViewComponentModule], exports: [AllowScreenshotCaptureComponent,
            AssignedToComponent,
            ClickableLinkComponent,
            CompanyLogoComponent,
            ContactLinksComponent,
            ...
            ValueWithUnitComponent,
            VisibilityComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: TableComponentsModule, imports: [CommonModule,
            FormsModule,
            NbBadgeModule,
            NbButtonModule,
            NbIconModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: TableComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
