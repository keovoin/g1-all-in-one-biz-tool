...
export class ActionConfirmationComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ActionConfirmationComponent, deps: [{ token: i1.NbDialogRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.7", type: ActionConfirmationComponent, isStandalone: false, selector: "ga-action-confirmation", ngImport: i0, template: `
		<nb-card>
			<nb-card-header>
...
//# sourceMappingURL=action-confirmation.component.js.map