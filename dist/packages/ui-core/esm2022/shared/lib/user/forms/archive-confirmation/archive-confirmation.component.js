...
export class ArchiveConfirmationComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ArchiveConfirmationComponent, deps: [{ token: i1.NbDialogRef }], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.0.7", type: ArchiveConfirmationComponent, isStandalone: false, selector: "ga-archive-confirmation", ngImport: i0, template: `
		<nb-card>
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.7", ngImport: i0, type: ArchiveConfirmationComponent, decorators: [{
            type: Component,
            args: [{ selector: 'ga-archive-confirmation', template: `
		<nb-card>
			<nb-card-header class="d-flex flex-column">
				<span class="cancel"><i class="fas fa-times" (click)="close()"></i></span>
				<h6 class="title">{{ 'FORM.CONFIRM' | translate }}</h6>
