 ...
 */
export declare const DEFAULT_HTTP_LOADER_OPTIONS: Required<HttpLoaderOptions>;
/**
 ...
 * ```
 */
export declare function provideTranslateHttpLoader(options?: HttpLoaderOptions): Provider;
