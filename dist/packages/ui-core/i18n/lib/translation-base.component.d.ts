 ...
 * ```
 */
export declare abstract class TranslationBaseComponent {
    /**
     ...
     */
    getTranslationAsync(key: string, params?: TranslateParams): Promise<string>;
    /**
     ...
     */
    getTranslationsAsync(keys: string[], params?: TranslateParams): Promise<Record<string, string>>;
    /**
