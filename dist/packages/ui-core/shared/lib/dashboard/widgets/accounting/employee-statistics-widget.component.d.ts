 ...
 */
export declare class EmployeeStatisticsWidgetComponent extends BaseAccountingWidgetComponent {
    /** One row per employee with bookings in the range; empty before the first fetch. */
    protected readonly rows: import("@angular/core").Signal<IEmployeeStatisticSum[]>;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<EmployeeStatisticsWidgetComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<EmployeeStatisticsWidgetComponent, "ga-accounting-employee-statistics-widget", never, {}, {}, never, never, true, never>;
}
