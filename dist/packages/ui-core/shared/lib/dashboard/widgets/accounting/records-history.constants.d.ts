 ...
 */
export declare const RECORDS_HISTORY_TYPE_CONFIG_KEY = "historyType";
/**
 ...
 */
export declare const RECORDS_HISTORY_TYPES: readonly EmployeeStatisticsHistoryEnum[];
/** History shown when a placement carries no (or an unusable) configuration. */
export declare const DEFAULT_RECORDS_HISTORY_TYPE = EmployeeStatisticsHistoryEnum.INCOME;
/**
 ...
 * it drills into.
 */
export declare const RECORDS_HISTORY_TYPE_LABELS: Readonly<Record<string, string>>;
/**
 ...
 */
export declare function toRecordsHistoryType(value: unknown, fallback?: EmployeeStatisticsHistoryEnum): EmployeeStatisticsHistoryEnum;
