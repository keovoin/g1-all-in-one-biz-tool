 ...
 */
export declare enum EmployeeChartKind {
    DOUGHNUT = "doughnut",
    HORIZONTAL_BAR = "horizontal-bar",
    STACKED_BAR = "stacked-bar"
}
/** Ordered list backing the switcher widget's dropdown. */
export declare const EMPLOYEE_CHART_KINDS: readonly EmployeeChartKind[];
/**
 ...
 */
export declare const EMPLOYEE_CHART_TYPE_CONFIG_KEY = "chartType";
/** Translation key of each chart kind, matching the legacy switcher's labels. */
export declare const EMPLOYEE_CHART_KIND_LABELS: Readonly<Record<EmployeeChartKind, string>>;
