import { ID, IOrganizationProject, ITask } from '@gauzy/contracts';
 ...
 */
export declare function projectManagementScopeKey(context: IDashboardWidgetContext | null): string;
/**
 ...
 */
export declare function scopedId(ids: ID[] | undefined): ID | null;
/**
 ...
 */
export declare function sortProjectsByPopularity(tasks: ITask[]): IOrganizationProject[];
/**
 ...
 */
export declare function openTasksMostRecentFirst(tasks: ITask[]): ITask[];
/**
 ...
 */
export declare function buildProjectManagementSnapshot(tasks: ITask[], total: number): IProjectManagementSnapshot;
