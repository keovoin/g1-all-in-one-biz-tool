...
import { ITeamDashboardMember, ITeamDashboardMemberTask } from './teams-dashboard.types';
 ...
 */
export declare class TeamMemberDetailsWidgetComponent extends BaseTeamsWidgetComponent {
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<TeamMemberDetailsWidgetComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<TeamMemberDetailsWidgetComponent, "ga-team-member-details-widget", never, {}, {}, never, never, true, never>;
}
