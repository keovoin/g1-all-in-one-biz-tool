 ...
 */
export declare class RecordViewDrawerComponent {
    open: boolean;
    /**
    ...
    onEscape(): void;
    close(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<RecordViewDrawerComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<RecordViewDrawerComponent, "ngx-record-view-drawer", never, { "open": { "alias": "open"; "required": false; }; "heading": { "alias": "heading"; "required": false; }; "subtitle": { "alias": "subtitle"; "required": false; }; }, { "closed": "closed"; }, never, ["*"], false, never>;
}
